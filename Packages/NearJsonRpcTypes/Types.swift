...
// Generated on: 2025-09-29 06:09:32 +0000
...
public struct EpochSyncConfig: Codable, Sendable {
    ...
    public init(epoch_sync_horizon: UInt64, ignore_epoch_sync_network_requests: Bool?, timeout_for_epoch_sync: DurationAsStdSchemaProvider, disable_epoch_sync_for_bootstrapping: Bool?) {
...
public struct RpcNetworkInfoResponse: Codable, Sendable {
    ...
    public init(known_producers: [RpcKnownProducer], received_bytes_per_sec: UInt64, num_active_peers: String, active_peers: [RpcPeerInfo], sent_bytes_per_sec: UInt64, peer_max_count: UInt32) {
...
public struct JsonRpcRequest_for_block: Codable, Sendable {
    ...
    public init(jsonrpc: String, params: RpcBlockRequest, id: String, method: String) {
        self.jsonrpc = jsonrpc
        self.params = params
        self.id = id
        self.method = method
...
public struct AccountDataView: Codable, Sendable {
    ...
    public init(timestamp: String, proxies: [Tier1ProxyView], account_key: PublicKey, peer_id: PublicKey) {
...
public struct ReceiptView: Codable, Sendable {
    ...
    public init(predecessor_id: AccountId, receiver_id: AccountId, priority: UInt64?, receipt_id: CryptoHash, receipt: ReceiptEnumView) {
...
public struct JsonRpcRequest_for_EXPERIMENTAL_validators_ordered: Codable, Sendable {
    ...
    public init(jsonrpc: String, params: RpcValidatorsOrderedRequest, id: String, method: String) {
        self.jsonrpc = jsonrpc
        self.params = params
        self.id = id
        self.method = method
...
public struct RpcProtocolConfigResponse: Codable, Sendable {
    ...
    public init(avg_hidden_validator_seats_per_shard: [UInt64], max_inflation_rate: [Int32], minimum_validators_per_shard: UInt64, genesis_time: String, gas_price_adjustment_rate: [Int32], shuffle_shard_assignment_for_chunk_producers: Bool, min_gas_price: NearToken, epoch_length: UInt64, target_validator_mandates_per_shard: UInt64, chunk_producer_kickout_threshold: String, gas_limit: NearGas, chunk_validator_only_kickout_threshold: String, max_kickout_stake_perc: String, max_gas_price: NearToken, block_producer_kickout_threshold: String, runtime_config: RuntimeConfigView, num_block_producer_seats: UInt64, protocol_reward_rate: [Int32], protocol_version: UInt32, online_max_threshold: [Int32], genesis_height: UInt64, shard_layout: ShardLayout, dynamic_resharding: Bool, transaction_validity_period: UInt64, num_blocks_per_year: UInt64, online_min_threshold: [Int32], chain_id: String, minimum_stake_divisor: UInt64, fishermen_threshold: NearToken, minimum_stake_ratio: [Int32], protocol_upgrade_stake_threshold: [Int32], num_block_producer_seats_per_shard: [UInt64], protocol_treasury_account: AccountId) {
...
public struct StatusSyncInfo: Codable, Sendable {
    ...
    public init(epoch_start_height: UInt64?, earliest_block_hash: String?, latest_block_height: UInt64, epoch_id: String?, latest_state_root: CryptoHash, earliest_block_time: String?, latest_block_time: String, syncing: Bool, latest_block_hash: CryptoHash, earliest_block_height: UInt64?) {
...
public struct ShardLayoutV1: Codable, Sendable {
    ...
    public init(to_parent_shard_map: [ShardId]?, boundary_accounts: [AccountId], version: UInt32, shards_split_map: [[ShardId]]?) {
...
public struct CurrentEpochValidatorInfo: Codable, Sendable {
    ...
    public init(num_produced_endorsements: UInt64?, num_produced_endorsements_per_shard: [UInt64]?, num_produced_blocks: UInt64, num_expected_chunks: UInt64?, num_expected_endorsements: UInt64?, public_key: PublicKey, num_produced_chunks: UInt64?, num_expected_chunks_per_shard: [UInt64]?, stake: NearToken, shards_endorsed: [ShardId]?, shards: [ShardId], is_slashed: Bool, num_expected_blocks: UInt64, num_produced_chunks_per_shard: [UInt64]?, account_id: AccountId, num_expected_endorsements_per_shard: [UInt64]?) {
...
public struct DumpConfig: Codable, Sendable {
    ...
    public init(restart_dump_for_shards: [ShardId]?, location: ExternalStorageLocation, credentials_file: String?, iteration_delay: String?) {
...
public struct JsonRpcRequest_for_status: Codable, Sendable {
    ...
    public init(jsonrpc: String, params: RpcStatusRequest, id: String, method: String) {
        self.jsonrpc = jsonrpc
        self.params = params
        self.id = id
        self.method = method
...
public struct AccessKeyCreationConfigView: Codable, Sendable {
    ...
    public init(function_call_cost_per_byte: Fee, full_access_cost: Fee, function_call_cost: Fee) {
...
public struct RpcValidatorResponse: Codable, Sendable {
    ...
    public init(epoch_start_height: UInt64, current_validators: [CurrentEpochValidatorInfo], epoch_height: UInt64, next_fishermen: [ValidatorStakeView], prev_epoch_kickout: [ValidatorKickoutView], current_proposals: [ValidatorStakeView], next_validators: [NextEpochValidatorInfo], current_fishermen: [ValidatorStakeView]) {
        self.epoch_start_height = epoch_start_height
...
public struct GenesisConfig: Codable, Sendable {
    ...
    public init(num_chunk_only_producer_seats: UInt64?, shuffle_shard_assignment_for_chunk_producers: Bool?, genesis_height: UInt64, max_gas_price: NearToken, num_block_producer_seats_per_shard: [UInt64], max_kickout_stake_perc: String?, protocol_upgrade_stake_threshold: [Int32]?, minimum_stake_divisor: UInt64?, protocol_treasury_account: AccountId, total_supply: NearToken, genesis_time: String, target_validator_mandates_per_shard: UInt64?, protocol_reward_rate: [Int32], avg_hidden_validator_seats_per_shard: [UInt64], gas_price_adjustment_rate: [Int32], minimum_validators_per_shard: UInt64?, num_block_producer_seats: UInt64, gas_limit: NearGas, max_inflation_rate: [Int32], epoch_length: UInt64, minimum_stake_ratio: [Int32]?, num_chunk_validator_seats: UInt64?, online_min_threshold: [Int32]?, chain_id: String, chunk_producer_assignment_changes_limit: UInt64?, dynamic_resharding: Bool, min_gas_price: NearToken, num_chunk_producer_seats: UInt64?, use_production_config: Bool?, fishermen_threshold: NearToken, transaction_validity_period: UInt64, validators: [AccountInfo], chunk_producer_kickout_threshold: String, chunk_validator_only_kickout_threshold: String?, block_producer_kickout_threshold: String, num_blocks_per_year: UInt64, protocol_version: UInt32, online_max_threshold: [Int32]?, shard_layout: ShardLayout?) {
...
public struct RuntimeConfigView: Codable, Sendable {
    ...
    public init(account_creation_config: AccountCreationConfigView, wasm_config: VMConfigView, congestion_control_config: CongestionControlConfigView, transaction_costs: RuntimeFeesConfigView, storage_amount_per_byte: NearToken, witness_config: WitnessConfigView) {
...
public struct FinalExecutionOutcomeView: Codable, Sendable {
    ...
    public init(transaction_outcome: ExecutionOutcomeWithIdView, status: FinalExecutionStatus, transaction: SignedTransactionView, receipts_outcome: [ExecutionOutcomeWithIdView]) {
...
public struct DetailedDebugStatus: Codable, Sendable {
    ...
    public init(network_info: NetworkInfoView, catchup_status: [CatchupStatusView], current_head_status: BlockStatusView, block_production_delay_millis: UInt64, current_header_head_status: BlockStatusView, sync_status: String) {
...
public struct FinalExecutionOutcomeWithReceiptView: Codable, Sendable {
    ...
    public init(receipts: [ReceiptView], transaction_outcome: ExecutionOutcomeWithIdView, status: FinalExecutionStatus, transaction: SignedTransactionView, receipts_outcome: [ExecutionOutcomeWithIdView]) {
...
public struct DelegateAction: Codable, Sendable {
    ...
    public init(public_key: PublicKey, actions: [NonDelegateAction], max_block_height: UInt64, receiver_id: AccountId, sender_id: AccountId, nonce: UInt64) {
        self.public_key = public_key
...
public struct JsonRpcRequest_for_EXPERIMENTAL_maintenance_windows: Codable, Sendable {
    ...
    public init(jsonrpc: String, params: RpcMaintenanceWindowsRequest, id: String, method: String) {
        self.jsonrpc = jsonrpc
        self.params = params
        self.id = id
        self.method = method
...
public struct ExecutionOutcomeView: Codable, Sendable {
    ...
    public init(status: ExecutionStatusView, metadata: ExecutionMetadataView?, gas_burnt: NearGas, executor_id: AccountId, logs: [String], receipt_ids: [CryptoHash], tokens_burnt: NearToken) {
        self.status = status
...
public struct JsonRpcRequest_for_EXPERIMENTAL_tx_status: Codable, Sendable {
    ...
    public init(jsonrpc: String, params: RpcTransactionStatusRequest, id: String, method: String) {
        self.jsonrpc = jsonrpc
        self.params = params
        self.id = id
        self.method = method
...
public struct BlockHeaderInnerLiteView: Codable, Sendable {
    ...
    public init(epoch_id: CryptoHash, timestamp: UInt64, outcome_root: CryptoHash, next_bp_hash: CryptoHash, height: UInt64, prev_state_root: CryptoHash, timestamp_nanosec: String, next_epoch_id: CryptoHash, block_merkle_root: CryptoHash) {
        self.epoch_id = epoch_id
        self.timestamp = timestamp
...
public struct RuntimeFeesConfigView: Codable, Sendable {
    ...
    public init(storage_usage_config: StorageUsageConfigView, action_creation_config: ActionCreationConfigView, pessimistic_gas_price_inflation_ratio: [Int32], data_receipt_creation_config: DataReceiptCreationConfigView, action_receipt_creation_config: Fee, burnt_gas_reward: [Int32]) {
...
public struct JsonRpcRequest_for_send_tx: Codable, Sendable {
    ...
    public init(jsonrpc: String, params: RpcSendTransactionRequest, id: String, method: String) {
        self.jsonrpc = jsonrpc
        self.params = params
        self.id = id
        self.method = method
...
public struct PeerInfoView: Codable, Sendable {
    ...
    public init(connection_established_time_millis: UInt64, archival: Bool, height: UInt64?, addr: String, last_time_peer_requested_millis: UInt64, is_highest_block_invalid: Bool, tracked_shards: [ShardId], is_outbound_peer: Bool, received_bytes_per_sec: UInt64, block_hash: String?, last_time_received_message_millis: UInt64, sent_bytes_per_sec: UInt64, peer_id: PublicKey, account_id: String?, nonce: UInt64) {
...
public struct JsonRpcRequest_for_next_light_client_block: Codable, Sendable {
    ...
    public init(jsonrpc: String, params: RpcLightClientNextBlockRequest, id: String, method: String) {
        self.jsonrpc = jsonrpc
        self.params = params
        self.id = id
        self.method = method
...
public struct JsonRpcRequest_for_EXPERIMENTAL_genesis_config: Codable, Sendable {
    ...
    public init(jsonrpc: String, params: GenesisConfigRequest, id: String, method: String) {
        self.jsonrpc = jsonrpc
        self.params = params
        self.id = id
        self.method = method
...
public struct RpcClientConfigResponse: Codable, Sendable {
    ...
    public init(sync_step_period: [UInt64], header_sync_expected_height_per_second: UInt64, transaction_request_handler_threads: String, header_sync_stall_ban_timeout: [UInt64], block_fetch_horizon: UInt64, tracked_shards_config: TrackedShardsConfig, state_sync_p2p_timeout: [UInt64], version: Version, enable_multiline_logging: Bool, header_sync_initial_timeout: [UInt64], archive: Bool, state_sync_enabled: Bool, chunk_wait_mult: [Int32], cloud_archival_reader: String?, orphan_state_witness_pool_size: String, state_requests_per_throttle_period: String, epoch_length: UInt64, state_sync_external_timeout: [UInt64], gc: GCConfig, transaction_pool_size_limit: UInt64?, save_trie_changes: Bool, ttl_account_id_router: [UInt64], state_sync: StateSyncConfig, save_tx_outcomes: Bool, produce_empty_blocks: Bool, protocol_version_check: ProtocolVersionCheckConfig, resharding_config: MutableConfigValue, num_block_producer_seats: UInt64, min_block_production_delay: [UInt64], max_block_wait_delay: [UInt64], sync_max_block_requests: String, chain_id: String, sync_check_period: [UInt64], epoch_sync: EpochSyncConfig, orphan_state_witness_max_size: UInt64, enable_statistics_export: Bool, doomslug_step_period: [UInt64], rpc_addr: String?, log_summary_period: [UInt64], tx_routing_height_horizon: UInt64, min_num_peers: String, client_background_migration_threads: String, trie_viewer_state_size_limit: UInt64?, block_header_fetch_horizon: UInt64, save_invalid_witnesses: Bool, chunk_distribution_network: String?, sync_height_threshold: UInt64, view_client_threads: String, max_block_production_delay: [UInt64], state_sync_retry_backoff: [UInt64], max_gas_burnt_view: String?, catchup_step_period: [UInt64], state_request_throttle_period: [UInt64], header_sync_progress_timeout: [UInt64], skip_sync_wait: Bool, chunk_validation_threads: String, cloud_archival_writer: String?, chunk_request_retry_period: [UInt64], state_sync_external_backoff: [UInt64], produce_chunk_add_transactions_time_limit: String, expected_shutdown: MutableConfigValue, save_latest_witnesses: Bool, block_production_tracking_delay: [UInt64], log_summary_style: LogSummaryStyle, state_request_server_threads: String, save_untracked_partial_chunks_parts: Bool) {
...
public struct ChunkHeaderView: Codable, Sendable {
    ...
    public init(validator_proposals: [ValidatorStakeView], gas_limit: NearGas, encoded_merkle_root: CryptoHash, balance_burnt: NearToken, gas_used: NearGas, height_created: UInt64, prev_state_root: CryptoHash, height_included: UInt64, outgoing_receipts_root: CryptoHash, rent_paid: NearToken?, encoded_length: UInt64, signature: Signature, bandwidth_requests: String?, prev_block_hash: CryptoHash, congestion_info: String?, chunk_hash: CryptoHash, outcome_root: CryptoHash, tx_root: CryptoHash, shard_id: ShardId, validator_reward: NearToken?) {
...
public struct GasKeyView: Codable, Sendable {
    ...
    public init(num_nonces: UInt32, permission: AccessKeyPermissionView, balance: NearToken) {
...
public struct JsonRpcRequest_for_client_config: Codable, Sendable {
    ...
    public init(jsonrpc: String, params: RpcClientConfigRequest, id: String, method: String) {
        self.jsonrpc = jsonrpc
        self.params = params
        self.id = id
        self.method = method
...
public struct JsonRpcRequest_for_validators: Codable, Sendable {
    ...
    public init(jsonrpc: String, params: RpcValidatorRequest, id: String, method: String) {
        self.jsonrpc = jsonrpc
        self.params = params
        self.id = id
        self.method = method
...
public struct JsonRpcRequest_for_EXPERIMENTAL_protocol_config: Codable, Sendable {
    ...
    public init(jsonrpc: String, params: RpcProtocolConfigRequest, id: String, method: String) {
        self.jsonrpc = jsonrpc
        self.params = params
        self.id = id
        self.method = method
...
public struct ShardLayoutV2: Codable, Sendable {
    ...
    public init(version: UInt32, id_to_index_map: String, shards_parent_map: String?, index_to_id_map: String, boundary_accounts: [AccountId], shards_split_map: String?, shard_ids: [ShardId]) {
        self.version = version
...
public struct ActionCreationConfigView: Codable, Sendable {
    ...
    public init(function_call_cost_per_byte: Fee, deploy_contract_cost: Fee, transfer_cost: Fee, delegate_cost: Fee, add_key_cost: AccessKeyCreationConfigView, stake_cost: Fee, deploy_contract_cost_per_byte: Fee, delete_key_cost: Fee, delete_account_cost: Fee, create_account_cost: Fee, function_call_cost: Fee) {
        self.function_call_cost_per_byte = function_call_cost_per_byte
...
public struct JsonRpcRequest_for_light_client_proof: Codable, Sendable {
    ...
    public init(jsonrpc: String, params: RpcLightClientExecutionProofRequest, id: String, method: String) {
        self.jsonrpc = jsonrpc
        self.params = params
        self.id = id
        self.method = method
...
public struct SignedTransactionView: Codable, Sendable {
    ...
    public init(receiver_id: AccountId, nonce: UInt64, actions: [ActionView], public_key: PublicKey, priority_fee: UInt64?, signature: Signature, hash: CryptoHash, signer_id: AccountId) {
        self.receiver_id = receiver_id
        self.nonce = nonce
        self.actions = actions
        self.public_key = public_key
...
public struct CongestionControlConfigView: Codable, Sendable {
    ...
    public init(outgoing_receipts_big_size_limit: UInt64, max_outgoing_gas: NearGas, max_congestion_incoming_gas: NearGas, min_tx_gas: NearGas, outgoing_receipts_usual_size_limit: UInt64, max_tx_gas: NearGas, max_congestion_outgoing_gas: NearGas, max_congestion_memory_consumption: UInt64, reject_tx_congestion_threshold: String, min_outgoing_gas: NearGas, max_congestion_missed_chunks: UInt64, allowed_shard_outgoing_gas: NearGas) {
...
public struct JsonRpcRequest_for_EXPERIMENTAL_light_client_block_proof: Codable, Sendable {
    ...
    public init(jsonrpc: String, params: RpcLightClientBlockProofRequest, id: String, method: String) {
        self.jsonrpc = jsonrpc
        self.params = params
        self.id = id
        self.method = method
...
public struct ExternalStorageConfig: Codable, Sendable {
    ...
    public init(num_concurrent_requests: String?, location: ExternalStorageLocation, external_storage_fallback_threshold: UInt64?, num_concurrent_requests_during_catchup: String?) {
...
public struct NetworkInfoView: Codable, Sendable {
    ...
    public init(tier1_accounts_keys: [PublicKey], tier1_connections: [PeerInfoView], num_connected_peers: String, known_producers: [KnownProducerView], peer_max_count: UInt32, connected_peers: [PeerInfoView], tier1_accounts_data: [AccountDataView]) {
...
public struct JsonRpcRequest_for_chunk: Codable, Sendable {
    ...
    public init(jsonrpc: String, params: RpcChunkRequest, id: String, method: String) {
        self.jsonrpc = jsonrpc
        self.params = params
        self.id = id
        self.method = method
...
public struct BlockHeaderView: Codable, Sendable {
    ...
    public init(next_bp_hash: CryptoHash, challenges_root: CryptoHash, last_ds_final_block: CryptoHash, chunk_receipts_root: CryptoHash, epoch_id: CryptoHash, chunk_headers_root: CryptoHash, block_merkle_root: CryptoHash, chunk_endorsements: [[String]]?, chunks_included: UInt64, total_supply: NearToken, prev_state_root: CryptoHash, rent_paid: NearToken?, height: UInt64, signature: Signature, hash: CryptoHash, chunk_mask: [Bool], outcome_root: CryptoHash, timestamp: UInt64, last_final_block: CryptoHash, validator_reward: NearToken?, latest_protocol_version: UInt32, challenges_result: [SlashedValidator], validator_proposals: [ValidatorStakeView], gas_price: NearToken, prev_height: UInt64?, prev_hash: CryptoHash, random_value: CryptoHash, chunk_tx_root: CryptoHash, next_epoch_id: CryptoHash, approvals: [String], epoch_sync_data_hash: String?, block_body_hash: String?, block_ordinal: UInt64?, timestamp_nanosec: String) {
        self.next_bp_hash = next_bp_hash
...
public struct AccountView: Codable, Sendable {
    ...
    public init(global_contract_account_id: String?, amount: NearToken, code_hash: CryptoHash, global_contract_hash: String?, storage_paid_at: UInt64?, storage_usage: UInt64, locked: NearToken) {
...
public struct VMConfigView: Codable, Sendable {
    ...
    public init(limit_config: LimitConfig, implicit_account_creation: Bool, ext_costs: ExtCostsConfigView, global_contract_host_fns: Bool, discard_custom_sections: Bool, fix_contract_loading_cost: Bool, regular_op_cost: UInt32, eth_implicit_accounts: Bool, grow_mem_cost: UInt32, reftypes_bulk_memory: Bool, storage_get_mode: StorageGetMode, deterministic_account_ids: Bool, saturating_float_to_int: Bool, vm_kind: VMKind) {
...
public struct RpcStatusResponse: Codable, Sendable {
    ...
    public init(latest_protocol_version: UInt32, node_public_key: PublicKey, detailed_debug_status: String?, validator_public_key: String?, chain_id: String, sync_info: StatusSyncInfo, validators: [ValidatorInfo], rpc_addr: String?, protocol_version: UInt32, version: Version, node_key: String?, uptime_sec: Int64, validator_account_id: String?, genesis_hash: CryptoHash) {
        self.latest_protocol_version = latest_protocol_version
...
public struct JsonRpcRequest_for_gas_price: Codable, Sendable {
    ...
    public init(jsonrpc: String, params: RpcGasPriceRequest, id: String, method: String) {
        self.jsonrpc = jsonrpc
        self.params = params
        self.id = id
        self.method = method
...
public struct LimitConfig: Codable, Sendable {
    ...
    public init(max_total_prepaid_gas: NearGas, initial_memory_pages: UInt32, max_total_log_length: UInt64, max_length_returned_data: UInt64, max_number_logs: UInt64, max_tables_per_contract: UInt32?, max_functions_number_per_contract: UInt64?, account_id_validity_rules_version: AccountIdValidityRulesVersion?, max_length_storage_key: UInt64, max_actions_per_receipt: UInt64, max_register_size: UInt64, max_number_registers: UInt64, registers_memory_limit: UInt64, max_contract_size: UInt64, max_length_storage_value: UInt64, max_number_input_data_dependencies: UInt64, max_length_method_name: UInt64, max_arguments_length: UInt64, max_number_bytes_method_names: UInt64, max_elements_per_contract_table: String?, per_receipt_storage_proof_size_limit: String, max_receipt_size: UInt64, max_yield_payload_size: UInt64, max_promises_per_function_call_action: UInt64, max_stack_height: UInt32, max_transaction_size: UInt64, max_locals_per_contract: UInt64?, yield_timeout_length_in_blocks: UInt64, max_gas_burnt: NearGas, max_memory_pages: UInt32) {
...
public struct JsonRpcRequest_for_EXPERIMENTAL_split_storage_info: Codable, Sendable {
    ...
    public init(jsonrpc: String, params: RpcSplitStorageInfoRequest, id: String, method: String) {
        self.jsonrpc = jsonrpc
        self.params = params
        self.id = id
        self.method = method
...
public struct CongestionInfoView: Codable, Sendable {
    ...
    public init(receipt_bytes: UInt64, allowed_shard: String, delayed_receipts_gas: String, buffered_receipts_gas: String) {
...
public struct ExtCostsConfigView: Codable, Sendable {
    ...
    public init(write_register_byte: NearGas, storage_iter_next_value_byte: NearGas, storage_write_key_byte: NearGas, validator_stake_base: NearGas, yield_resume_base: NearGas, bls12381_p2_sum_element: NearGas, ecrecover_base: NearGas, keccak512_byte: NearGas, storage_read_base: NearGas, ripemd160_base: NearGas, read_register_base: NearGas, bls12381_map_fp_to_g1_element: NearGas, storage_iter_create_range_base: NearGas, utf16_decoding_byte: NearGas, storage_iter_next_key_byte: NearGas, storage_has_key_byte: NearGas, log_base: NearGas, read_memory_byte: NearGas, bls12381_g2_multiexp_element: NearGas, bls12381_g2_multiexp_base: NearGas, storage_iter_create_from_byte: NearGas, storage_write_value_byte: NearGas, storage_remove_ret_value_byte: NearGas, utf16_decoding_base: NearGas, yield_create_byte: NearGas, contract_loading_bytes: NearGas, bls12381_map_fp2_to_g2_element: NearGas, storage_has_key_base: NearGas, log_byte: NearGas, read_register_byte: NearGas, storage_iter_create_prefix_byte: NearGas, contract_compile_bytes: NearGas, contract_loading_base: NearGas, bls12381_p2_decompress_base: NearGas, bls12381_map_fp2_to_g2_base: NearGas, storage_remove_key_byte: NearGas, touching_trie_node: NearGas, bls12381_map_fp_to_g1_base: NearGas, storage_write_base: NearGas, storage_iter_next_base: NearGas, storage_read_value_byte: NearGas, bls12381_g1_multiexp_element: NearGas, keccak512_base: NearGas, promise_and_base: NearGas, storage_large_read_overhead_byte: NearGas, ripemd160_block: NearGas, storage_remove_base: NearGas, utf8_decoding_byte: NearGas, alt_bn128_pairing_check_element: NearGas, storage_write_evicted_byte: NearGas, alt_bn128_g1_sum_base: NearGas, bls12381_p1_sum_element: NearGas, contract_compile_base: NearGas, read_memory_base: NearGas, sha256_byte: NearGas, base: NearGas, promise_return: NearGas, bls12381_g1_multiexp_base: NearGas, bls12381_pairing_element: NearGas, storage_large_read_overhead_base: NearGas, keccak256_byte: NearGas, storage_iter_create_prefix_base: NearGas, sha256_base: NearGas, yield_resume_byte: NearGas, yield_create_base: NearGas, keccak256_base: NearGas, alt_bn128_g1_sum_element: NearGas, storage_iter_create_to_byte: NearGas, bls12381_p1_sum_base: NearGas, write_memory_byte: NearGas, bls12381_p1_decompress_element: NearGas, write_memory_base: NearGas, ed25519_verify_byte: NearGas, bls12381_p1_decompress_base: NearGas, promise_and_per_promise: NearGas, utf8_decoding_base: NearGas, bls12381_pairing_base: NearGas, alt_bn128_pairing_check_base: NearGas, bls12381_p2_sum_base: NearGas, bls12381_p2_decompress_element: NearGas, read_cached_trie_node: NearGas, ed25519_verify_base: NearGas, alt_bn128_g1_multiexp_element: NearGas, storage_read_key_byte: NearGas, alt_bn128_g1_multiexp_base: NearGas, write_register_base: NearGas, validator_total_stake_base: NearGas) {
...
public struct JsonRpcRequest_for_health: Codable, Sendable {
    ...
    public init(jsonrpc: String, params: RpcHealthRequest, id: String, method: String) {
        self.jsonrpc = jsonrpc
        self.params = params
        self.id = id
        self.method = method
