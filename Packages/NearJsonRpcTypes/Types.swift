...
// Generated on: 2025-09-29 06:19:23 +0000
...
public struct RuntimeFeesConfigView: Codable, Sendable {
    ...
    public init(action_receipt_creation_config: Fee, pessimistic_gas_price_inflation_ratio: [Int32], action_creation_config: ActionCreationConfigView, data_receipt_creation_config: DataReceiptCreationConfigView, burnt_gas_reward: [Int32], storage_usage_config: StorageUsageConfigView) {
...
public struct DumpConfig: Codable, Sendable {
    ...
    public init(credentials_file: String?, location: ExternalStorageLocation, restart_dump_for_shards: [ShardId]?, iteration_delay: String?) {
...
public struct CongestionControlConfigView: Codable, Sendable {
    ...
    public init(max_outgoing_gas: NearGas, max_congestion_missed_chunks: UInt64, outgoing_receipts_usual_size_limit: UInt64, max_tx_gas: NearGas, max_congestion_memory_consumption: UInt64, allowed_shard_outgoing_gas: NearGas, outgoing_receipts_big_size_limit: UInt64, reject_tx_congestion_threshold: String, min_tx_gas: NearGas, min_outgoing_gas: NearGas, max_congestion_incoming_gas: NearGas, max_congestion_outgoing_gas: NearGas) {
...
public struct RpcProtocolConfigResponse: Codable, Sendable {
    ...
    public init(protocol_treasury_account: AccountId, epoch_length: UInt64, minimum_stake_ratio: [Int32], num_block_producer_seats: UInt64, min_gas_price: NearToken, num_block_producer_seats_per_shard: [UInt64], target_validator_mandates_per_shard: UInt64, dynamic_resharding: Bool, shuffle_shard_assignment_for_chunk_producers: Bool, max_kickout_stake_perc: String, block_producer_kickout_threshold: String, max_inflation_rate: [Int32], protocol_reward_rate: [Int32], chunk_producer_kickout_threshold: String, protocol_upgrade_stake_threshold: [Int32], transaction_validity_period: UInt64, minimum_validators_per_shard: UInt64, avg_hidden_validator_seats_per_shard: [UInt64], online_min_threshold: [Int32], num_blocks_per_year: UInt64, protocol_version: UInt32, minimum_stake_divisor: UInt64, shard_layout: ShardLayout, max_gas_price: NearToken, chain_id: String, fishermen_threshold: NearToken, gas_price_adjustment_rate: [Int32], chunk_validator_only_kickout_threshold: String, runtime_config: RuntimeConfigView, genesis_time: String, genesis_height: UInt64, online_max_threshold: [Int32], gas_limit: NearGas) {
...
public struct JsonRpcRequest_for_next_light_client_block: Codable, Sendable {
    ...
    public init(id: String, method: String, jsonrpc: String, params: RpcLightClientNextBlockRequest) {
        self.id = id
        self.method = method
        self.jsonrpc = jsonrpc
        self.params = params
...
public struct JsonRpcRequest_for_validators: Codable, Sendable {
    ...
    public init(id: String, method: String, jsonrpc: String, params: RpcValidatorRequest) {
        self.id = id
        self.method = method
        self.jsonrpc = jsonrpc
        self.params = params
...
public struct VMConfigView: Codable, Sendable {
    ...
    public init(eth_implicit_accounts: Bool, storage_get_mode: StorageGetMode, fix_contract_loading_cost: Bool, saturating_float_to_int: Bool, regular_op_cost: UInt32, limit_config: LimitConfig, grow_mem_cost: UInt32, reftypes_bulk_memory: Bool, global_contract_host_fns: Bool, vm_kind: VMKind, implicit_account_creation: Bool, discard_custom_sections: Bool, ext_costs: ExtCostsConfigView, deterministic_account_ids: Bool) {
...
public struct JsonRpcRequest_for_EXPERIMENTAL_changes: Codable, Sendable {
    ...
    public init(id: String, method: String, jsonrpc: String, params: RpcStateChangesInBlockByTypeRequest) {
        self.id = id
        self.method = method
        self.jsonrpc = jsonrpc
        self.params = params
...
public struct ExecutionOutcomeView: Codable, Sendable {
    ...
    public init(executor_id: AccountId, logs: [String], receipt_ids: [CryptoHash], status: ExecutionStatusView, metadata: ExecutionMetadataView?, tokens_burnt: NearToken, gas_burnt: NearGas) {
...
public struct GenesisConfig: Codable, Sendable {
    ...
    public init(protocol_upgrade_stake_threshold: [Int32]?, num_chunk_validator_seats: UInt64?, protocol_version: UInt32, chunk_validator_only_kickout_threshold: String?, chunk_producer_kickout_threshold: String, validators: [AccountInfo], minimum_stake_divisor: UInt64?, num_block_producer_seats_per_shard: [UInt64], shard_layout: ShardLayout?, epoch_length: UInt64, target_validator_mandates_per_shard: UInt64?, dynamic_resharding: Bool, total_supply: NearToken, chunk_producer_assignment_changes_limit: UInt64?, protocol_reward_rate: [Int32], min_gas_price: NearToken, use_production_config: Bool?, online_min_threshold: [Int32]?, num_chunk_producer_seats: UInt64?, num_chunk_only_producer_seats: UInt64?, transaction_validity_period: UInt64, fishermen_threshold: NearToken, gas_limit: NearGas, minimum_validators_per_shard: UInt64?, shuffle_shard_assignment_for_chunk_producers: Bool?, online_max_threshold: [Int32]?, num_blocks_per_year: UInt64, genesis_height: UInt64, avg_hidden_validator_seats_per_shard: [UInt64], block_producer_kickout_threshold: String, minimum_stake_ratio: [Int32]?, genesis_time: String, max_inflation_rate: [Int32], gas_price_adjustment_rate: [Int32], max_kickout_stake_perc: String?, protocol_treasury_account: AccountId, num_block_producer_seats: UInt64, max_gas_price: NearToken, chain_id: String) {
        self.protocol_upgrade_stake_threshold = protocol_upgrade_stake_threshold
...
public struct RpcClientConfigResponse: Codable, Sendable {
    ...
    public init(header_sync_stall_ban_timeout: [UInt64], ttl_account_id_router: [UInt64], state_requests_per_throttle_period: String, block_fetch_horizon: UInt64, save_invalid_witnesses: Bool, protocol_version_check: ProtocolVersionCheckConfig, log_summary_period: [UInt64], block_production_tracking_delay: [UInt64], enable_statistics_export: Bool, catchup_step_period: [UInt64], state_sync_retry_backoff: [UInt64], sync_check_period: [UInt64], archive: Bool, expected_shutdown: MutableConfigValue, state_sync: StateSyncConfig, epoch_sync: EpochSyncConfig, tracked_shards_config: TrackedShardsConfig, chunk_validation_threads: String, header_sync_initial_timeout: [UInt64], cloud_archival_reader: String?, state_sync_external_backoff: [UInt64], rpc_addr: String?, max_block_production_delay: [UInt64], produce_empty_blocks: Bool, chain_id: String, skip_sync_wait: Bool, block_header_fetch_horizon: UInt64, gc: GCConfig, orphan_state_witness_max_size: UInt64, produce_chunk_add_transactions_time_limit: String, log_summary_style: LogSummaryStyle, chunk_request_retry_period: [UInt64], save_latest_witnesses: Bool, epoch_length: UInt64, view_client_threads: String, chunk_wait_mult: [Int32], num_block_producer_seats: UInt64, state_sync_external_timeout: [UInt64], doomslug_step_period: [UInt64], resharding_config: MutableConfigValue, enable_multiline_logging: Bool, state_sync_enabled: Bool, state_request_server_threads: String, transaction_pool_size_limit: UInt64?, transaction_request_handler_threads: String, header_sync_progress_timeout: [UInt64], save_trie_changes: Bool, client_background_migration_threads: String, sync_step_period: [UInt64], header_sync_expected_height_per_second: UInt64, state_request_throttle_period: [UInt64], max_block_wait_delay: [UInt64], version: Version, save_tx_outcomes: Bool, min_num_peers: String, cloud_archival_writer: String?, tx_routing_height_horizon: UInt64, sync_height_threshold: UInt64, min_block_production_delay: [UInt64], trie_viewer_state_size_limit: UInt64?, save_untracked_partial_chunks_parts: Bool, state_sync_p2p_timeout: [UInt64], orphan_state_witness_pool_size: String, sync_max_block_requests: String, max_gas_burnt_view: String?, chunk_distribution_network: String?) {
...
public struct JsonRpcRequest_for_genesis_config: Codable, Sendable {
    ...
    public init(id: String, method: String, jsonrpc: String, params: GenesisConfigRequest) {
        self.id = id
        self.method = method
        self.jsonrpc = jsonrpc
        self.params = params
...
public struct NetworkInfoView: Codable, Sendable {
    ...
    public init(known_producers: [KnownProducerView], tier1_connections: [PeerInfoView], connected_peers: [PeerInfoView], tier1_accounts_keys: [PublicKey], peer_max_count: UInt32, num_connected_peers: String, tier1_accounts_data: [AccountDataView]) {
...
public struct JsonRpcRequest_for_status: Codable, Sendable {
    ...
    public init(id: String, method: String, jsonrpc: String, params: RpcStatusRequest) {
        self.id = id
        self.method = method
        self.jsonrpc = jsonrpc
        self.params = params
...
public struct JsonRpcRequest_for_client_config: Codable, Sendable {
    ...
    public init(id: String, method: String, jsonrpc: String, params: RpcClientConfigRequest) {
        self.id = id
        self.method = method
        self.jsonrpc = jsonrpc
        self.params = params
...
public struct JsonRpcRequest_for_tx: Codable, Sendable {
    ...
    public init(id: String, method: String, jsonrpc: String, params: RpcTransactionStatusRequest) {
        self.id = id
        self.method = method
        self.jsonrpc = jsonrpc
        self.params = params
...
public struct RpcNetworkInfoResponse: Codable, Sendable {
    ...
    public init(sent_bytes_per_sec: UInt64, known_producers: [RpcKnownProducer], peer_max_count: UInt32, active_peers: [RpcPeerInfo], num_active_peers: String, received_bytes_per_sec: UInt64) {
...
public struct DetailedDebugStatus: Codable, Sendable {
    ...
    public init(network_info: NetworkInfoView, current_header_head_status: BlockStatusView, current_head_status: BlockStatusView, catchup_status: [CatchupStatusView], block_production_delay_millis: UInt64, sync_status: String) {
...
public struct PeerInfoView: Codable, Sendable {
    ...
    public init(sent_bytes_per_sec: UInt64, archival: Bool, account_id: String?, peer_id: PublicKey, addr: String, block_hash: String?, last_time_received_message_millis: UInt64, connection_established_time_millis: UInt64, is_highest_block_invalid: Bool, is_outbound_peer: Bool, tracked_shards: [ShardId], nonce: UInt64, last_time_peer_requested_millis: UInt64, height: UInt64?, received_bytes_per_sec: UInt64) {
        self.sent_bytes_per_sec = sent_bytes_per_sec
...
public struct JsonRpcRequest_for_light_client_proof: Codable, Sendable {
    ...
    public init(id: String, method: String, jsonrpc: String, params: RpcLightClientExecutionProofRequest) {
        self.id = id
        self.method = method
        self.jsonrpc = jsonrpc
        self.params = params
...
public struct JsonRpcRequest_for_EXPERIMENTAL_congestion_level: Codable, Sendable {
    ...
    public init(id: String, method: String, jsonrpc: String, params: RpcCongestionLevelRequest) {
        self.id = id
        self.method = method
        self.jsonrpc = jsonrpc
        self.params = params
...
public struct JsonRpcRequest_for_maintenance_windows: Codable, Sendable {
    ...
    public init(id: String, method: String, jsonrpc: String, params: RpcMaintenanceWindowsRequest) {
        self.id = id
        self.method = method
        self.jsonrpc = jsonrpc
        self.params = params
...
public struct FinalExecutionOutcomeWithReceiptView: Codable, Sendable {
    ...
    public init(receipts_outcome: [ExecutionOutcomeWithIdView], transaction_outcome: ExecutionOutcomeWithIdView, receipts: [ReceiptView], transaction: SignedTransactionView, status: FinalExecutionStatus) {
        self.receipts_outcome = receipts_outcome
        self.transaction_outcome = transaction_outcome
...
public struct FunctionCallAction: Codable, Sendable {
    ...
    public init(gas: NearGas, args: String, deposit: NearToken, method_name: String) {
        self.gas = gas
        self.args = args
        self.deposit = deposit
...
public struct JsonRpcRequest_for_chunk: Codable, Sendable {
    ...
    public init(id: String, method: String, jsonrpc: String, params: RpcChunkRequest) {
        self.id = id
        self.method = method
        self.jsonrpc = jsonrpc
        self.params = params
...
public struct JsonRpcRequest_for_query: Codable, Sendable {
    ...
    public init(id: String, method: String, jsonrpc: String, params: RpcQueryRequest) {
        self.id = id
        self.method = method
        self.jsonrpc = jsonrpc
        self.params = params
...
public struct ReceiptView: Codable, Sendable {
    ...
    public init(priority: UInt64?, receipt_id: CryptoHash, receipt: ReceiptEnumView, receiver_id: AccountId, predecessor_id: AccountId) {
...
public struct RuntimeConfigView: Codable, Sendable {
    ...
    public init(transaction_costs: RuntimeFeesConfigView, storage_amount_per_byte: NearToken, wasm_config: VMConfigView, congestion_control_config: CongestionControlConfigView, witness_config: WitnessConfigView, account_creation_config: AccountCreationConfigView) {
...
public struct SignedTransactionView: Codable, Sendable {
    ...
    public init(priority_fee: UInt64?, public_key: PublicKey, signer_id: AccountId, receiver_id: AccountId, signature: Signature, nonce: UInt64, hash: CryptoHash, actions: [ActionView]) {
...
public struct AccountView: Codable, Sendable {
    ...
    public init(global_contract_hash: String?, global_contract_account_id: String?, amount: NearToken, storage_usage: UInt64, code_hash: CryptoHash, storage_paid_at: UInt64?, locked: NearToken) {
...
public struct CongestionInfoView: Codable, Sendable {
    ...
    public init(buffered_receipts_gas: String, allowed_shard: String, delayed_receipts_gas: String, receipt_bytes: UInt64) {
...
public struct JsonRpcRequest_for_EXPERIMENTAL_validators_ordered: Codable, Sendable {
    ...
    public init(id: String, method: String, jsonrpc: String, params: RpcValidatorsOrderedRequest) {
        self.id = id
        self.method = method
        self.jsonrpc = jsonrpc
        self.params = params
...
public struct JsonRpcRequest_for_health: Codable, Sendable {
    ...
    public init(id: String, method: String, jsonrpc: String, params: RpcHealthRequest) {
        self.id = id
        self.method = method
        self.jsonrpc = jsonrpc
        self.params = params
...
public struct RpcStatusResponse: Codable, Sendable {
    ...
    public init(detailed_debug_status: String?, latest_protocol_version: UInt32, rpc_addr: String?, validator_account_id: String?, version: Version, sync_info: StatusSyncInfo, validator_public_key: String?, node_public_key: PublicKey, chain_id: String, uptime_sec: Int64, genesis_hash: CryptoHash, protocol_version: UInt32, node_key: String?, validators: [ValidatorInfo]) {
...
public struct ActionCreationConfigView: Codable, Sendable {
    ...
    public init(create_account_cost: Fee, delete_key_cost: Fee, transfer_cost: Fee, delegate_cost: Fee, add_key_cost: AccessKeyCreationConfigView, function_call_cost_per_byte: Fee, delete_account_cost: Fee, function_call_cost: Fee, deploy_contract_cost_per_byte: Fee, deploy_contract_cost: Fee, stake_cost: Fee) {
...
public struct ChunkHeaderView: Codable, Sendable {
    ...
    public init(chunk_hash: CryptoHash, signature: Signature, bandwidth_requests: String?, rent_paid: NearToken?, prev_state_root: CryptoHash, gas_used: NearGas, shard_id: ShardId, height_included: UInt64, outcome_root: CryptoHash, height_created: UInt64, balance_burnt: NearToken, tx_root: CryptoHash, congestion_info: String?, encoded_length: UInt64, validator_proposals: [ValidatorStakeView], prev_block_hash: CryptoHash, encoded_merkle_root: CryptoHash, gas_limit: NearGas, outgoing_receipts_root: CryptoHash, validator_reward: NearToken?) {
...
public struct ShardLayoutV2: Codable, Sendable {
    ...
    public init(version: UInt32, boundary_accounts: [AccountId], id_to_index_map: String, shards_parent_map: String?, index_to_id_map: String, shard_ids: [ShardId], shards_split_map: String?) {
        self.version = version
...
public struct BlockHeaderInnerLiteView: Codable, Sendable {
    ...
    public init(next_epoch_id: CryptoHash, timestamp_nanosec: String, outcome_root: CryptoHash, epoch_id: CryptoHash, next_bp_hash: CryptoHash, timestamp: UInt64, height: UInt64, prev_state_root: CryptoHash, block_merkle_root: CryptoHash) {
...
public struct JsonRpcRequest_for_broadcast_tx_commit: Codable, Sendable {
    ...
    public init(id: String, method: String, jsonrpc: String, params: RpcSendTransactionRequest) {
        self.id = id
        self.method = method
        self.jsonrpc = jsonrpc
        self.params = params
...
public struct JsonRpcRequest_for_EXPERIMENTAL_receipt: Codable, Sendable {
    ...
    public init(id: String, method: String, jsonrpc: String, params: RpcReceiptRequest) {
        self.id = id
        self.method = method
        self.jsonrpc = jsonrpc
        self.params = params
...
public struct JsonRpcRequest_for_EXPERIMENTAL_split_storage_info: Codable, Sendable {
    ...
    public init(id: String, method: String, jsonrpc: String, params: RpcSplitStorageInfoRequest) {
        self.id = id
        self.method = method
        self.jsonrpc = jsonrpc
        self.params = params
...
public struct DelegateAction: Codable, Sendable {
    ...
    public init(sender_id: AccountId, actions: [NonDelegateAction], nonce: UInt64, public_key: PublicKey, receiver_id: AccountId, max_block_height: UInt64) {
...
public struct RpcValidatorResponse: Codable, Sendable {
    ...
    public init(epoch_start_height: UInt64, current_proposals: [ValidatorStakeView], current_validators: [CurrentEpochValidatorInfo], epoch_height: UInt64, prev_epoch_kickout: [ValidatorKickoutView], current_fishermen: [ValidatorStakeView], next_fishermen: [ValidatorStakeView], next_validators: [NextEpochValidatorInfo]) {
...
public struct JsonRpcRequest_for_EXPERIMENTAL_protocol_config: Codable, Sendable {
    ...
    public init(id: String, method: String, jsonrpc: String, params: RpcProtocolConfigRequest) {
        self.id = id
        self.method = method
        self.jsonrpc = jsonrpc
        self.params = params
...
public struct JsonRpcRequest_for_block: Codable, Sendable {
    ...
    public init(id: String, method: String, jsonrpc: String, params: RpcBlockRequest) {
        self.id = id
        self.method = method
        self.jsonrpc = jsonrpc
        self.params = params
...
public struct CurrentEpochValidatorInfo: Codable, Sendable {
    ...
    public init(public_key: PublicKey, stake: NearToken, num_produced_chunks_per_shard: [UInt64]?, shards_endorsed: [ShardId]?, account_id: AccountId, num_expected_chunks: UInt64?, num_expected_endorsements_per_shard: [UInt64]?, num_produced_blocks: UInt64, num_produced_endorsements_per_shard: [UInt64]?, num_expected_blocks: UInt64, num_produced_chunks: UInt64?, num_produced_endorsements: UInt64?, num_expected_chunks_per_shard: [UInt64]?, is_slashed: Bool, num_expected_endorsements: UInt64?, shards: [ShardId]) {
        self.public_key = public_key
        self.stake = stake
...
public struct StatusSyncInfo: Codable, Sendable {
    ...
    public init(earliest_block_height: UInt64?, epoch_start_height: UInt64?, latest_block_time: String, latest_block_height: UInt64, epoch_id: String?, syncing: Bool, latest_state_root: CryptoHash, earliest_block_time: String?, latest_block_hash: CryptoHash, earliest_block_hash: String?) {
...
public struct RpcLightClientExecutionProofResponse: Codable, Sendable {
    ...
    public init(outcome_proof: ExecutionOutcomeWithIdView, block_proof: [MerklePathItem], outcome_root_proof: [MerklePathItem], block_header_lite: LightClientBlockLiteView) {
...
public struct BlockHeaderView: Codable, Sendable {
    ...
    public init(last_final_block: CryptoHash, validator_proposals: [ValidatorStakeView], signature: Signature, epoch_sync_data_hash: String?, block_body_hash: String?, chunk_headers_root: CryptoHash, hash: CryptoHash, chunk_tx_root: CryptoHash, chunks_included: UInt64, block_ordinal: UInt64?, validator_reward: NearToken?, outcome_root: CryptoHash, prev_height: UInt64?, challenges_result: [SlashedValidator], prev_hash: CryptoHash, chunk_receipts_root: CryptoHash, chunk_mask: [Bool], block_merkle_root: CryptoHash, height: UInt64, gas_price: NearToken, last_ds_final_block: CryptoHash, next_bp_hash: CryptoHash, total_supply: NearToken, rent_paid: NearToken?, challenges_root: CryptoHash, chunk_endorsements: [[String]]?, timestamp_nanosec: String, random_value: CryptoHash, next_epoch_id: CryptoHash, timestamp: UInt64, prev_state_root: CryptoHash, approvals: [String], latest_protocol_version: UInt32, epoch_id: CryptoHash) {
...
public struct ExternalStorageConfig: Codable, Sendable {
    ...
    public init(location: ExternalStorageLocation, num_concurrent_requests_during_catchup: String?, num_concurrent_requests: String?, external_storage_fallback_threshold: UInt64?) {
        self.location = location
...
public struct JsonRpcRequest_for_EXPERIMENTAL_changes_in_block: Codable, Sendable {
    ...
    public init(id: String, method: String, jsonrpc: String, params: RpcStateChangesInBlockRequest) {
        self.id = id
        self.method = method
        self.jsonrpc = jsonrpc
        self.params = params
...
public struct LimitConfig: Codable, Sendable {
    ...
    public init(max_receipt_size: UInt64, max_number_bytes_method_names: UInt64, max_elements_per_contract_table: String?, max_memory_pages: UInt32, account_id_validity_rules_version: AccountIdValidityRulesVersion?, max_arguments_length: UInt64, max_register_size: UInt64, initial_memory_pages: UInt32, max_total_log_length: UInt64, max_length_storage_key: UInt64, max_yield_payload_size: UInt64, max_length_storage_value: UInt64, yield_timeout_length_in_blocks: UInt64, max_gas_burnt: NearGas, max_number_input_data_dependencies: UInt64, max_stack_height: UInt32, max_number_registers: UInt64, registers_memory_limit: UInt64, max_total_prepaid_gas: NearGas, max_transaction_size: UInt64, max_length_returned_data: UInt64, max_number_logs: UInt64, max_actions_per_receipt: UInt64, max_contract_size: UInt64, max_length_method_name: UInt64, max_functions_number_per_contract: UInt64?, max_tables_per_contract: UInt32?, max_promises_per_function_call_action: UInt64, per_receipt_storage_proof_size_limit: String, max_locals_per_contract: UInt64?) {
...
public struct NextEpochValidatorInfo: Codable, Sendable {
    ...
    public init(account_id: AccountId, shards: [ShardId], stake: NearToken, public_key: PublicKey) {
        self.account_id = account_id
        self.shards = shards
        self.stake = stake
        self.public_key = public_key
...
public struct ExtCostsConfigView: Codable, Sendable {
    ...
    public init(utf16_decoding_byte: NearGas, bls12381_g1_multiexp_element: NearGas, log_byte: NearGas, storage_write_base: NearGas, yield_create_base: NearGas, storage_iter_next_base: NearGas, keccak512_byte: NearGas, storage_large_read_overhead_base: NearGas, ripemd160_block: NearGas, storage_iter_create_to_byte: NearGas, storage_has_key_byte: NearGas, contract_compile_bytes: NearGas, utf16_decoding_base: NearGas, alt_bn128_g1_multiexp_base: NearGas, storage_iter_create_from_byte: NearGas, bls12381_g2_multiexp_base: NearGas, bls12381_g2_multiexp_element: NearGas, storage_read_base: NearGas, alt_bn128_g1_multiexp_element: NearGas, read_register_byte: NearGas, storage_large_read_overhead_byte: NearGas, bls12381_p1_decompress_element: NearGas, read_memory_byte: NearGas, storage_iter_next_key_byte: NearGas, storage_iter_create_range_base: NearGas, bls12381_p1_sum_base: NearGas, promise_return: NearGas, storage_read_key_byte: NearGas, sha256_base: NearGas, storage_has_key_base: NearGas, bls12381_pairing_element: NearGas, storage_write_evicted_byte: NearGas, bls12381_p2_decompress_base: NearGas, storage_iter_next_value_byte: NearGas, bls12381_map_fp2_to_g2_element: NearGas, write_memory_base: NearGas, bls12381_map_fp_to_g1_element: NearGas, contract_loading_bytes: NearGas, bls12381_map_fp_to_g1_base: NearGas, ed25519_verify_base: NearGas, touching_trie_node: NearGas, keccak256_base: NearGas, bls12381_p2_decompress_element: NearGas, alt_bn128_pairing_check_element: NearGas, bls12381_map_fp2_to_g2_base: NearGas, utf8_decoding_byte: NearGas, read_memory_base: NearGas, write_register_base: NearGas, bls12381_p2_sum_base: NearGas, write_register_byte: NearGas, sha256_byte: NearGas, validator_total_stake_base: NearGas, promise_and_base: NearGas, ripemd160_base: NearGas, storage_iter_create_prefix_byte: NearGas, yield_resume_byte: NearGas, alt_bn128_g1_sum_base: NearGas, bls12381_p2_sum_element: NearGas, storage_read_value_byte: NearGas, yield_create_byte: NearGas, storage_write_value_byte: NearGas, write_memory_byte: NearGas, validator_stake_base: NearGas, utf8_decoding_base: NearGas, alt_bn128_pairing_check_base: NearGas, promise_and_per_promise: NearGas, storage_remove_ret_value_byte: NearGas, ed25519_verify_byte: NearGas, bls12381_pairing_base: NearGas, bls12381_p1_decompress_base: NearGas, log_base: NearGas, ecrecover_base: NearGas, read_cached_trie_node: NearGas, storage_remove_base: NearGas, bls12381_p1_sum_element: NearGas, bls12381_g1_multiexp_base: NearGas, keccak512_base: NearGas, contract_loading_base: NearGas, keccak256_byte: NearGas, alt_bn128_g1_sum_element: NearGas, yield_resume_base: NearGas, storage_iter_create_prefix_base: NearGas, contract_compile_base: NearGas, base: NearGas, read_register_base: NearGas, storage_remove_key_byte: NearGas, storage_write_key_byte: NearGas) {
