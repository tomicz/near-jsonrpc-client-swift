...
// Generated on: 2025-10-05 01:46:41 +0000
...
public struct ExecutionOutcomeView: Codable, Sendable {
    ...
    public init(tokens_burnt: NearToken, executor_id: AccountId, gas_burnt: NearGas, logs: [String], metadata: ExecutionMetadataView?, receipt_ids: [CryptoHash], status: ExecutionStatusView) {
...
public struct RpcProtocolConfigResponse: Codable, Sendable {
    ...
    public init(chunk_producer_kickout_threshold: String, protocol_upgrade_stake_threshold: [Int32], fishermen_threshold: NearToken, minimum_stake_divisor: UInt64, minimum_validators_per_shard: UInt64, dynamic_resharding: Bool, chunk_validator_only_kickout_threshold: String, shuffle_shard_assignment_for_chunk_producers: Bool, protocol_version: UInt32, transaction_validity_period: UInt64, target_validator_mandates_per_shard: UInt64, epoch_length: UInt64, gas_price_adjustment_rate: [Int32], num_block_producer_seats_per_shard: [UInt64], chain_id: String, online_min_threshold: [Int32], shard_layout: ShardLayout, protocol_reward_rate: [Int32], gas_limit: NearGas, block_producer_kickout_threshold: String, avg_hidden_validator_seats_per_shard: [UInt64], num_blocks_per_year: UInt64, runtime_config: RuntimeConfigView, genesis_height: UInt64, max_gas_price: NearToken, num_block_producer_seats: UInt64, protocol_treasury_account: AccountId, genesis_time: String, min_gas_price: NearToken, max_kickout_stake_perc: String, online_max_threshold: [Int32], minimum_stake_ratio: [Int32], max_inflation_rate: [Int32]) {
...
public struct AccessKeyCreationConfigView: Codable, Sendable {
    ...
    public init(function_call_cost: Fee, full_access_cost: Fee, function_call_cost_per_byte: Fee) {
...
public struct RpcChunkResponse: Codable, Sendable {
    ...
    public init(receipts: [ReceiptView], transactions: [SignedTransactionView], author: AccountId, header: ChunkHeaderView) {
...
public struct JsonRpcRequest_for_maintenance_windows: Codable, Sendable {
    ...
    public init(jsonrpc: String, id: String, params: RpcMaintenanceWindowsRequest, method: String) {
...
public struct JsonRpcRequest_for_health: Codable, Sendable {
    ...
    public init(jsonrpc: String, id: String, params: RpcHealthRequest, method: String) {
        self.jsonrpc = jsonrpc
        self.id = id
        self.params = params
        self.method = method
...
public struct JsonRpcRequest_for_tx: Codable, Sendable {
    ...
    public init(jsonrpc: String, id: String, params: RpcTransactionStatusRequest, method: String) {
        self.jsonrpc = jsonrpc
        self.id = id
        self.params = params
        self.method = method
...
public struct SignedTransactionView: Codable, Sendable {
    ...
    public init(signature: Signature, actions: [ActionView], priority_fee: UInt64?, hash: CryptoHash, receiver_id: AccountId, nonce: UInt64, public_key: PublicKey, signer_id: AccountId) {
...
public struct JsonRpcRequest_for_client_config: Codable, Sendable {
    ...
    public init(jsonrpc: String, id: String, params: RpcClientConfigRequest, method: String) {
        self.jsonrpc = jsonrpc
        self.id = id
        self.params = params
        self.method = method
...
public struct JsonRpcRequest_for_next_light_client_block: Codable, Sendable {
    ...
    public init(jsonrpc: String, id: String, params: RpcLightClientNextBlockRequest, method: String) {
        self.jsonrpc = jsonrpc
        self.id = id
        self.params = params
        self.method = method
...
public struct JsonRpcRequest_for_chunk: Codable, Sendable {
    ...
    public init(jsonrpc: String, id: String, params: RpcChunkRequest, method: String) {
        self.jsonrpc = jsonrpc
        self.id = id
        self.params = params
        self.method = method
...
public struct Version: Codable, Sendable {
    ...
    public init(version: String, commit: String, build: String, rustc_version: String?) {
...
public struct JsonRpcRequest_for_EXPERIMENTAL_congestion_level: Codable, Sendable {
    ...
    public init(jsonrpc: String, id: String, params: RpcCongestionLevelRequest, method: String) {
        self.jsonrpc = jsonrpc
        self.id = id
        self.params = params
        self.method = method
...
public struct JsonRpcRequest_for_query: Codable, Sendable {
    ...
    public init(jsonrpc: String, id: String, params: RpcQueryRequest, method: String) {
        self.jsonrpc = jsonrpc
        self.id = id
        self.params = params
        self.method = method
...
public struct RpcValidatorResponse: Codable, Sendable {
    ...
    public init(prev_epoch_kickout: [ValidatorKickoutView], next_validators: [NextEpochValidatorInfo], epoch_start_height: UInt64, next_fishermen: [ValidatorStakeView], epoch_height: UInt64, current_proposals: [ValidatorStakeView], current_validators: [CurrentEpochValidatorInfo], current_fishermen: [ValidatorStakeView]) {
...
public struct FunctionCallAction: Codable, Sendable {
    ...
    public init(args: String, gas: NearGas, deposit: NearToken, method_name: String) {
        self.args = args
        self.gas = gas
...
public struct ExtCostsConfigView: Codable, Sendable {
    ...
    public init(storage_iter_next_key_byte: NearGas, utf16_decoding_byte: NearGas, alt_bn128_pairing_check_base: NearGas, write_memory_base: NearGas, utf8_decoding_base: NearGas, log_base: NearGas, keccak256_byte: NearGas, storage_has_key_byte: NearGas, storage_large_read_overhead_base: NearGas, bls12381_p2_sum_base: NearGas, read_register_byte: NearGas, yield_create_base: NearGas, write_register_base: NearGas, read_memory_byte: NearGas, keccak512_base: NearGas, read_register_base: NearGas, ripemd160_block: NearGas, yield_create_byte: NearGas, contract_compile_base: NearGas, storage_iter_create_prefix_byte: NearGas, base: NearGas, alt_bn128_pairing_check_element: NearGas, contract_loading_base: NearGas, storage_write_evicted_byte: NearGas, bls12381_p2_sum_element: NearGas, storage_iter_create_prefix_base: NearGas, storage_iter_next_base: NearGas, touching_trie_node: NearGas, storage_write_key_byte: NearGas, alt_bn128_g1_sum_base: NearGas, storage_write_base: NearGas, keccak512_byte: NearGas, storage_iter_create_to_byte: NearGas, log_byte: NearGas, keccak256_base: NearGas, bls12381_p2_decompress_element: NearGas, storage_large_read_overhead_byte: NearGas, storage_remove_key_byte: NearGas, sha256_byte: NearGas, bls12381_g2_multiexp_element: NearGas, read_cached_trie_node: NearGas, write_register_byte: NearGas, storage_read_key_byte: NearGas, alt_bn128_g1_sum_element: NearGas, bls12381_map_fp_to_g1_element: NearGas, promise_and_per_promise: NearGas, bls12381_p2_decompress_base: NearGas, storage_has_key_base: NearGas, bls12381_map_fp2_to_g2_base: NearGas, ed25519_verify_base: NearGas, bls12381_map_fp_to_g1_base: NearGas, storage_iter_next_value_byte: NearGas, bls12381_pairing_element: NearGas, ed25519_verify_byte: NearGas, utf8_decoding_byte: NearGas, read_memory_base: NearGas, yield_resume_byte: NearGas, storage_remove_ret_value_byte: NearGas, storage_read_base: NearGas, storage_write_value_byte: NearGas, storage_remove_base: NearGas, bls12381_g1_multiexp_element: NearGas, promise_return: NearGas, bls12381_map_fp2_to_g2_element: NearGas, storage_read_value_byte: NearGas, write_memory_byte: NearGas, bls12381_g2_multiexp_base: NearGas, bls12381_p1_sum_element: NearGas, ripemd160_base: NearGas, bls12381_g1_multiexp_base: NearGas, validator_stake_base: NearGas, bls12381_pairing_base: NearGas, contract_loading_bytes: NearGas, alt_bn128_g1_multiexp_base: NearGas, bls12381_p1_decompress_base: NearGas, sha256_base: NearGas, bls12381_p1_decompress_element: NearGas, storage_iter_create_range_base: NearGas, promise_and_base: NearGas, bls12381_p1_sum_base: NearGas, contract_compile_bytes: NearGas, ecrecover_base: NearGas, utf16_decoding_base: NearGas, storage_iter_create_from_byte: NearGas, alt_bn128_g1_multiexp_element: NearGas, yield_resume_base: NearGas, validator_total_stake_base: NearGas) {
...
public struct ActionCreationConfigView: Codable, Sendable {
    ...
    public init(add_key_cost: AccessKeyCreationConfigView, function_call_cost: Fee, delete_key_cost: Fee, transfer_cost: Fee, deploy_contract_cost_per_byte: Fee, delete_account_cost: Fee, deploy_contract_cost: Fee, delegate_cost: Fee, stake_cost: Fee, create_account_cost: Fee, function_call_cost_per_byte: Fee) {
...
public struct LimitConfig: Codable, Sendable {
    ...
    public init(max_number_logs: UInt64, max_memory_pages: UInt32, max_transaction_size: UInt64, max_number_bytes_method_names: UInt64, max_number_input_data_dependencies: UInt64, max_length_method_name: UInt64, max_stack_height: UInt32, max_total_log_length: UInt64, max_locals_per_contract: UInt64?, max_register_size: UInt64, max_length_storage_value: UInt64, max_actions_per_receipt: UInt64, account_id_validity_rules_version: AccountIdValidityRulesVersion?, max_yield_payload_size: UInt64, max_contract_size: UInt64, max_total_prepaid_gas: NearGas, yield_timeout_length_in_blocks: UInt64, max_arguments_length: UInt64, initial_memory_pages: UInt32, max_tables_per_contract: UInt32?, max_length_returned_data: UInt64, max_length_storage_key: UInt64, per_receipt_storage_proof_size_limit: String, max_functions_number_per_contract: UInt64?, max_receipt_size: UInt64, max_gas_burnt: NearGas, max_promises_per_function_call_action: UInt64, registers_memory_limit: UInt64, max_number_registers: UInt64, max_elements_per_contract_table: String?) {
...
public struct FinalExecutionOutcomeWithReceiptView: Codable, Sendable {
    ...
    public init(transaction: SignedTransactionView, transaction_outcome: ExecutionOutcomeWithIdView, status: FinalExecutionStatus, receipts_outcome: [ExecutionOutcomeWithIdView], receipts: [ReceiptView]) {
...
public struct JsonRpcRequest_for_EXPERIMENTAL_protocol_config: Codable, Sendable {
    ...
    public init(jsonrpc: String, id: String, params: RpcProtocolConfigRequest, method: String) {
        self.jsonrpc = jsonrpc
        self.id = id
        self.params = params
        self.method = method
...
public struct EpochSyncConfig: Codable, Sendable {
    ...
    public init(ignore_epoch_sync_network_requests: Bool?, disable_epoch_sync_for_bootstrapping: Bool?, epoch_sync_horizon: UInt64, timeout_for_epoch_sync: DurationAsStdSchemaProvider) {
...
public struct RpcStatusResponse: Codable, Sendable {
    ...
    public init(uptime_sec: Int64, node_public_key: PublicKey, node_key: String?, protocol_version: UInt32, validator_account_id: String?, rpc_addr: String?, detailed_debug_status: String?, validator_public_key: String?, validators: [ValidatorInfo], chain_id: String, genesis_hash: CryptoHash, latest_protocol_version: UInt32, version: Version, sync_info: StatusSyncInfo) {
...
public struct JsonRpcRequest_for_broadcast_tx_async: Codable, Sendable {
    ...
    public init(jsonrpc: String, id: String, params: RpcSendTransactionRequest, method: String) {
        self.jsonrpc = jsonrpc
        self.id = id
        self.params = params
        self.method = method
...
public struct ShardLayoutV1: Codable, Sendable {
    ...
    public init(boundary_accounts: [AccountId], version: UInt32, to_parent_shard_map: [ShardId]?, shards_split_map: [[ShardId]]?) {
...
public struct CongestionInfoView: Codable, Sendable {
    ...
    public init(receipt_bytes: UInt64, buffered_receipts_gas: String, allowed_shard: String, delayed_receipts_gas: String) {
...
public struct CongestionControlConfigView: Codable, Sendable {
    ...
    public init(max_congestion_missed_chunks: UInt64, outgoing_receipts_usual_size_limit: UInt64, min_outgoing_gas: NearGas, max_congestion_incoming_gas: NearGas, max_congestion_outgoing_gas: NearGas, min_tx_gas: NearGas, max_congestion_memory_consumption: UInt64, max_tx_gas: NearGas, max_outgoing_gas: NearGas, allowed_shard_outgoing_gas: NearGas, outgoing_receipts_big_size_limit: UInt64, reject_tx_congestion_threshold: String) {
...
public struct DumpConfig: Codable, Sendable {
    ...
    public init(restart_dump_for_shards: [ShardId]?, credentials_file: String?, location: ExternalStorageLocation, iteration_delay: String?) {
...
public struct JsonRpcRequest_for_EXPERIMENTAL_receipt: Codable, Sendable {
    ...
    public init(jsonrpc: String, id: String, params: RpcReceiptRequest, method: String) {
        self.jsonrpc = jsonrpc
        self.id = id
        self.params = params
        self.method = method
...
public struct BlockHeaderView: Codable, Sendable {
    ...
    public init(chunks_included: UInt64, chunk_endorsements: [[String]]?, timestamp_nanosec: String, last_ds_final_block: CryptoHash, validator_reward: NearToken?, chunk_tx_root: CryptoHash, approvals: [String], challenges_root: CryptoHash, chunk_headers_root: CryptoHash, height: UInt64, timestamp: UInt64, epoch_sync_data_hash: String?, epoch_id: CryptoHash, prev_hash: CryptoHash, validator_proposals: [ValidatorStakeView], block_merkle_root: CryptoHash, hash: CryptoHash, last_final_block: CryptoHash, outcome_root: CryptoHash, block_ordinal: UInt64?, signature: Signature, chunk_receipts_root: CryptoHash, prev_state_root: CryptoHash, gas_price: NearToken, rent_paid: NearToken?, block_body_hash: String?, prev_height: UInt64?, random_value: CryptoHash, total_supply: NearToken, next_bp_hash: CryptoHash, chunk_mask: [Bool], next_epoch_id: CryptoHash, latest_protocol_version: UInt32, challenges_result: [SlashedValidator]) {
...
public struct JsonRpcRequest_for_EXPERIMENTAL_validators_ordered: Codable, Sendable {
    ...
    public init(jsonrpc: String, id: String, params: RpcValidatorsOrderedRequest, method: String) {
        self.jsonrpc = jsonrpc
        self.id = id
        self.params = params
        self.method = method
...
public struct RuntimeConfigView: Codable, Sendable {
    ...
    public init(congestion_control_config: CongestionControlConfigView, wasm_config: VMConfigView, account_creation_config: AccountCreationConfigView, storage_amount_per_byte: NearToken, witness_config: WitnessConfigView, transaction_costs: RuntimeFeesConfigView) {
...
public struct JsonRpcRequest_for_EXPERIMENTAL_changes_in_block: Codable, Sendable {
    ...
    public init(jsonrpc: String, id: String, params: RpcStateChangesInBlockRequest, method: String) {
        self.jsonrpc = jsonrpc
        self.id = id
        self.params = params
        self.method = method
...
public struct RuntimeFeesConfigView: Codable, Sendable {
    ...
    public init(action_receipt_creation_config: Fee, action_creation_config: ActionCreationConfigView, pessimistic_gas_price_inflation_ratio: [Int32], burnt_gas_reward: [Int32], data_receipt_creation_config: DataReceiptCreationConfigView, storage_usage_config: StorageUsageConfigView) {
...
public struct JsonRpcRequest_for_block: Codable, Sendable {
    ...
    public init(jsonrpc: String, id: String, params: RpcBlockRequest, method: String) {
        self.jsonrpc = jsonrpc
        self.id = id
        self.params = params
        self.method = method
...
public struct JsonRpcRequest_for_network_info: Codable, Sendable {
    ...
    public init(jsonrpc: String, id: String, params: RpcNetworkInfoRequest, method: String) {
        self.jsonrpc = jsonrpc
        self.id = id
        self.params = params
        self.method = method
...
public struct JsonRpcRequest_for_EXPERIMENTAL_light_client_proof: Codable, Sendable {
    ...
    public init(jsonrpc: String, id: String, params: RpcLightClientExecutionProofRequest, method: String) {
        self.jsonrpc = jsonrpc
        self.id = id
        self.params = params
        self.method = method
...
public struct DelegateAction: Codable, Sendable {
    ...
    public init(actions: [NonDelegateAction], max_block_height: UInt64, nonce: UInt64, sender_id: AccountId, receiver_id: AccountId, public_key: PublicKey) {
        self.actions = actions
...
public struct RpcPeerInfo: Codable, Sendable {
    ...
    public init(addr: String?, id: PeerId, account_id: String?) {
        self.addr = addr
        self.id = id
        self.account_id = account_id
    }
...
public struct PeerInfoView: Codable, Sendable {
    ...
    public init(block_hash: String?, last_time_peer_requested_millis: UInt64, connection_established_time_millis: UInt64, peer_id: PublicKey, account_id: String?, nonce: UInt64, last_time_received_message_millis: UInt64, is_highest_block_invalid: Bool, tracked_shards: [ShardId], height: UInt64?, received_bytes_per_sec: UInt64, sent_bytes_per_sec: UInt64, addr: String, is_outbound_peer: Bool, archival: Bool) {
        self.block_hash = block_hash
...
public struct JsonRpcRequest_for_validators: Codable, Sendable {
    ...
    public init(jsonrpc: String, id: String, params: RpcValidatorRequest, method: String) {
        self.jsonrpc = jsonrpc
        self.id = id
        self.params = params
        self.method = method
...
public struct JsonRpcRequest_for_EXPERIMENTAL_split_storage_info: Codable, Sendable {
    ...
    public init(jsonrpc: String, id: String, params: RpcSplitStorageInfoRequest, method: String) {
        self.jsonrpc = jsonrpc
        self.id = id
        self.params = params
        self.method = method
...
public struct AccountView: Codable, Sendable {
    ...
    public init(global_contract_hash: String?, storage_usage: UInt64, code_hash: CryptoHash, amount: NearToken, locked: NearToken, storage_paid_at: UInt64?, global_contract_account_id: String?) {
...
public struct AccountDataView: Codable, Sendable {
    ...
    public init(account_key: PublicKey, timestamp: String, peer_id: PublicKey, proxies: [Tier1ProxyView]) {
...
public struct FinalExecutionOutcomeView: Codable, Sendable {
    ...
    public init(transaction: SignedTransactionView, status: FinalExecutionStatus, receipts_outcome: [ExecutionOutcomeWithIdView], transaction_outcome: ExecutionOutcomeWithIdView) {
        self.transaction = transaction
        self.status = status
        self.receipts_outcome = receipts_outcome
        self.transaction_outcome = transaction_outcome
...
public struct BlockHeaderInnerLiteView: Codable, Sendable {
    ...
    public init(epoch_id: CryptoHash, outcome_root: CryptoHash, prev_state_root: CryptoHash, timestamp_nanosec: String, timestamp: UInt64, height: UInt64, next_bp_hash: CryptoHash, next_epoch_id: CryptoHash, block_merkle_root: CryptoHash) {
        self.epoch_id = epoch_id
        self.outcome_root = outcome_root
        self.prev_state_root = prev_state_root
        self.timestamp_nanosec = timestamp_nanosec
...
public struct RpcNetworkInfoResponse: Codable, Sendable {
    ...
    public init(sent_bytes_per_sec: UInt64, received_bytes_per_sec: UInt64, known_producers: [RpcKnownProducer], num_active_peers: String, peer_max_count: UInt32, active_peers: [RpcPeerInfo]) {
        self.sent_bytes_per_sec = sent_bytes_per_sec
        self.received_bytes_per_sec = received_bytes_per_sec
...
public struct ReceiptView: Codable, Sendable {
    ...
    public init(predecessor_id: AccountId, receipt: ReceiptEnumView, receipt_id: CryptoHash, priority: UInt64?, receiver_id: AccountId) {
...
public struct ChunkHeaderView: Codable, Sendable {
    ...
    public init(validator_reward: NearToken?, outgoing_receipts_root: CryptoHash, height_created: UInt64, tx_root: CryptoHash, rent_paid: NearToken?, encoded_merkle_root: CryptoHash, balance_burnt: NearToken, bandwidth_requests: String?, congestion_info: String?, shard_id: ShardId, validator_proposals: [ValidatorStakeView], height_included: UInt64, gas_used: NearGas, outcome_root: CryptoHash, gas_limit: NearGas, encoded_length: UInt64, chunk_hash: CryptoHash, signature: Signature, prev_block_hash: CryptoHash, prev_state_root: CryptoHash) {
        self.validator_reward = validator_reward
...
public struct RpcClientConfigResponse: Codable, Sendable {
    ...
    public init(state_sync_retry_backoff: [UInt64], cloud_archival_writer: String?, state_request_server_threads: String, ttl_account_id_router: [UInt64], header_sync_progress_timeout: [UInt64], cloud_archival_reader: String?, skip_sync_wait: Bool, sync_check_period: [UInt64], min_block_production_delay: [UInt64], state_sync_external_timeout: [UInt64], produce_chunk_add_transactions_time_limit: String, rpc_addr: String?, chunk_request_retry_period: [UInt64], state_request_throttle_period: [UInt64], max_block_production_delay: [UInt64], chunk_validation_threads: String, doomslug_step_period: [UInt64], trie_viewer_state_size_limit: UInt64?, header_sync_initial_timeout: [UInt64], log_summary_period: [UInt64], state_requests_per_throttle_period: String, save_trie_changes: Bool, chain_id: String, orphan_state_witness_pool_size: String, enable_multiline_logging: Bool, block_fetch_horizon: UInt64, state_sync_external_backoff: [UInt64], epoch_length: UInt64, block_production_tracking_delay: [UInt64], header_sync_expected_height_per_second: UInt64, catchup_step_period: [UInt64], resharding_config: MutableConfigValue, block_header_fetch_horizon: UInt64, view_client_threads: String, chunk_wait_mult: [Int32], max_block_wait_delay: [UInt64], save_latest_witnesses: Bool, transaction_pool_size_limit: UInt64?, chunk_distribution_network: String?, transaction_request_handler_threads: String, state_sync_enabled: Bool, epoch_sync: EpochSyncConfig, tracked_shards_config: TrackedShardsConfig, log_summary_style: LogSummaryStyle, protocol_version_check: ProtocolVersionCheckConfig, tx_routing_height_horizon: UInt64, version: Version, state_sync: StateSyncConfig, max_gas_burnt_view: String?, header_sync_stall_ban_timeout: [UInt64], sync_step_period: [UInt64], sync_height_threshold: UInt64, archive: Bool, state_sync_p2p_timeout: [UInt64], expected_shutdown: MutableConfigValue, save_invalid_witnesses: Bool, client_background_migration_threads: String, save_untracked_partial_chunks_parts: Bool, orphan_state_witness_max_size: UInt64, enable_statistics_export: Bool, produce_empty_blocks: Bool, save_tx_outcomes: Bool, num_block_producer_seats: UInt64, gc: GCConfig, sync_max_block_requests: String, min_num_peers: String) {
...
public struct JsonRpcRequest_for_EXPERIMENTAL_light_client_block_proof: Codable, Sendable {
    ...
    public init(method: String, id: String, jsonrpc: String, params: RpcLightClientBlockProofRequest) {
        self.method = method
        self.id = id
        self.jsonrpc = jsonrpc
        self.params = params
...
public struct RpcReceiptResponse: Codable, Sendable {
    ...
    public init(receipt_id: CryptoHash, predecessor_id: AccountId, receipt: ReceiptEnumView, priority: UInt64?, receiver_id: AccountId) {
        self.receipt_id = receipt_id
        self.predecessor_id = predecessor_id
        self.receipt = receipt
        self.priority = priority
...
public struct DetailedDebugStatus: Codable, Sendable {
    ...
    public init(catchup_status: [CatchupStatusView], sync_status: String, block_production_delay_millis: UInt64, current_head_status: BlockStatusView, current_header_head_status: BlockStatusView, network_info: NetworkInfoView) {
...
public struct ExternalStorageConfig: Codable, Sendable {
    ...
    public init(num_concurrent_requests: String?, external_storage_fallback_threshold: UInt64?, location: ExternalStorageLocation, num_concurrent_requests_during_catchup: String?) {
...
public struct StatusSyncInfo: Codable, Sendable {
    ...
    public init(epoch_start_height: UInt64?, latest_state_root: CryptoHash, latest_block_height: UInt64, latest_block_hash: CryptoHash, epoch_id: String?, latest_block_time: String, syncing: Bool, earliest_block_hash: String?, earliest_block_time: String?, earliest_block_height: UInt64?) {
        self.epoch_start_height = epoch_start_height
...
public struct ShardLayoutV2: Codable, Sendable {
    ...
    public init(index_to_id_map: String, shards_split_map: String?, version: UInt32, shards_parent_map: String?, shard_ids: [ShardId], id_to_index_map: String, boundary_accounts: [AccountId]) {
...
public struct NetworkInfoView: Codable, Sendable {
    ...
    public init(tier1_connections: [PeerInfoView], known_producers: [KnownProducerView], connected_peers: [PeerInfoView], tier1_accounts_data: [AccountDataView], num_connected_peers: String, peer_max_count: UInt32, tier1_accounts_keys: [PublicKey]) {
...
public struct RpcLightClientExecutionProofResponse: Codable, Sendable {
    ...
    public init(block_proof: [MerklePathItem], outcome_root_proof: [MerklePathItem], outcome_proof: ExecutionOutcomeWithIdView, block_header_lite: LightClientBlockLiteView) {
        self.block_proof = block_proof
...
public struct CurrentEpochValidatorInfo: Codable, Sendable {
    ...
    public init(num_produced_endorsements: UInt64?, shards_endorsed: [ShardId]?, num_produced_chunks_per_shard: [UInt64]?, num_expected_endorsements_per_shard: [UInt64]?, num_expected_chunks_per_shard: [UInt64]?, num_produced_chunks: UInt64?, stake: NearToken, account_id: AccountId, num_expected_chunks: UInt64?, shards: [ShardId], num_produced_endorsements_per_shard: [UInt64]?, num_expected_endorsements: UInt64?, is_slashed: Bool, public_key: PublicKey, num_produced_blocks: UInt64, num_expected_blocks: UInt64) {
...
public struct VMConfigView: Codable, Sendable {
    ...
    public init(fix_contract_loading_cost: Bool, saturating_float_to_int: Bool, storage_get_mode: StorageGetMode, global_contract_host_fns: Bool, ext_costs: ExtCostsConfigView, vm_kind: VMKind, limit_config: LimitConfig, grow_mem_cost: UInt32, regular_op_cost: UInt32, eth_implicit_accounts: Bool, discard_custom_sections: Bool, deterministic_account_ids: Bool, implicit_account_creation: Bool, reftypes_bulk_memory: Bool) {
...
public struct GenesisConfig: Codable, Sendable {
    ...
    public init(shard_layout: ShardLayout?, max_inflation_rate: [Int32], shuffle_shard_assignment_for_chunk_producers: Bool?, num_block_producer_seats: UInt64, num_chunk_producer_seats: UInt64?, minimum_validators_per_shard: UInt64?, protocol_version: UInt32, chunk_producer_assignment_changes_limit: UInt64?, num_block_producer_seats_per_shard: [UInt64], chain_id: String, protocol_treasury_account: AccountId, max_gas_price: NearToken, dynamic_resharding: Bool, block_producer_kickout_threshold: String, online_max_threshold: [Int32]?, genesis_height: UInt64, target_validator_mandates_per_shard: UInt64?, num_chunk_only_producer_seats: UInt64?, protocol_reward_rate: [Int32], validators: [AccountInfo], min_gas_price: NearToken, use_production_config: Bool?, protocol_upgrade_stake_threshold: [Int32]?, num_blocks_per_year: UInt64, chunk_producer_kickout_threshold: String, online_min_threshold: [Int32]?, fishermen_threshold: NearToken, minimum_stake_divisor: UInt64?, avg_hidden_validator_seats_per_shard: [UInt64], chunk_validator_only_kickout_threshold: String?, gas_price_adjustment_rate: [Int32], total_supply: NearToken, gas_limit: NearGas, epoch_length: UInt64, minimum_stake_ratio: [Int32]?, max_kickout_stake_perc: String?, genesis_time: String, num_chunk_validator_seats: UInt64?, transaction_validity_period: UInt64) {
        self.shard_layout = shard_layout
        self.max_inflation_rate = max_inflation_rate
        self.shuffle_shard_assignment_for_chunk_producers = shuffle_shard_assignment_for_chunk_producers
        self.num_block_producer_seats = num_block_producer_seats
