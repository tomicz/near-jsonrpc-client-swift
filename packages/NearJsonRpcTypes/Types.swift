...
// Generated on: 2025-09-25 03:44:21 +0000
...
public struct JsonRpcRequest_for_client_config: Codable {
    ...
    public init(params: RpcClientConfigRequest, jsonrpc: String, id: String, method: String) {
        self.params = params
...
public struct DelegateAction: Codable {
    ...
    public init(receiver_id: String, max_block_height: UInt64, sender_id: String, nonce: UInt64, actions: [NonDelegateAction], public_key: String) {
...
public struct JsonRpcRequest_for_light_client_proof: Codable {
    ...
    public init(params: RpcLightClientExecutionProofRequest, jsonrpc: String, id: String, method: String) {
        self.params = params
        self.jsonrpc = jsonrpc
        self.id = id
        self.method = method
...
public struct JsonRpcRequest_for_chunk: Codable {
    ...
    public init(params: RpcChunkRequest, jsonrpc: String, id: String, method: String) {
        self.params = params
        self.jsonrpc = jsonrpc
        self.id = id
        self.method = method
...
public struct JsonRpcRequest_for_EXPERIMENTAL_protocol_config: Codable {
    ...
    public init(params: RpcProtocolConfigRequest, jsonrpc: String, id: String, method: String) {
        self.params = params
        self.jsonrpc = jsonrpc
        self.id = id
        self.method = method
...
public struct ExecutionOutcomeView: Codable {
    ...
    public init(tokens_burnt: String, executor_id: String, gas_burnt: String, receipt_ids: [CryptoHash], metadata: String?, status: String, logs: [String]) {
...
public struct BlockHeaderInnerLiteView: Codable {
    ...
    public init(next_bp_hash: String, next_epoch_id: String, height: UInt64, timestamp: UInt64, timestamp_nanosec: String, epoch_id: String, block_merkle_root: String, prev_state_root: CryptoHash, outcome_root: CryptoHash) {
...
public struct JsonRpcRequest_for_EXPERIMENTAL_receipt: Codable {
    ...
    public init(params: RpcReceiptRequest, jsonrpc: String, id: String, method: String) {
        self.params = params
        self.jsonrpc = jsonrpc
        self.id = id
        self.method = method
...
public struct RpcLightClientExecutionProofResponse: Codable {
    ...
    public init(block_proof: [MerklePathItem], block_header_lite: LightClientBlockLiteView, outcome_root_proof: [MerklePathItem], outcome_proof: ExecutionOutcomeWithIdView) {
...
public struct JsonRpcRequest_for_gas_price: Codable {
    ...
    public init(params: RpcGasPriceRequest, jsonrpc: String, id: String, method: String) {
        self.params = params
        self.jsonrpc = jsonrpc
        self.id = id
        self.method = method
...
public struct JsonRpcRequest_for_block_effects: Codable {
    ...
    public init(params: RpcStateChangesInBlockRequest, jsonrpc: String, id: String, method: String) {
        self.params = params
        self.jsonrpc = jsonrpc
        self.id = id
        self.method = method
...
public struct JsonRpcRequest_for_tx: Codable {
    ...
    public init(params: RpcTransactionStatusRequest, jsonrpc: String, id: String, method: String) {
        self.params = params
        self.jsonrpc = jsonrpc
        self.id = id
        self.method = method
...
public struct StatusSyncInfo: Codable {
    ...
    public init(earliest_block_hash: String?, earliest_block_time: String?, epoch_start_height: UInt64?, epoch_id: String?, earliest_block_height: UInt64?, latest_block_hash: CryptoHash, latest_block_time: String, syncing: Bool, latest_block_height: UInt64, latest_state_root: CryptoHash) {
...
public struct SyncConcurrency: Codable {
    ...
    public init(apply_during_catchup: String, peer_downloads: String, per_shard: String, apply: String) {
...
public struct LimitConfig: Codable {
    ...
    public init(initial_memory_pages: String, yield_timeout_length_in_blocks: UInt64, max_register_size: UInt64, max_receipt_size: UInt64, max_length_storage_key: UInt64, max_number_logs: UInt64, max_number_input_data_dependencies: UInt64, max_tables_per_contract: String?, account_id_validity_rules_version: String?, registers_memory_limit: UInt64, max_number_bytes_method_names: UInt64, max_arguments_length: UInt64, max_transaction_size: UInt64, max_length_method_name: UInt64, per_receipt_storage_proof_size_limit: String, max_functions_number_per_contract: UInt64?, max_promises_per_function_call_action: UInt64, max_memory_pages: String, max_total_log_length: UInt64, max_elements_per_contract_table: String?, max_actions_per_receipt: UInt64, max_locals_per_contract: UInt64?, max_yield_payload_size: UInt64, max_length_storage_value: UInt64, max_number_registers: UInt64, max_stack_height: String, max_length_returned_data: UInt64, max_total_prepaid_gas: String, max_contract_size: UInt64, max_gas_burnt: String) {
...
public struct RpcValidatorResponse: Codable {
    ...
    public init(prev_epoch_kickout: [ValidatorKickoutView], current_proposals: [ValidatorStakeView], next_validators: [NextEpochValidatorInfo], epoch_start_height: UInt64, next_fishermen: [ValidatorStakeView], current_fishermen: [ValidatorStakeView], epoch_height: UInt64, current_validators: [CurrentEpochValidatorInfo]) {
...
public struct Fee: Codable {
    ...
    public init(send_sir: String, send_not_sir: String, execution: String) {
...
public struct JsonRpcRequest_for_next_light_client_block: Codable {
    ...
    public init(params: RpcLightClientNextBlockRequest, jsonrpc: String, id: String, method: String) {
        self.params = params
        self.jsonrpc = jsonrpc
        self.id = id
        self.method = method
...
public struct RpcReceiptResponse: Codable {
    ...
    public init(receipt: ReceiptEnumView, priority: UInt64?, receipt_id: CryptoHash, receiver_id: AccountId, predecessor_id: AccountId) {
...
public struct AccountView: Codable {
    ...
    public init(storage_usage: UInt64, amount: NearToken, locked: NearToken, global_contract_hash: String?, code_hash: CryptoHash, storage_paid_at: UInt64?, global_contract_account_id: String?) {
...
public struct JsonRpcRequest_for_EXPERIMENTAL_split_storage_info: Codable {
    ...
    public init(params: RpcSplitStorageInfoRequest, jsonrpc: String, id: String, method: String) {
        self.params = params
        self.jsonrpc = jsonrpc
        self.id = id
        self.method = method
...
public struct CongestionControlConfigView: Codable {
    ...
    public init(reject_tx_congestion_threshold: String, max_tx_gas: String, outgoing_receipts_big_size_limit: UInt64, allowed_shard_outgoing_gas: String, max_outgoing_gas: String, max_congestion_outgoing_gas: String, max_congestion_memory_consumption: UInt64, min_tx_gas: String, max_congestion_missed_chunks: UInt64, outgoing_receipts_usual_size_limit: UInt64, max_congestion_incoming_gas: String, min_outgoing_gas: String) {
...
public struct JsonRpcRequest_for_broadcast_tx_commit: Codable {
    ...
    public init(params: RpcSendTransactionRequest, jsonrpc: String, id: String, method: String) {
        self.params = params
        self.jsonrpc = jsonrpc
        self.id = id
        self.method = method
...
public struct JsonRpcRequest_for_health: Codable {
    ...
    public init(params: RpcHealthRequest, jsonrpc: String, id: String, method: String) {
        self.params = params
        self.jsonrpc = jsonrpc
        self.id = id
        self.method = method
...
public struct SignedTransactionView: Codable {
    ...
    public init(hash: CryptoHash, actions: [ActionView], receiver_id: AccountId, public_key: PublicKey, nonce: UInt64, priority_fee: UInt64?, signature: Signature, signer_id: AccountId) {
        self.hash = hash
        self.actions = actions
        self.receiver_id = receiver_id
        self.public_key = public_key
...
public struct RpcClientConfigResponse: Codable {
    ...
    public init(state_requests_per_throttle_period: String, state_sync_enabled: Bool, transaction_pool_size_limit: UInt64?, header_sync_expected_height_per_second: UInt64, max_gas_burnt_view: String?, chunk_validation_threads: String, log_summary_style: String, save_untracked_partial_chunks_parts: Bool, orphan_state_witness_max_size: UInt64, chunk_request_retry_period: [UInt64], view_client_threads: String, gc: String, trie_viewer_state_size_limit: UInt64?, cloud_archival_writer: String?, state_request_throttle_period: [UInt64], save_tx_outcomes: Bool, version: String, orphan_state_witness_pool_size: String, resharding_config: MutableConfigValue, archive: Bool, enable_multiline_logging: Bool, state_request_server_threads: String, expected_shutdown: String, num_block_producer_seats: UInt64, sync_max_block_requests: String, chunk_wait_mult: [Int32], catchup_step_period: [UInt64], min_num_peers: String, protocol_version_check: String, state_sync_p2p_timeout: [UInt64], state_sync: String, min_block_production_delay: [UInt64], ttl_account_id_router: [UInt64], block_fetch_horizon: UInt64, sync_height_threshold: UInt64, state_sync_external_backoff: [UInt64], save_trie_changes: Bool, transaction_request_handler_threads: String, cloud_archival_reader: String?, block_header_fetch_horizon: UInt64, log_summary_period: [UInt64], produce_empty_blocks: Bool, tracked_shards_config: TrackedShardsConfig, rpc_addr: String?, sync_step_period: [UInt64], header_sync_stall_ban_timeout: [UInt64], state_sync_external_timeout: [UInt64], client_background_migration_threads: String, save_latest_witnesses: Bool, enable_statistics_export: Bool, skip_sync_wait: Bool, save_invalid_witnesses: Bool, epoch_sync: String, header_sync_progress_timeout: [UInt64], tx_routing_height_horizon: UInt64, sync_check_period: [UInt64], epoch_length: UInt64, chain_id: String, doomslug_step_period: [UInt64], block_production_tracking_delay: [UInt64], max_block_wait_delay: [UInt64], chunk_distribution_network: String?, max_block_production_delay: [UInt64], produce_chunk_add_transactions_time_limit: String, header_sync_initial_timeout: [UInt64], state_sync_retry_backoff: [UInt64]) {
...
public struct ExtCostsConfigView: Codable {
    ...
    public init(yield_create_byte: String, ed25519_verify_byte: String, bls12381_map_fp_to_g1_element: NearGas, write_register_base: String, storage_read_base: String, bls12381_map_fp2_to_g2_base: NearGas, storage_remove_base: String, ecrecover_base: String, sha256_byte: String, read_memory_base: String, bls12381_pairing_base: NearGas, promise_and_base: String, storage_read_value_byte: String, bls12381_g1_multiexp_element: NearGas, storage_write_key_byte: String, ed25519_verify_base: String, read_register_base: String, storage_remove_key_byte: String, ripemd160_block: String, storage_write_value_byte: String, contract_compile_bytes: NearGas, keccak512_base: String, bls12381_p2_sum_base: NearGas, read_memory_byte: String, bls12381_p1_decompress_element: NearGas, storage_large_read_overhead_base: String, bls12381_g2_multiexp_element: NearGas, yield_resume_byte: String, bls12381_p2_sum_element: NearGas, contract_loading_bytes: String, storage_iter_create_prefix_byte: String, contract_loading_base: String, yield_resume_base: String, storage_iter_create_from_byte: String, bls12381_p2_decompress_base: NearGas, validator_total_stake_base: String, bls12381_map_fp_to_g1_base: NearGas, write_memory_byte: String, storage_iter_next_key_byte: String, keccak256_base: String, bls12381_p1_sum_base: NearGas, promise_and_per_promise: String, storage_iter_create_to_byte: String, bls12381_pairing_element: NearGas, storage_has_key_base: String, promise_return: String, storage_has_key_byte: String, storage_large_read_overhead_byte: String, storage_iter_create_range_base: String, yield_create_base: String, storage_remove_ret_value_byte: String, alt_bn128_g1_multiexp_element: String, write_memory_base: String, ripemd160_base: String, alt_bn128_g1_sum_element: String, log_byte: String, bls12381_g2_multiexp_base: NearGas, read_cached_trie_node: String, alt_bn128_pairing_check_base: String, contract_compile_base: NearGas, storage_write_base: String, utf8_decoding_base: String, validator_stake_base: String, bls12381_p1_sum_element: NearGas, read_register_byte: String, write_register_byte: String, storage_iter_create_prefix_base: String, alt_bn128_pairing_check_element: String, utf16_decoding_byte: String, keccak512_byte: String, storage_iter_next_value_byte: String, utf16_decoding_base: String, storage_iter_next_base: String, bls12381_p1_decompress_base: NearGas, alt_bn128_g1_multiexp_base: String, log_base: String, storage_write_evicted_byte: String, touching_trie_node: String, utf8_decoding_byte: String, bls12381_map_fp2_to_g2_element: NearGas, base: String, alt_bn128_g1_sum_base: String, keccak256_byte: String, bls12381_g1_multiexp_base: NearGas, sha256_base: String, bls12381_p2_decompress_element: NearGas, storage_read_key_byte: String) {
...
public struct ActionCreationConfigView: Codable {
    ...
    public init(stake_cost: String, delete_account_cost: String, deploy_contract_cost: String, delete_key_cost: String, create_account_cost: String, function_call_cost_per_byte: String, transfer_cost: String, function_call_cost: String, delegate_cost: String, add_key_cost: String, deploy_contract_cost_per_byte: String) {
...
public struct JsonRpcRequest_for_network_info: Codable {
    ...
    public init(params: RpcNetworkInfoRequest, jsonrpc: String, id: String, method: String) {
        self.params = params
        self.jsonrpc = jsonrpc
        self.id = id
        self.method = method
...
public struct NextEpochValidatorInfo: Codable {
    ...
    public init(account_id: AccountId, shards: [ShardId], public_key: PublicKey, stake: NearToken) {
        self.account_id = account_id
        self.shards = shards
        self.public_key = public_key
        self.stake = stake
...
public struct KnownProducerView: Codable {
    ...
    public init(next_hops: [PublicKey]?, peer_id: PublicKey, account_id: AccountId) {
...
public struct CurrentEpochValidatorInfo: Codable {
    ...
    public init(num_expected_endorsements_per_shard: [UInt64]?, num_produced_blocks: UInt64, num_produced_chunks_per_shard: [UInt64]?, account_id: AccountId, is_slashed: Bool, num_produced_endorsements_per_shard: [UInt64]?, stake: NearToken, num_expected_blocks: UInt64, num_expected_chunks_per_shard: [UInt64]?, num_produced_endorsements: UInt64?, public_key: PublicKey, num_produced_chunks: UInt64?, num_expected_chunks: UInt64?, shards_endorsed: [ShardId]?, num_expected_endorsements: UInt64?, shards: [ShardId]) {
...
public struct NetworkInfoView: Codable {
    ...
    public init(tier1_accounts_keys: [PublicKey], peer_max_count: String, known_producers: [KnownProducerView], connected_peers: [PeerInfoView], tier1_accounts_data: [AccountDataView], tier1_connections: [PeerInfoView], num_connected_peers: String) {
...
public struct RpcKnownProducer: Codable {
    ...
    public init(addr: String?, peer_id: PeerId, account_id: AccountId) {
        self.addr = addr
        self.peer_id = peer_id
        self.account_id = account_id
    }
...
public struct JsonRpcRequest_for_block: Codable {
    ...
    public init(params: RpcBlockRequest, jsonrpc: String, id: String, method: String) {
        self.params = params
        self.jsonrpc = jsonrpc
        self.id = id
        self.method = method
...
public struct JsonRpcRequest_for_EXPERIMENTAL_genesis_config: Codable {
    ...
    public init(params: GenesisConfigRequest, jsonrpc: String, id: String, method: String) {
        self.params = params
        self.jsonrpc = jsonrpc
        self.id = id
        self.method = method
...
public struct RpcStatusResponse: Codable {
    ...
    public init(sync_info: String, rpc_addr: String?, node_public_key: String, protocol_version: String, latest_protocol_version: String, validators: [ValidatorInfo], uptime_sec: String, version: String, chain_id: String, validator_public_key: String?, validator_account_id: String?, detailed_debug_status: String?, genesis_hash: String, node_key: String?) {
...
public struct DetailedDebugStatus: Codable {
    ...
    public init(current_head_status: BlockStatusView, catchup_status: [CatchupStatusView], current_header_head_status: BlockStatusView, block_production_delay_millis: UInt64, sync_status: String, network_info: NetworkInfoView) {
...
public struct FinalExecutionOutcomeWithReceiptView: Codable {
    ...
    public init(receipts_outcome: [ExecutionOutcomeWithIdView], transaction_outcome: String, transaction: String, receipts: [ReceiptView], status: String) {
...
public struct CatchupStatusView: Codable {
    ...
    public init(sync_block_hash: CryptoHash, blocks_to_catchup: [BlockStatusView], shard_sync_status: String, sync_block_height: UInt64) {
...
public struct VMConfigView: Codable {
    ...
    public init(deterministic_account_ids: Bool, saturating_float_to_int: Bool, vm_kind: String, storage_get_mode: String, fix_contract_loading_cost: Bool, implicit_account_creation: Bool, reftypes_bulk_memory: Bool, eth_implicit_accounts: Bool, ext_costs: String, global_contract_host_fns: Bool, limit_config: String, regular_op_cost: String, grow_mem_cost: String, discard_custom_sections: Bool) {
...
public struct ShardLayoutV1: Codable {
    ...
    public init(shards_split_map: [[ShardId]]?, boundary_accounts: [AccountId], to_parent_shard_map: [ShardId]?, version: String) {
...
public struct RuntimeFeesConfigView: Codable {
    ...
    public init(data_receipt_creation_config: String, pessimistic_gas_price_inflation_ratio: [Int32], burnt_gas_reward: [Int32], action_creation_config: String, storage_usage_config: String, action_receipt_creation_config: String) {
...
public struct ReceiptView: Codable {
    ...
    public init(predecessor_id: AccountId, receiver_id: AccountId, receipt_id: CryptoHash, priority: UInt64?, receipt: ReceiptEnumView) {
        self.predecessor_id = predecessor_id
        self.receiver_id = receiver_id
        self.receipt_id = receipt_id
        self.priority = priority
...
public struct RpcNetworkInfoResponse: Codable {
    ...
    public init(known_producers: [RpcKnownProducer], sent_bytes_per_sec: UInt64, num_active_peers: String, active_peers: [RpcPeerInfo], peer_max_count: String, received_bytes_per_sec: UInt64) {
        self.known_producers = known_producers
...
public struct RuntimeConfigView: Codable {
    ...
    public init(account_creation_config: String, wasm_config: String, storage_amount_per_byte: String, transaction_costs: String, congestion_control_config: String, witness_config: String) {
...
public struct ExternalStorageConfig: Codable {
    ...
    public init(num_concurrent_requests_during_catchup: String?, external_storage_fallback_threshold: UInt64?, location: String, num_concurrent_requests: String?) {
...
public struct PeerInfoView: Codable {
    ...
    public init(account_id: String?, is_outbound_peer: Bool, tracked_shards: [ShardId], last_time_peer_requested_millis: UInt64, nonce: UInt64, block_hash: String?, received_bytes_per_sec: UInt64, is_highest_block_invalid: Bool, addr: String, last_time_received_message_millis: UInt64, sent_bytes_per_sec: UInt64, archival: Bool, peer_id: PublicKey, connection_established_time_millis: UInt64, height: UInt64?) {
        self.account_id = account_id
...
public struct EpochSyncConfig: Codable {
    ...
    public init(epoch_sync_horizon: UInt64, timeout_for_epoch_sync: String, ignore_epoch_sync_network_requests: Bool?, disable_epoch_sync_for_bootstrapping: Bool?) {
...
public struct BlockHeaderView: Codable {
    ...
    public init(outcome_root: CryptoHash, chunk_endorsements: [[String]]?, timestamp: UInt64, chunk_headers_root: CryptoHash, block_merkle_root: CryptoHash, chunk_mask: [Bool], last_final_block: CryptoHash, prev_height: UInt64?, next_bp_hash: CryptoHash, gas_price: NearToken, rent_paid: String?, validator_proposals: [ValidatorStakeView], height: UInt64, hash: CryptoHash, next_epoch_id: CryptoHash, chunk_tx_root: CryptoHash, chunk_receipts_root: CryptoHash, random_value: CryptoHash, timestamp_nanosec: String, total_supply: NearToken, block_ordinal: UInt64?, epoch_sync_data_hash: String?, challenges_result: [SlashedValidator], last_ds_final_block: CryptoHash, epoch_id: CryptoHash, prev_state_root: CryptoHash, challenges_root: CryptoHash, block_body_hash: String?, approvals: [String], chunks_included: UInt64, signature: String, latest_protocol_version: String, validator_reward: String?, prev_hash: String) {
        self.outcome_root = outcome_root
...
public struct JsonRpcRequest_for_EXPERIMENTAL_validators_ordered: Codable {
    ...
    public init(params: RpcValidatorsOrderedRequest, jsonrpc: String, id: String, method: String) {
        self.params = params
        self.jsonrpc = jsonrpc
        self.id = id
        self.method = method
...
public struct JsonRpcRequest_for_query: Codable {
    ...
    public init(params: RpcQueryRequest, jsonrpc: String, id: String, method: String) {
        self.params = params
        self.jsonrpc = jsonrpc
        self.id = id
        self.method = method
...
public struct RpcProtocolConfigResponse: Codable {
    ...
    public init(num_block_producer_seats_per_shard: [UInt64], epoch_length: UInt64, min_gas_price: String, shuffle_shard_assignment_for_chunk_producers: Bool, chain_id: String, avg_hidden_validator_seats_per_shard: [UInt64], fishermen_threshold: String, minimum_validators_per_shard: UInt64, transaction_validity_period: UInt64, protocol_version: String, shard_layout: String, protocol_treasury_account: String, dynamic_resharding: Bool, online_min_threshold: [Int32], chunk_validator_only_kickout_threshold: String, num_block_producer_seats: UInt64, protocol_upgrade_stake_threshold: [Int32], max_kickout_stake_perc: String, genesis_height: UInt64, chunk_producer_kickout_threshold: String, online_max_threshold: [Int32], genesis_time: String, gas_limit: String, block_producer_kickout_threshold: String, target_validator_mandates_per_shard: UInt64, num_blocks_per_year: UInt64, minimum_stake_divisor: UInt64, max_inflation_rate: [Int32], protocol_reward_rate: [Int32], runtime_config: String, minimum_stake_ratio: [Int32], max_gas_price: String, gas_price_adjustment_rate: [Int32]) {
...
public struct ShardLayoutV2: Codable {
    ...
    public init(boundary_accounts: [AccountId], shards_split_map: String?, index_to_id_map: String, id_to_index_map: String, shard_ids: [ShardId], shards_parent_map: String?, version: String) {
        self.boundary_accounts = boundary_accounts
        self.shards_split_map = shards_split_map
...
public struct WitnessConfigView: Codable {
    ...
    public init(combined_transactions_size_limit: String, new_transactions_validation_state_size_soft_limit: UInt64, main_storage_proof_size_soft_limit: UInt64) {
...
public struct JsonRpcRequest_for_validators: Codable {
    ...
    public init(params: RpcValidatorRequest, jsonrpc: String, id: String, method: String) {
        self.params = params
        self.jsonrpc = jsonrpc
        self.id = id
        self.method = method
...
public struct JsonRpcRequest_for_maintenance_windows: Codable {
    ...
    public init(params: RpcMaintenanceWindowsRequest, jsonrpc: String, id: String, method: String) {
        self.params = params
        self.jsonrpc = jsonrpc
        self.id = id
        self.method = method
...
public struct ChunkHeaderView: Codable {
    ...
    public init(outcome_root: CryptoHash, prev_block_hash: CryptoHash, encoded_length: UInt64, congestion_info: String?, chunk_hash: CryptoHash, shard_id: ShardId, balance_burnt: NearToken, prev_state_root: CryptoHash, gas_limit: NearGas, bandwidth_requests: String?, encoded_merkle_root: CryptoHash, rent_paid: String?, height_included: UInt64, outgoing_receipts_root: CryptoHash, validator_proposals: [ValidatorStakeView], signature: Signature, tx_root: CryptoHash, height_created: UInt64, validator_reward: String?, gas_used: NearGas) {
        self.outcome_root = outcome_root
        self.prev_block_hash = prev_block_hash
...
public struct GenesisConfig: Codable {
    ...
    public init(num_block_producer_seats_per_shard: [UInt64], num_chunk_only_producer_seats: UInt64?, epoch_length: UInt64, min_gas_price: String, shuffle_shard_assignment_for_chunk_producers: Bool?, chain_id: String, avg_hidden_validator_seats_per_shard: [UInt64], fishermen_threshold: String, minimum_validators_per_shard: UInt64?, transaction_validity_period: UInt64, validators: [AccountInfo], protocol_version: String, shard_layout: String?, num_block_producer_seats: UInt64, dynamic_resharding: Bool, online_min_threshold: [Int32]?, chunk_validator_only_kickout_threshold: String?, use_production_config: Bool?, protocol_treasury_account: String, protocol_upgrade_stake_threshold: [Int32]?, chunk_producer_assignment_changes_limit: UInt64?, total_supply: String, max_kickout_stake_perc: String?, genesis_height: UInt64, chunk_producer_kickout_threshold: String, online_max_threshold: [Int32]?, genesis_time: String, gas_limit: String, block_producer_kickout_threshold: String, target_validator_mandates_per_shard: UInt64?, num_chunk_producer_seats: UInt64?, num_blocks_per_year: UInt64, minimum_stake_divisor: UInt64?, max_inflation_rate: [Int32], protocol_reward_rate: [Int32], num_chunk_validator_seats: UInt64?, minimum_stake_ratio: [Int32]?, max_gas_price: NearToken, gas_price_adjustment_rate: [Int32]) {
        self.num_block_producer_seats_per_shard = num_block_producer_seats_per_shard
...
public struct JsonRpcRequest_for_status: Codable {
    ...
    public init(params: RpcStatusRequest, jsonrpc: String, id: String, method: String) {
        self.params = params
        self.jsonrpc = jsonrpc
        self.id = id
        self.method = method
