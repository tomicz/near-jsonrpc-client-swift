...
// Generated on: 2025-09-29 02:23:16 +0000
...
public struct ReceiptView: Codable, Sendable {
    ...
    public init(receipt: ReceiptEnumView, priority: UInt64?, receiver_id: AccountId, predecessor_id: AccountId, receipt_id: CryptoHash) {
...
public struct RpcStatusResponse: Codable, Sendable {
    ...
    public init(genesis_hash: CryptoHash, node_public_key: PublicKey, uptime_sec: Int64, chain_id: String, rpc_addr: String?, protocol_version: UInt32, validator_public_key: String?, validators: [ValidatorInfo], validator_account_id: String?, node_key: String?, detailed_debug_status: String?, version: Version, latest_protocol_version: UInt32, sync_info: StatusSyncInfo) {
...
public struct StatusSyncInfo: Codable, Sendable {
    ...
    public init(latest_block_time: String, syncing: Bool, earliest_block_hash: String?, epoch_start_height: UInt64?, epoch_id: String?, latest_block_height: UInt64, earliest_block_time: String?, latest_block_hash: CryptoHash, latest_state_root: CryptoHash, earliest_block_height: UInt64?) {
...
public struct RuntimeConfigView: Codable, Sendable {
    ...
    public init(witness_config: WitnessConfigView, wasm_config: VMConfigView, account_creation_config: AccountCreationConfigView, transaction_costs: RuntimeFeesConfigView, congestion_control_config: CongestionControlConfigView, storage_amount_per_byte: NearToken) {
...
public struct JsonRpcRequest_for_EXPERIMENTAL_changes: Codable, Sendable {
    ...
    public init(jsonrpc: String, id: String, params: RpcStateChangesInBlockByTypeRequest, method: String) {
        self.jsonrpc = jsonrpc
        self.id = id
        self.params = params
        self.method = method
...
public struct LimitConfig: Codable, Sendable {
    ...
    public init(max_total_log_length: UInt64, registers_memory_limit: UInt64, yield_timeout_length_in_blocks: UInt64, max_locals_per_contract: UInt64?, max_tables_per_contract: UInt32?, max_receipt_size: UInt64, max_length_storage_key: UInt64, max_transaction_size: UInt64, max_length_method_name: UInt64, max_number_input_data_dependencies: UInt64, max_promises_per_function_call_action: UInt64, account_id_validity_rules_version: AccountIdValidityRulesVersion?, max_gas_burnt: NearGas, max_number_registers: UInt64, max_functions_number_per_contract: UInt64?, per_receipt_storage_proof_size_limit: String, max_number_bytes_method_names: UInt64, max_number_logs: UInt64, max_length_returned_data: UInt64, max_yield_payload_size: UInt64, max_total_prepaid_gas: NearGas, max_register_size: UInt64, max_elements_per_contract_table: String?, max_contract_size: UInt64, max_stack_height: UInt32, max_actions_per_receipt: UInt64, max_length_storage_value: UInt64, max_memory_pages: UInt32, max_arguments_length: UInt64, initial_memory_pages: UInt32) {
...
public struct RuntimeFeesConfigView: Codable, Sendable {
    ...
    public init(data_receipt_creation_config: DataReceiptCreationConfigView, pessimistic_gas_price_inflation_ratio: [Int32], burnt_gas_reward: [Int32], action_creation_config: ActionCreationConfigView, storage_usage_config: StorageUsageConfigView, action_receipt_creation_config: Fee) {
...
public struct GenesisConfig: Codable, Sendable {
    ...
    public init(chunk_producer_assignment_changes_limit: UInt64?, use_production_config: Bool?, total_supply: NearToken, protocol_upgrade_stake_threshold: [Int32]?, num_chunk_producer_seats: UInt64?, gas_price_adjustment_rate: [Int32], max_gas_price: NearToken, target_validator_mandates_per_shard: UInt64?, protocol_version: UInt32, validators: [AccountInfo], chain_id: String, protocol_reward_rate: [Int32], dynamic_resharding: Bool, num_block_producer_seats_per_shard: [UInt64], gas_limit: NearGas, shard_layout: ShardLayout?, num_block_producer_seats: UInt64, online_min_threshold: [Int32]?, minimum_validators_per_shard: UInt64?, num_chunk_only_producer_seats: UInt64?, epoch_length: UInt64, minimum_stake_divisor: UInt64?, min_gas_price: NearToken, max_inflation_rate: [Int32], fishermen_threshold: NearToken, genesis_time: String, shuffle_shard_assignment_for_chunk_producers: Bool?, online_max_threshold: [Int32]?, avg_hidden_validator_seats_per_shard: [UInt64], max_kickout_stake_perc: String?, protocol_treasury_account: AccountId, genesis_height: UInt64, block_producer_kickout_threshold: String, num_blocks_per_year: UInt64, chunk_producer_kickout_threshold: String, num_chunk_validator_seats: UInt64?, minimum_stake_ratio: [Int32]?, chunk_validator_only_kickout_threshold: String?, transaction_validity_period: UInt64) {
...
public struct JsonRpcRequest_for_EXPERIMENTAL_genesis_config: Codable, Sendable {
    ...
    public init(jsonrpc: String, id: String, params: GenesisConfigRequest, method: String) {
        self.jsonrpc = jsonrpc
        self.id = id
        self.params = params
        self.method = method
...
public struct FinalExecutionOutcomeView: Codable, Sendable {
    ...
    public init(transaction: SignedTransactionView, transaction_outcome: ExecutionOutcomeWithIdView, status: FinalExecutionStatus, receipts_outcome: [ExecutionOutcomeWithIdView]) {
...
public struct ExecutionOutcomeView: Codable, Sendable {
    ...
    public init(executor_id: AccountId, logs: [String], gas_burnt: NearGas, tokens_burnt: NearToken, status: ExecutionStatusView, metadata: ExecutionMetadataView?, receipt_ids: [CryptoHash]) {
...
public struct RpcClientConfigResponse: Codable, Sendable {
    ...
    public init(expected_shutdown: MutableConfigValue, chunk_wait_mult: [Int32], gc: GCConfig, log_summary_style: LogSummaryStyle, save_latest_witnesses: Bool, save_invalid_witnesses: Bool, log_summary_period: [UInt64], state_sync_retry_backoff: [UInt64], block_header_fetch_horizon: UInt64, produce_empty_blocks: Bool, transaction_pool_size_limit: UInt64?, chain_id: String, num_block_producer_seats: UInt64, resharding_config: MutableConfigValue, enable_statistics_export: Bool, chunk_request_retry_period: [UInt64], epoch_length: UInt64, protocol_version_check: ProtocolVersionCheckConfig, save_trie_changes: Bool, sync_check_period: [UInt64], cloud_archival_reader: String?, header_sync_initial_timeout: [UInt64], header_sync_stall_ban_timeout: [UInt64], state_requests_per_throttle_period: String, rpc_addr: String?, sync_height_threshold: UInt64, version: Version, max_block_production_delay: [UInt64], chunk_distribution_network: String?, min_num_peers: String, orphan_state_witness_max_size: UInt64, max_gas_burnt_view: String?, tracked_shards_config: TrackedShardsConfig, save_tx_outcomes: Bool, enable_multiline_logging: Bool, doomslug_step_period: [UInt64], header_sync_expected_height_per_second: UInt64, state_sync: StateSyncConfig, state_sync_p2p_timeout: [UInt64], block_production_tracking_delay: [UInt64], archive: Bool, state_sync_enabled: Bool, trie_viewer_state_size_limit: UInt64?, epoch_sync: EpochSyncConfig, header_sync_progress_timeout: [UInt64], max_block_wait_delay: [UInt64], state_sync_external_backoff: [UInt64], skip_sync_wait: Bool, client_background_migration_threads: String, chunk_validation_threads: String, sync_max_block_requests: String, state_request_throttle_period: [UInt64], orphan_state_witness_pool_size: String, cloud_archival_writer: String?, sync_step_period: [UInt64], produce_chunk_add_transactions_time_limit: String, save_untracked_partial_chunks_parts: Bool, state_request_server_threads: String, block_fetch_horizon: UInt64, tx_routing_height_horizon: UInt64, state_sync_external_timeout: [UInt64], catchup_step_period: [UInt64], min_block_production_delay: [UInt64], transaction_request_handler_threads: String, view_client_threads: String, ttl_account_id_router: [UInt64]) {
...
public struct AccountView: Codable, Sendable {
    ...
    public init(global_contract_hash: String?, locked: NearToken, storage_paid_at: UInt64?, global_contract_account_id: String?, storage_usage: UInt64, code_hash: CryptoHash, amount: NearToken) {
...
public struct CurrentEpochValidatorInfo: Codable, Sendable {
    ...
    public init(num_expected_chunks: UInt64?, is_slashed: Bool, num_expected_endorsements: UInt64?, shards: [ShardId], num_produced_blocks: UInt64, num_produced_chunks_per_shard: [UInt64]?, num_expected_endorsements_per_shard: [UInt64]?, num_expected_chunks_per_shard: [UInt64]?, num_produced_endorsements_per_shard: [UInt64]?, num_produced_endorsements: UInt64?, account_id: AccountId, shards_endorsed: [ShardId]?, num_produced_chunks: UInt64?, stake: NearToken, num_expected_blocks: UInt64, public_key: PublicKey) {
...
public struct FinalExecutionOutcomeWithReceiptView: Codable, Sendable {
    ...
    public init(transaction: SignedTransactionView, receipts: [ReceiptView], transaction_outcome: ExecutionOutcomeWithIdView, status: FinalExecutionStatus, receipts_outcome: [ExecutionOutcomeWithIdView]) {
        self.transaction = transaction
...
public struct NextEpochValidatorInfo: Codable, Sendable {
    ...
    public init(stake: NearToken, shards: [ShardId], account_id: AccountId, public_key: PublicKey) {
        self.stake = stake
        self.shards = shards
        self.account_id = account_id
        self.public_key = public_key
...
public struct NetworkInfoView: Codable, Sendable {
    ...
    public init(known_producers: [KnownProducerView], connected_peers: [PeerInfoView], tier1_accounts_data: [AccountDataView], tier1_accounts_keys: [PublicKey], peer_max_count: UInt32, tier1_connections: [PeerInfoView], num_connected_peers: String) {
...
public struct ShardLayoutV2: Codable, Sendable {
    ...
    public init(id_to_index_map: String, shard_ids: [ShardId], version: UInt32, shards_parent_map: String?, shards_split_map: String?, index_to_id_map: String, boundary_accounts: [AccountId]) {
...
public struct CongestionControlConfigView: Codable, Sendable {
    ...
    public init(max_outgoing_gas: NearGas, reject_tx_congestion_threshold: String, max_congestion_missed_chunks: UInt64, allowed_shard_outgoing_gas: NearGas, outgoing_receipts_big_size_limit: UInt64, max_congestion_incoming_gas: NearGas, outgoing_receipts_usual_size_limit: UInt64, min_outgoing_gas: NearGas, max_congestion_memory_consumption: UInt64, min_tx_gas: NearGas, max_congestion_outgoing_gas: NearGas, max_tx_gas: NearGas) {
...
public struct CatchupStatusView: Codable, Sendable {
    ...
    public init(sync_block_height: UInt64, shard_sync_status: String, sync_block_hash: CryptoHash, blocks_to_catchup: [BlockStatusView]) {
...
public struct RpcChunkResponse: Codable, Sendable {
    ...
    public init(author: AccountId, receipts: [ReceiptView], header: ChunkHeaderView, transactions: [SignedTransactionView]) {
        self.author = author
        self.receipts = receipts
        self.header = header
...
public struct DetailedDebugStatus: Codable, Sendable {
    ...
    public init(current_head_status: BlockStatusView, current_header_head_status: BlockStatusView, network_info: NetworkInfoView, block_production_delay_millis: UInt64, catchup_status: [CatchupStatusView], sync_status: String) {
...
public struct RpcProtocolConfigResponse: Codable, Sendable {
    ...
    public init(gas_limit: NearGas, online_max_threshold: [Int32], protocol_version: UInt32, max_kickout_stake_perc: String, protocol_reward_rate: [Int32], max_inflation_rate: [Int32], fishermen_threshold: NearToken, num_block_producer_seats_per_shard: [UInt64], max_gas_price: NearToken, minimum_stake_divisor: UInt64, avg_hidden_validator_seats_per_shard: [UInt64], target_validator_mandates_per_shard: UInt64, runtime_config: RuntimeConfigView, num_block_producer_seats: UInt64, min_gas_price: NearToken, transaction_validity_period: UInt64, dynamic_resharding: Bool, genesis_height: UInt64, chain_id: String, epoch_length: UInt64, chunk_validator_only_kickout_threshold: String, protocol_upgrade_stake_threshold: [Int32], genesis_time: String, chunk_producer_kickout_threshold: String, protocol_treasury_account: AccountId, num_blocks_per_year: UInt64, online_min_threshold: [Int32], shuffle_shard_assignment_for_chunk_producers: Bool, shard_layout: ShardLayout, minimum_validators_per_shard: UInt64, block_producer_kickout_threshold: String, gas_price_adjustment_rate: [Int32], minimum_stake_ratio: [Int32]) {
        self.gas_limit = gas_limit
        self.online_max_threshold = online_max_threshold
        self.protocol_version = protocol_version
        self.max_kickout_stake_perc = max_kickout_stake_perc
...
public struct Version: Codable, Sendable {
    ...
    public init(commit: String, build: String, rustc_version: String?, version: String) {
        self.commit = commit
        self.build = build
...
public struct Fee: Codable, Sendable {
    ...
    public init(execution: NearGas, send_sir: NearGas, send_not_sir: NearGas) {
...
public struct BlockHeaderInnerLiteView: Codable, Sendable {
    ...
    public init(timestamp_nanosec: String, next_epoch_id: CryptoHash, timestamp: UInt64, outcome_root: CryptoHash, prev_state_root: CryptoHash, epoch_id: CryptoHash, next_bp_hash: CryptoHash, height: UInt64, block_merkle_root: CryptoHash) {
...
public struct AccountDataView: Codable, Sendable {
    ...
    public init(peer_id: PublicKey, timestamp: String, proxies: [Tier1ProxyView], account_key: PublicKey) {
        self.peer_id = peer_id
        self.timestamp = timestamp
...
public struct RpcNetworkInfoResponse: Codable, Sendable {
    ...
    public init(known_producers: [RpcKnownProducer], active_peers: [RpcPeerInfo], received_bytes_per_sec: UInt64, sent_bytes_per_sec: UInt64, num_active_peers: String, peer_max_count: UInt32) {
        self.known_producers = known_producers
...
public struct ExternalStorageConfig: Codable, Sendable {
    ...
    public init(location: ExternalStorageLocation, external_storage_fallback_threshold: UInt64?, num_concurrent_requests_during_catchup: String?, num_concurrent_requests: String?) {
...
public struct EpochSyncConfig: Codable, Sendable {
    ...
    public init(ignore_epoch_sync_network_requests: Bool?, disable_epoch_sync_for_bootstrapping: Bool?, timeout_for_epoch_sync: DurationAsStdSchemaProvider, epoch_sync_horizon: UInt64) {
...
public struct RpcReceiptResponse: Codable, Sendable {
    ...
    public init(receipt: ReceiptEnumView, receiver_id: AccountId, receipt_id: CryptoHash, predecessor_id: AccountId, priority: UInt64?) {
        self.receipt = receipt
        self.receiver_id = receiver_id
        self.receipt_id = receipt_id
        self.predecessor_id = predecessor_id
...
public struct FunctionCallAction: Codable, Sendable {
    ...
    public init(args: String, gas: NearGas, method_name: String, deposit: NearToken) {
        self.args = args
        self.gas = gas
...
public struct ShardLayoutV1: Codable, Sendable {
    ...
    public init(to_parent_shard_map: [ShardId]?, version: UInt32, boundary_accounts: [AccountId], shards_split_map: [[ShardId]]?) {
...
public struct SignedTransactionView: Codable, Sendable {
    ...
    public init(signer_id: AccountId, hash: CryptoHash, actions: [ActionView], nonce: UInt64, public_key: PublicKey, signature: Signature, receiver_id: AccountId, priority_fee: UInt64?) {
...
public struct BlockHeaderView: Codable, Sendable {
    ...
    public init(chunk_tx_root: CryptoHash, epoch_id: CryptoHash, total_supply: NearToken, block_ordinal: UInt64?, chunk_endorsements: [[String]]?, block_merkle_root: CryptoHash, epoch_sync_data_hash: String?, gas_price: NearToken, signature: Signature, last_final_block: CryptoHash, challenges_result: [SlashedValidator], chunk_headers_root: CryptoHash, prev_state_root: CryptoHash, chunks_included: UInt64, challenges_root: CryptoHash, outcome_root: CryptoHash, chunk_mask: [Bool], height: UInt64, rent_paid: NearToken?, approvals: [String], random_value: CryptoHash, validator_reward: NearToken?, next_bp_hash: CryptoHash, latest_protocol_version: UInt32, prev_height: UInt64?, chunk_receipts_root: CryptoHash, validator_proposals: [ValidatorStakeView], timestamp: UInt64, last_ds_final_block: CryptoHash, next_epoch_id: CryptoHash, hash: CryptoHash, block_body_hash: String?, prev_hash: CryptoHash, timestamp_nanosec: String) {
...
public struct DelegateAction: Codable, Sendable {
    ...
    public init(max_block_height: UInt64, actions: [NonDelegateAction], sender_id: AccountId, nonce: UInt64, public_key: PublicKey, receiver_id: AccountId) {
...
public struct ExtCostsConfigView: Codable, Sendable {
    ...
    public init(alt_bn128_pairing_check_element: NearGas, bls12381_map_fp2_to_g2_element: NearGas, sha256_byte: NearGas, utf8_decoding_base: NearGas, keccak256_byte: NearGas, promise_and_per_promise: NearGas, alt_bn128_g1_multiexp_base: NearGas, promise_return: NearGas, bls12381_g2_multiexp_element: NearGas, ripemd160_block: NearGas, contract_loading_base: NearGas, promise_and_base: NearGas, storage_iter_create_prefix_base: NearGas, alt_bn128_pairing_check_base: NearGas, storage_read_key_byte: NearGas, storage_remove_base: NearGas, read_register_byte: NearGas, contract_loading_bytes: NearGas, ecrecover_base: NearGas, base: NearGas, bls12381_p1_decompress_element: NearGas, alt_bn128_g1_sum_element: NearGas, yield_resume_byte: NearGas, ripemd160_base: NearGas, bls12381_map_fp_to_g1_element: NearGas, touching_trie_node: NearGas, yield_create_base: NearGas, storage_write_value_byte: NearGas, bls12381_p1_decompress_base: NearGas, bls12381_g1_multiexp_element: NearGas, storage_write_key_byte: NearGas, storage_large_read_overhead_base: NearGas, bls12381_p2_sum_base: NearGas, storage_iter_create_prefix_byte: NearGas, bls12381_p1_sum_base: NearGas, log_base: NearGas, read_memory_byte: NearGas, bls12381_p2_sum_element: NearGas, validator_stake_base: NearGas, storage_write_evicted_byte: NearGas, bls12381_g1_multiexp_base: NearGas, log_byte: NearGas, ed25519_verify_byte: NearGas, ed25519_verify_base: NearGas, keccak256_base: NearGas, write_memory_byte: NearGas, storage_write_base: NearGas, contract_compile_base: NearGas, read_memory_base: NearGas, utf8_decoding_byte: NearGas, utf16_decoding_byte: NearGas, write_memory_base: NearGas, validator_total_stake_base: NearGas, storage_read_value_byte: NearGas, storage_remove_ret_value_byte: NearGas, bls12381_g2_multiexp_base: NearGas, alt_bn128_g1_sum_base: NearGas, write_register_byte: NearGas, bls12381_p1_sum_element: NearGas, utf16_decoding_base: NearGas, contract_compile_bytes: NearGas, storage_iter_next_key_byte: NearGas, storage_iter_create_range_base: NearGas, keccak512_byte: NearGas, storage_has_key_byte: NearGas, storage_iter_next_value_byte: NearGas, storage_remove_key_byte: NearGas, bls12381_pairing_base: NearGas, read_register_base: NearGas, bls12381_p2_decompress_element: NearGas, bls12381_pairing_element: NearGas, storage_has_key_base: NearGas, yield_create_byte: NearGas, keccak512_base: NearGas, bls12381_map_fp2_to_g2_base: NearGas, yield_resume_base: NearGas, storage_iter_create_to_byte: NearGas, bls12381_p2_decompress_base: NearGas, storage_large_read_overhead_byte: NearGas, storage_iter_create_from_byte: NearGas, read_cached_trie_node: NearGas, storage_read_base: NearGas, bls12381_map_fp_to_g1_base: NearGas, storage_iter_next_base: NearGas, alt_bn128_g1_multiexp_element: NearGas, sha256_base: NearGas, write_register_base: NearGas) {
...
public struct ActionCreationConfigView: Codable, Sendable {
    ...
    public init(deploy_contract_cost_per_byte: Fee, stake_cost: Fee, create_account_cost: Fee, transfer_cost: Fee, delete_key_cost: Fee, deploy_contract_cost: Fee, add_key_cost: AccessKeyCreationConfigView, delegate_cost: Fee, delete_account_cost: Fee, function_call_cost_per_byte: Fee, function_call_cost: Fee) {
...
public struct PeerInfoView: Codable, Sendable {
    ...
    public init(block_hash: String?, last_time_peer_requested_millis: UInt64, sent_bytes_per_sec: UInt64, peer_id: PublicKey, last_time_received_message_millis: UInt64, is_outbound_peer: Bool, account_id: String?, received_bytes_per_sec: UInt64, is_highest_block_invalid: Bool, tracked_shards: [ShardId], archival: Bool, height: UInt64?, nonce: UInt64, addr: String, connection_established_time_millis: UInt64) {
        self.block_hash = block_hash
...
public struct DumpConfig: Codable, Sendable {
    ...
    public init(credentials_file: String?, restart_dump_for_shards: [ShardId]?, iteration_delay: String?, location: ExternalStorageLocation) {
        self.credentials_file = credentials_file
...
public struct VMConfigView: Codable, Sendable {
    ...
    public init(implicit_account_creation: Bool, limit_config: LimitConfig, global_contract_host_fns: Bool, storage_get_mode: StorageGetMode, reftypes_bulk_memory: Bool, ext_costs: ExtCostsConfigView, regular_op_cost: UInt32, grow_mem_cost: UInt32, eth_implicit_accounts: Bool, deterministic_account_ids: Bool, discard_custom_sections: Bool, fix_contract_loading_cost: Bool, vm_kind: VMKind, saturating_float_to_int: Bool) {
...
public struct RpcValidatorResponse: Codable, Sendable {
    ...
    public init(epoch_height: UInt64, current_fishermen: [ValidatorStakeView], current_validators: [CurrentEpochValidatorInfo], epoch_start_height: UInt64, next_validators: [NextEpochValidatorInfo], prev_epoch_kickout: [ValidatorKickoutView], next_fishermen: [ValidatorStakeView], current_proposals: [ValidatorStakeView]) {
...
public struct ChunkHeaderView: Codable, Sendable {
    ...
    public init(balance_burnt: NearToken, shard_id: ShardId, encoded_merkle_root: CryptoHash, prev_state_root: CryptoHash, validator_proposals: [ValidatorStakeView], outcome_root: CryptoHash, height_included: UInt64, validator_reward: NearToken?, gas_used: NearGas, rent_paid: NearToken?, signature: Signature, bandwidth_requests: String?, chunk_hash: CryptoHash, prev_block_hash: CryptoHash, congestion_info: String?, tx_root: CryptoHash, outgoing_receipts_root: CryptoHash, gas_limit: NearGas, height_created: UInt64, encoded_length: UInt64) {
