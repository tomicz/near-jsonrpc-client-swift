...
// Generated on: 2025-09-25 03:13:24 +0000
...
public struct JsonRpcRequest_for_tx: Codable {
    ...
    public init(id: String, params: RpcTransactionStatusRequest, method: String, jsonrpc: String) {
        self.id = id
        self.params = params
        self.method = method
...
public struct DetailedDebugStatus: Codable {
    ...
    public init(block_production_delay_millis: UInt64, current_header_head_status: BlockStatusView, network_info: NetworkInfoView, catchup_status: [CatchupStatusView], current_head_status: BlockStatusView, sync_status: String) {
...
public struct JsonRpcRequest_for_EXPERIMENTAL_validators_ordered: Codable {
    ...
    public init(method: String, id: String, jsonrpc: String, params: RpcValidatorsOrderedRequest) {
        self.method = method
        self.id = id
        self.jsonrpc = jsonrpc
        self.params = params
...
public struct FunctionCallAction: Codable {
    ...
    public init(deposit: NearToken, method_name: String, args: String, gas: NearGas) {
...
public struct ChunkHeaderView: Codable {
    ...
    public init(encoded_merkle_root: CryptoHash, height_included: UInt64, validator_proposals: [ValidatorStakeView], gas_used: NearGas, prev_state_root: CryptoHash, validator_reward: String?, chunk_hash: CryptoHash, prev_block_hash: CryptoHash, gas_limit: NearGas, shard_id: ShardId, bandwidth_requests: String?, tx_root: CryptoHash, height_created: UInt64, balance_burnt: NearToken, congestion_info: String?, outcome_root: CryptoHash, rent_paid: String?, outgoing_receipts_root: CryptoHash, signature: Signature, encoded_length: UInt64) {
...
public struct JsonRpcRequest_for_network_info: Codable {
    ...
    public init(method: String, id: String, jsonrpc: String, params: RpcNetworkInfoRequest) {
        self.method = method
        self.id = id
        self.jsonrpc = jsonrpc
        self.params = params
...
public struct DelegateAction: Codable {
    ...
    public init(nonce: UInt64, public_key: String, sender_id: String, actions: [NonDelegateAction], receiver_id: String, max_block_height: UInt64) {
        self.nonce = nonce
...
public struct JsonRpcRequest_for_query: Codable {
    ...
    public init(method: String, id: String, jsonrpc: String, params: RpcQueryRequest) {
        self.method = method
        self.id = id
        self.jsonrpc = jsonrpc
        self.params = params
...
public struct JsonRpcRequest_for_status: Codable {
    ...
    public init(method: String, id: String, jsonrpc: String, params: RpcStatusRequest) {
        self.method = method
        self.id = id
        self.jsonrpc = jsonrpc
        self.params = params
...
public struct NetworkInfoView: Codable {
    ...
    public init(connected_peers: [PeerInfoView], tier1_connections: [PeerInfoView], peer_max_count: String, num_connected_peers: String, tier1_accounts_keys: [PublicKey], known_producers: [KnownProducerView], tier1_accounts_data: [AccountDataView]) {
...
public struct BlockHeaderView: Codable {
    ...
    public init(rent_paid: String?, block_ordinal: UInt64?, hash: CryptoHash, chunk_mask: [Bool], gas_price: NearToken, epoch_id: CryptoHash, last_final_block: CryptoHash, prev_state_root: CryptoHash, height: UInt64, prev_hash: String, block_body_hash: String?, next_bp_hash: CryptoHash, chunk_headers_root: CryptoHash, outcome_root: CryptoHash, validator_reward: String?, chunk_receipts_root: CryptoHash, random_value: CryptoHash, validator_proposals: [ValidatorStakeView], last_ds_final_block: CryptoHash, challenges_root: CryptoHash, approvals: [String], prev_height: UInt64?, signature: String, next_epoch_id: CryptoHash, chunk_endorsements: [[String]]?, block_merkle_root: CryptoHash, timestamp_nanosec: String, timestamp: UInt64, latest_protocol_version: String, epoch_sync_data_hash: String?, total_supply: NearToken, chunks_included: UInt64, chunk_tx_root: CryptoHash, challenges_result: [SlashedValidator]) {
        self.rent_paid = rent_paid
...
public struct JsonRpcRequest_for_broadcast_tx_async: Codable {
    ...
    public init(method: String, id: String, jsonrpc: String, params: RpcSendTransactionRequest) {
        self.method = method
        self.id = id
        self.jsonrpc = jsonrpc
        self.params = params
...
public struct RpcNetworkInfoResponse: Codable {
    ...
    public init(sent_bytes_per_sec: UInt64, peer_max_count: String, known_producers: [RpcKnownProducer], received_bytes_per_sec: UInt64, active_peers: [RpcPeerInfo], num_active_peers: String) {
...
public struct StatusSyncInfo: Codable {
    ...
    public init(epoch_id: String?, earliest_block_height: UInt64?, earliest_block_time: String?, syncing: Bool, latest_block_time: String, epoch_start_height: UInt64?, latest_block_height: UInt64, latest_block_hash: CryptoHash, earliest_block_hash: String?, latest_state_root: CryptoHash) {
        self.epoch_id = epoch_id
...
public struct RuntimeFeesConfigView: Codable {
    ...
    public init(action_receipt_creation_config: String, burnt_gas_reward: [Int32], action_creation_config: String, storage_usage_config: String, pessimistic_gas_price_inflation_ratio: [Int32], data_receipt_creation_config: String) {
...
public struct JsonRpcRequest_for_client_config: Codable {
    ...
    public init(method: String, id: String, jsonrpc: String, params: RpcClientConfigRequest) {
        self.method = method
        self.id = id
        self.jsonrpc = jsonrpc
        self.params = params
...
public struct GenesisConfig: Codable {
    ...
    public init(online_min_threshold: [Int32]?, validators: [AccountInfo], chunk_producer_assignment_changes_limit: UInt64?, minimum_stake_divisor: UInt64?, gas_price_adjustment_rate: [Int32], epoch_length: UInt64, use_production_config: Bool?, num_chunk_only_producer_seats: UInt64?, chunk_validator_only_kickout_threshold: String?, max_gas_price: NearToken, minimum_stake_ratio: [Int32]?, num_block_producer_seats_per_shard: [UInt64], protocol_treasury_account: String, block_producer_kickout_threshold: String, max_kickout_stake_perc: String?, target_validator_mandates_per_shard: UInt64?, transaction_validity_period: UInt64, chain_id: String, genesis_height: UInt64, max_inflation_rate: [Int32], avg_hidden_validator_seats_per_shard: [UInt64], num_chunk_producer_seats: UInt64?, minimum_validators_per_shard: UInt64?, fishermen_threshold: String, total_supply: String, protocol_reward_rate: [Int32], genesis_time: String, num_blocks_per_year: UInt64, min_gas_price: String, num_chunk_validator_seats: UInt64?, chunk_producer_kickout_threshold: String, protocol_upgrade_stake_threshold: [Int32]?, shuffle_shard_assignment_for_chunk_producers: Bool?, gas_limit: String, dynamic_resharding: Bool, shard_layout: String?, protocol_version: String, online_max_threshold: [Int32]?, num_block_producer_seats: UInt64) {
...
public struct JsonRpcRequest_for_EXPERIMENTAL_genesis_config: Codable {
    ...
    public init(method: String, id: String, jsonrpc: String, params: GenesisConfigRequest) {
        self.method = method
        self.id = id
        self.jsonrpc = jsonrpc
        self.params = params
...
public struct ReceiptView: Codable {
    ...
    public init(receipt: ReceiptEnumView, receipt_id: CryptoHash, predecessor_id: AccountId, priority: UInt64?, receiver_id: AccountId) {
...
public struct ExtCostsConfigView: Codable {
    ...
    public init(yield_create_base: String, ed25519_verify_base: String, bls12381_pairing_element: NearGas, storage_iter_create_from_byte: String, ecrecover_base: String, storage_has_key_byte: String, write_memory_byte: String, utf16_decoding_base: String, read_memory_base: String, read_memory_byte: String, storage_write_key_byte: String, storage_large_read_overhead_byte: String, promise_return: String, validator_total_stake_base: String, alt_bn128_g1_sum_base: String, bls12381_p2_decompress_element: NearGas, sha256_base: String, storage_remove_ret_value_byte: String, storage_large_read_overhead_base: String, alt_bn128_g1_multiexp_base: String, utf16_decoding_byte: String, bls12381_p2_decompress_base: NearGas, write_register_byte: String, storage_iter_create_to_byte: String, alt_bn128_g1_multiexp_element: String, bls12381_p1_sum_base: NearGas, bls12381_g1_multiexp_base: NearGas, bls12381_pairing_base: NearGas, bls12381_map_fp_to_g1_base: NearGas, storage_read_value_byte: String, contract_compile_base: NearGas, storage_iter_next_base: String, storage_remove_key_byte: String, ed25519_verify_byte: String, storage_write_base: String, read_register_base: String, log_base: String, validator_stake_base: String, storage_write_evicted_byte: String, yield_resume_byte: String, promise_and_per_promise: String, keccak512_byte: String, bls12381_map_fp_to_g1_element: NearGas, write_register_base: String, contract_loading_base: String, storage_read_base: String, contract_compile_bytes: NearGas, storage_has_key_base: String, base: String, read_register_byte: String, contract_loading_bytes: String, bls12381_p1_decompress_base: NearGas, log_byte: String, storage_read_key_byte: String, alt_bn128_pairing_check_base: String, bls12381_g2_multiexp_base: NearGas, keccak256_base: String, write_memory_base: String, ripemd160_block: String, storage_write_value_byte: String, storage_remove_base: String, utf8_decoding_byte: String, alt_bn128_g1_sum_element: String, sha256_byte: String, bls12381_map_fp2_to_g2_base: NearGas, storage_iter_create_range_base: String, utf8_decoding_base: String, promise_and_base: String, storage_iter_next_key_byte: String, bls12381_map_fp2_to_g2_element: NearGas, yield_resume_base: String, ripemd160_base: String, storage_iter_next_value_byte: String, keccak512_base: String, yield_create_byte: String, bls12381_p2_sum_base: NearGas, bls12381_p1_sum_element: NearGas, bls12381_g1_multiexp_element: NearGas, bls12381_g2_multiexp_element: NearGas, alt_bn128_pairing_check_element: String, touching_trie_node: String, read_cached_trie_node: String, bls12381_p1_decompress_element: NearGas, bls12381_p2_sum_element: NearGas, storage_iter_create_prefix_base: String, storage_iter_create_prefix_byte: String, keccak256_byte: String) {
...
public struct SyncConcurrency: Codable {
    ...
    public init(per_shard: String, apply_during_catchup: String, apply: String, peer_downloads: String) {
...
public struct ExecutionOutcomeWithIdView: Codable {
    ...
    public init(block_hash: CryptoHash, outcome: ExecutionOutcomeView, id: CryptoHash, proof: [MerklePathItem]) {
        self.block_hash = block_hash
...
public struct RpcStatusResponse: Codable {
    ...
    public init(genesis_hash: String, detailed_debug_status: String?, chain_id: String, node_public_key: String, sync_info: String, version: String, node_key: String?, uptime_sec: String, latest_protocol_version: String, rpc_addr: String?, validator_public_key: String?, validators: [ValidatorInfo], validator_account_id: String?, protocol_version: String) {
...
public struct CurrentEpochValidatorInfo: Codable {
    ...
    public init(num_produced_blocks: UInt64, public_key: PublicKey, account_id: AccountId, num_expected_chunks: UInt64?, shards: [ShardId], num_expected_endorsements_per_shard: [UInt64]?, num_produced_endorsements_per_shard: [UInt64]?, num_expected_blocks: UInt64, shards_endorsed: [ShardId]?, num_expected_chunks_per_shard: [UInt64]?, stake: NearToken, num_expected_endorsements: UInt64?, num_produced_chunks: UInt64?, is_slashed: Bool, num_produced_chunks_per_shard: [UInt64]?, num_produced_endorsements: UInt64?) {
...
public struct SignedTransactionView: Codable {
    ...
    public init(actions: [ActionView], public_key: PublicKey, priority_fee: UInt64?, receiver_id: AccountId, nonce: UInt64, signature: Signature, signer_id: AccountId, hash: CryptoHash) {
        self.actions = actions
        self.public_key = public_key
...
public struct JsonRpcRequest_for_light_client_proof: Codable {
    ...
    public init(id: String, method: String, params: RpcLightClientExecutionProofRequest, jsonrpc: String) {
        self.id = id
        self.method = method
        self.params = params
        self.jsonrpc = jsonrpc
...
public struct JsonRpcRequest_for_EXPERIMENTAL_light_client_block_proof: Codable {
    ...
    public init(id: String, method: String, params: RpcLightClientBlockProofRequest, jsonrpc: String) {
        self.id = id
        self.method = method
        self.params = params
        self.jsonrpc = jsonrpc
...
public struct JsonRpcRequest_for_EXPERIMENTAL_changes: Codable {
    ...
    public init(id: String, method: String, params: RpcStateChangesInBlockByTypeRequest, jsonrpc: String) {
        self.id = id
        self.method = method
        self.params = params
        self.jsonrpc = jsonrpc
...
public struct RpcValidatorResponse: Codable {
    ...
    public init(current_fishermen: [ValidatorStakeView], next_fishermen: [ValidatorStakeView], epoch_start_height: UInt64, current_proposals: [ValidatorStakeView], prev_epoch_kickout: [ValidatorKickoutView], epoch_height: UInt64, next_validators: [NextEpochValidatorInfo], current_validators: [CurrentEpochValidatorInfo]) {
...
public struct CongestionControlConfigView: Codable {
    ...
    public init(max_tx_gas: String, max_congestion_missed_chunks: UInt64, outgoing_receipts_big_size_limit: UInt64, max_congestion_memory_consumption: UInt64, max_congestion_outgoing_gas: String, max_outgoing_gas: String, outgoing_receipts_usual_size_limit: UInt64, min_tx_gas: String, reject_tx_congestion_threshold: String, allowed_shard_outgoing_gas: String, max_congestion_incoming_gas: String, min_outgoing_gas: String) {
...
public struct PeerInfoView: Codable {
    ...
    public init(is_outbound_peer: Bool, account_id: String?, last_time_peer_requested_millis: UInt64, height: UInt64?, sent_bytes_per_sec: UInt64, archival: Bool, block_hash: String?, tracked_shards: [ShardId], last_time_received_message_millis: UInt64, peer_id: PublicKey, received_bytes_per_sec: UInt64, nonce: UInt64, addr: String, connection_established_time_millis: UInt64, is_highest_block_invalid: Bool) {
...
public struct AccountView: Codable {
    ...
    public init(storage_usage: UInt64, global_contract_hash: String?, storage_paid_at: UInt64?, global_contract_account_id: String?, amount: NearToken, locked: NearToken, code_hash: CryptoHash) {
...
public struct Version: Codable {
    ...
    public init(commit: String, version: String, rustc_version: String?, build: String) {
        self.commit = commit
        self.version = version
...
public struct JsonRpcRequest_for_maintenance_windows: Codable {
    ...
    public init(method: String, id: String, jsonrpc: String, params: RpcMaintenanceWindowsRequest) {
        self.method = method
        self.id = id
        self.jsonrpc = jsonrpc
        self.params = params
...
public struct JsonRpcRequest_for_changes: Codable {
    ...
    public init(method: String, id: String, jsonrpc: String, params: RpcStateChangesInBlockByTypeRequest) {
        self.method = method
        self.id = id
        self.jsonrpc = jsonrpc
        self.params = params
...
public struct LimitConfig: Codable {
    ...
    public init(initial_memory_pages: String, registers_memory_limit: UInt64, max_length_method_name: UInt64, max_length_storage_value: UInt64, max_transaction_size: UInt64, account_id_validity_rules_version: String?, max_gas_burnt: String, max_yield_payload_size: UInt64, yield_timeout_length_in_blocks: UInt64, max_elements_per_contract_table: String?, max_actions_per_receipt: UInt64, max_length_storage_key: UInt64, max_contract_size: UInt64, max_locals_per_contract: UInt64?, max_total_log_length: UInt64, max_tables_per_contract: String?, max_number_input_data_dependencies: UInt64, max_arguments_length: UInt64, max_memory_pages: String, max_number_bytes_method_names: UInt64, max_receipt_size: UInt64, max_total_prepaid_gas: String, max_stack_height: String, max_number_logs: UInt64, max_promises_per_function_call_action: UInt64, max_functions_number_per_contract: UInt64?, max_length_returned_data: UInt64, max_register_size: UInt64, per_receipt_storage_proof_size_limit: String, max_number_registers: UInt64) {
...
public struct VMConfigView: Codable {
    ...
    public init(reftypes_bulk_memory: Bool, ext_costs: String, eth_implicit_accounts: Bool, global_contract_host_fns: Bool, storage_get_mode: String, limit_config: String, deterministic_account_ids: Bool, grow_mem_cost: String, discard_custom_sections: Bool, regular_op_cost: String, saturating_float_to_int: Bool, implicit_account_creation: Bool, fix_contract_loading_cost: Bool, vm_kind: String) {
...
public struct RpcLightClientExecutionProofResponse: Codable {
    ...
    public init(outcome_proof: ExecutionOutcomeWithIdView, block_proof: [MerklePathItem], block_header_lite: LightClientBlockLiteView, outcome_root_proof: [MerklePathItem]) {
...
public struct RpcClientConfigResponse: Codable {
    ...
    public init(state_sync_enabled: Bool, sync_check_period: [UInt64], epoch_length: UInt64, state_sync_p2p_timeout: [UInt64], state_request_server_threads: String, min_num_peers: String, log_summary_style: String, save_untracked_partial_chunks_parts: Bool, chunk_distribution_network: String?, view_client_threads: String, produce_empty_blocks: Bool, state_sync: String, save_invalid_witnesses: Bool, block_production_tracking_delay: [UInt64], trie_viewer_state_size_limit: UInt64?, catchup_step_period: [UInt64], epoch_sync: String, transaction_pool_size_limit: UInt64?, state_requests_per_throttle_period: String, ttl_account_id_router: [UInt64], orphan_state_witness_max_size: UInt64, tx_routing_height_horizon: UInt64, state_sync_retry_backoff: [UInt64], chain_id: String, save_trie_changes: Bool, protocol_version_check: String, skip_sync_wait: Bool, sync_height_threshold: UInt64, save_tx_outcomes: Bool, state_sync_external_backoff: [UInt64], version: String, rpc_addr: String?, state_sync_external_timeout: [UInt64], chunk_validation_threads: String, log_summary_period: [UInt64], max_gas_burnt_view: String?, enable_statistics_export: Bool, header_sync_stall_ban_timeout: [UInt64], chunk_request_retry_period: [UInt64], client_background_migration_threads: String, max_block_production_delay: [UInt64], header_sync_initial_timeout: [UInt64], sync_step_period: [UInt64], orphan_state_witness_pool_size: String, gc: String, chunk_wait_mult: [Int32], produce_chunk_add_transactions_time_limit: String, cloud_archival_reader: String?, header_sync_progress_timeout: [UInt64], block_fetch_horizon: UInt64, cloud_archival_writer: String?, state_request_throttle_period: [UInt64], num_block_producer_seats: UInt64, doomslug_step_period: [UInt64], min_block_production_delay: [UInt64], archive: Bool, max_block_wait_delay: [UInt64], block_header_fetch_horizon: UInt64, save_latest_witnesses: Bool, transaction_request_handler_threads: String, sync_max_block_requests: String, tracked_shards_config: TrackedShardsConfig, resharding_config: MutableConfigValue, enable_multiline_logging: Bool, header_sync_expected_height_per_second: UInt64, expected_shutdown: String) {
...
public struct JsonRpcRequest_for_chunk: Codable {
    ...
    public init(method: String, id: String, jsonrpc: String, params: RpcChunkRequest) {
        self.method = method
        self.id = id
        self.jsonrpc = jsonrpc
        self.params = params
...
public struct JsonRpcRequest_for_gas_price: Codable {
    ...
    public init(method: String, id: String, jsonrpc: String, params: RpcGasPriceRequest) {
        self.method = method
        self.id = id
        self.jsonrpc = jsonrpc
        self.params = params
...
public struct FinalExecutionOutcomeView: Codable {
    ...
    public init(transaction: String, transaction_outcome: String, receipts_outcome: [ExecutionOutcomeWithIdView], status: String) {
...
public struct NextEpochValidatorInfo: Codable {
    ...
    public init(shards: [ShardId], account_id: AccountId, stake: NearToken, public_key: PublicKey) {
        self.shards = shards
        self.account_id = account_id
        self.stake = stake
        self.public_key = public_key
...
public struct JsonRpcRequest_for_EXPERIMENTAL_light_client_proof: Codable {
    ...
    public init(method: String, id: String, jsonrpc: String, params: RpcLightClientExecutionProofRequest) {
        self.method = method
        self.id = id
        self.jsonrpc = jsonrpc
        self.params = params
...
public struct JsonRpcRequest_for_EXPERIMENTAL_tx_status: Codable {
    ...
    public init(method: String, id: String, jsonrpc: String, params: RpcTransactionStatusRequest) {
        self.method = method
        self.id = id
        self.jsonrpc = jsonrpc
        self.params = params
...
public struct RpcProtocolConfigResponse: Codable {
    ...
    public init(online_min_threshold: [Int32], gas_price_adjustment_rate: [Int32], minimum_stake_divisor: UInt64, epoch_length: UInt64, chunk_validator_only_kickout_threshold: String, num_block_producer_seats_per_shard: [UInt64], minimum_stake_ratio: [Int32], protocol_treasury_account: String, max_gas_price: String, block_producer_kickout_threshold: String, max_kickout_stake_perc: String, target_validator_mandates_per_shard: UInt64, transaction_validity_period: UInt64, chain_id: String, genesis_height: UInt64, max_inflation_rate: [Int32], avg_hidden_validator_seats_per_shard: [UInt64], minimum_validators_per_shard: UInt64, fishermen_threshold: String, protocol_reward_rate: [Int32], genesis_time: String, num_blocks_per_year: UInt64, min_gas_price: String, chunk_producer_kickout_threshold: String, protocol_upgrade_stake_threshold: [Int32], shuffle_shard_assignment_for_chunk_producers: Bool, runtime_config: String, shard_layout: String, dynamic_resharding: Bool, gas_limit: String, protocol_version: String, online_max_threshold: [Int32], num_block_producer_seats: UInt64) {
        self.online_min_threshold = online_min_threshold
        self.gas_price_adjustment_rate = gas_price_adjustment_rate
        self.minimum_stake_divisor = minimum_stake_divisor
        self.epoch_length = epoch_length
...
public struct BlockHeaderInnerLiteView: Codable {
    ...
    public init(timestamp_nanosec: String, block_merkle_root: String, timestamp: UInt64, outcome_root: CryptoHash, next_bp_hash: String, next_epoch_id: String, height: UInt64, epoch_id: String, prev_state_root: CryptoHash) {
        self.timestamp_nanosec = timestamp_nanosec
        self.block_merkle_root = block_merkle_root
        self.timestamp = timestamp
        self.outcome_root = outcome_root
...
public struct CatchupStatusView: Codable {
    ...
    public init(sync_block_height: UInt64, sync_block_hash: CryptoHash, blocks_to_catchup: [BlockStatusView], shard_sync_status: String) {
...
public struct ActionCreationConfigView: Codable {
    ...
    public init(transfer_cost: String, delete_account_cost: String, deploy_contract_cost: String, deploy_contract_cost_per_byte: String, delete_key_cost: String, add_key_cost: String, stake_cost: String, function_call_cost: String, create_account_cost: String, delegate_cost: String, function_call_cost_per_byte: String) {
...
public struct JsonRpcRequest_for_next_light_client_block: Codable {
    ...
    public init(method: String, id: String, jsonrpc: String, params: RpcLightClientNextBlockRequest) {
        self.method = method
        self.id = id
        self.jsonrpc = jsonrpc
        self.params = params
...
public struct ExecutionOutcomeView: Codable {
    ...
    public init(receipt_ids: [CryptoHash], executor_id: String, gas_burnt: String, status: String, logs: [String], metadata: String?, tokens_burnt: String) {
...
public struct RuntimeConfigView: Codable {
    ...
    public init(storage_amount_per_byte: String, congestion_control_config: String, witness_config: String, wasm_config: String, account_creation_config: String, transaction_costs: String) {
...
public struct FinalExecutionOutcomeWithReceiptView: Codable {
    ...
    public init(transaction: String, transaction_outcome: String, receipts: [ReceiptView], status: String, receipts_outcome: [ExecutionOutcomeWithIdView]) {
        self.transaction = transaction
        self.transaction_outcome = transaction_outcome
        self.receipts = receipts
        self.status = status
...
public struct JsonRpcRequest_for_EXPERIMENTAL_protocol_config: Codable {
    ...
    public init(method: String, id: String, jsonrpc: String, params: RpcProtocolConfigRequest) {
        self.method = method
        self.id = id
        self.jsonrpc = jsonrpc
        self.params = params
...
public struct JsonRpcRequest_for_EXPERIMENTAL_congestion_level: Codable {
    ...
    public init(method: String, id: String, jsonrpc: String, params: RpcCongestionLevelRequest) {
        self.method = method
        self.id = id
        self.jsonrpc = jsonrpc
        self.params = params
...
public struct ShardLayoutV2: Codable {
    ...
    public init(index_to_id_map: String, shard_ids: [ShardId], boundary_accounts: [AccountId], id_to_index_map: String, version: String, shards_split_map: String?, shards_parent_map: String?) {
...
public struct JsonRpcRequest_for_health: Codable {
    ...
    public init(method: String, id: String, jsonrpc: String, params: RpcHealthRequest) {
        self.method = method
        self.id = id
        self.jsonrpc = jsonrpc
        self.params = params
