...
public struct DumpConfig: Codable, Sendable {
    ...
    public init(iteration_delay: String?, credentials_file: String?, restart_dump_for_shards: [ShardId]?, location: ExternalStorageLocation) {
...
public struct SignedTransactionView: Codable, Sendable {
    ...
    public init(nonce: UInt64, signature: Signature, public_key: PublicKey, hash: CryptoHash, receiver_id: AccountId, actions: [ActionView], signer_id: AccountId, priority_fee: UInt64?) {
        self.nonce = nonce
...
public struct JsonRpcRequest_for_status: Codable, Sendable {
    ...
    public init(jsonrpc: String, id: String, params: RpcStatusRequest, method: String) {
...
public struct CloudArchivalWriterConfig: Codable, Sendable {
    ...
    public init(archive_block_data: Bool?, polling_interval: DurationAsStdSchemaProvider?, cloud_storage: CloudStorageConfig) {
...
public struct DetailedDebugStatus: Codable, Sendable {
    ...
    public init(network_info: NetworkInfoView, sync_status: String, current_header_head_status: BlockStatusView, block_production_delay_millis: UInt64, catchup_status: [CatchupStatusView], current_head_status: BlockStatusView) {
...
public struct BlockHeaderInnerLiteView: Codable, Sendable {
    ...
    public init(block_merkle_root: CryptoHash, timestamp_nanosec: String, next_epoch_id: CryptoHash, epoch_id: CryptoHash, height: UInt64, next_bp_hash: CryptoHash, outcome_root: CryptoHash, prev_state_root: CryptoHash, timestamp: UInt64) {
...
public struct ExtCostsConfigView: Codable, Sendable {
    ...
    public init(alt_bn128_g1_multiexp_base: NearGas, storage_iter_next_value_byte: NearGas, promise_and_per_promise: NearGas, contract_compile_bytes: NearGas, keccak512_byte: NearGas, storage_read_key_byte: NearGas, read_register_byte: NearGas, bls12381_p2_decompress_element: NearGas, ecrecover_base: NearGas, ed25519_verify_base: NearGas, storage_write_key_byte: NearGas, keccak256_byte: NearGas, storage_has_key_byte: NearGas, alt_bn128_pairing_check_element: NearGas, alt_bn128_g1_multiexp_element: NearGas, bls12381_p2_sum_element: NearGas, ripemd160_base: NearGas, storage_large_read_overhead_base: NearGas, bls12381_map_fp_to_g1_base: NearGas, yield_resume_base: NearGas, storage_large_read_overhead_byte: NearGas, storage_iter_next_key_byte: NearGas, storage_iter_next_base: NearGas, storage_read_base: NearGas, log_byte: NearGas, contract_loading_base: NearGas, write_memory_byte: NearGas, bls12381_map_fp2_to_g2_element: NearGas, validator_total_stake_base: NearGas, promise_and_base: NearGas, bls12381_p2_sum_base: NearGas, bls12381_map_fp_to_g1_element: NearGas, storage_remove_base: NearGas, bls12381_g1_multiexp_base: NearGas, ed25519_verify_byte: NearGas, bls12381_p1_decompress_base: NearGas, storage_iter_create_to_byte: NearGas, bls12381_map_fp2_to_g2_base: NearGas, utf8_decoding_byte: NearGas, storage_read_value_byte: NearGas, write_register_byte: NearGas, bls12381_g2_multiexp_base: NearGas, bls12381_pairing_base: NearGas, bls12381_pairing_element: NearGas, storage_iter_create_prefix_byte: NearGas, contract_compile_base: NearGas, storage_remove_key_byte: NearGas, alt_bn128_pairing_check_base: NearGas, bls12381_g2_multiexp_element: NearGas, read_cached_trie_node: NearGas, validator_stake_base: NearGas, storage_write_value_byte: NearGas, bls12381_p1_sum_base: NearGas, storage_write_base: NearGas, read_memory_byte: NearGas, storage_iter_create_prefix_base: NearGas, alt_bn128_g1_sum_element: NearGas, yield_create_base: NearGas, storage_iter_create_range_base: NearGas, write_memory_base: NearGas, bls12381_p1_decompress_element: NearGas, storage_has_key_base: NearGas, write_register_base: NearGas, utf8_decoding_base: NearGas, yield_resume_byte: NearGas, log_base: NearGas, storage_remove_ret_value_byte: NearGas, contract_loading_bytes: NearGas, keccak512_base: NearGas, utf16_decoding_byte: NearGas, yield_create_byte: NearGas, ripemd160_block: NearGas, base: NearGas, keccak256_base: NearGas, sha256_base: NearGas, read_register_base: NearGas, sha256_byte: NearGas, read_memory_base: NearGas, alt_bn128_g1_sum_base: NearGas, utf16_decoding_base: NearGas, bls12381_g1_multiexp_element: NearGas, promise_return: NearGas, touching_trie_node: NearGas, storage_iter_create_from_byte: NearGas, bls12381_p1_sum_element: NearGas, bls12381_p2_decompress_base: NearGas, storage_write_evicted_byte: NearGas) {
...
public struct ShardLayoutV2: Codable, Sendable {
    ...
    public init(version: UInt32, shards_split_map: String?, boundary_accounts: [AccountId], shards_parent_map: String?, id_to_index_map: String, index_to_id_map: String, shard_ids: [ShardId]) {
        self.version = version
...
public struct SyncConcurrency: Codable, Sendable {
    ...
    public init(peer_downloads: String, per_shard: String, apply_during_catchup: String, apply: String) {
...
public struct CurrentEpochValidatorInfo: Codable, Sendable {
    ...
    public init(num_produced_endorsements: UInt64?, num_expected_blocks: UInt64, num_expected_endorsements: UInt64?, public_key: PublicKey, shards: [ShardId], num_produced_chunks: UInt64?, shards_endorsed: [ShardId]?, account_id: AccountId, stake: NearToken, num_expected_chunks: UInt64?, num_produced_endorsements_per_shard: [UInt64]?, num_produced_chunks_per_shard: [UInt64]?, num_expected_endorsements_per_shard: [UInt64]?, num_expected_chunks_per_shard: [UInt64]?, is_slashed: Bool, num_produced_blocks: UInt64) {
...
public struct EpochSyncConfig: Codable, Sendable {
    ...
    public init(epoch_sync_horizon: UInt64, timeout_for_epoch_sync: DurationAsStdSchemaProvider, disable_epoch_sync_for_bootstrapping: Bool?, ignore_epoch_sync_network_requests: Bool?) {
...
public struct ChunkHeaderView: Codable, Sendable {
    ...
    public init(gas_limit: NearGas, outgoing_receipts_root: CryptoHash, outcome_root: CryptoHash, signature: Signature, validator_proposals: [ValidatorStakeView], gas_used: NearGas, encoded_length: UInt64, prev_block_hash: CryptoHash, encoded_merkle_root: CryptoHash, chunk_hash: CryptoHash, height_created: UInt64, prev_state_root: CryptoHash, rent_paid: NearToken?, shard_id: ShardId, height_included: UInt64, balance_burnt: NearToken, congestion_info: String?, validator_reward: NearToken?, bandwidth_requests: String?, tx_root: CryptoHash) {
...
public struct FinalExecutionOutcomeWithReceiptView: Codable, Sendable {
    ...
    public init(transaction: SignedTransactionView, receipts: [ReceiptView], status: FinalExecutionStatus, transaction_outcome: ExecutionOutcomeWithIdView, receipts_outcome: [ExecutionOutcomeWithIdView]) {
...
public struct ExecutionOutcomeView: Codable, Sendable {
    ...
    public init(status: ExecutionStatusView, receipt_ids: [CryptoHash], tokens_burnt: NearToken, metadata: ExecutionMetadataView?, executor_id: AccountId, logs: [String], gas_burnt: NearGas) {
        self.status = status
...
public struct ExternalStorageConfig: Codable, Sendable {
    ...
    public init(num_concurrent_requests: String?, num_concurrent_requests_during_catchup: String?, external_storage_fallback_threshold: UInt64?, location: ExternalStorageLocation) {
...
public struct PeerInfoView: Codable, Sendable {
    ...
    public init(account_id: String?, is_highest_block_invalid: Bool, archival: Bool, last_time_peer_requested_millis: UInt64, last_time_received_message_millis: UInt64, tracked_shards: [ShardId], addr: String, block_hash: String?, connection_established_time_millis: UInt64, received_bytes_per_sec: UInt64, is_outbound_peer: Bool, sent_bytes_per_sec: UInt64, nonce: UInt64, peer_id: PublicKey, height: UInt64?) {
        self.account_id = account_id
...
public struct LimitConfig: Codable, Sendable {
    ...
    public init(per_receipt_storage_proof_size_limit: String, max_length_returned_data: UInt64, max_total_log_length: UInt64, max_length_storage_key: UInt64, max_stack_height: UInt32, max_actions_per_receipt: UInt64, max_promises_per_function_call_action: UInt64, registers_memory_limit: UInt64, max_number_logs: UInt64, max_contract_size: UInt64, max_receipt_size: UInt64, max_number_bytes_method_names: UInt64, max_memory_pages: UInt32, max_yield_payload_size: UInt64, max_number_input_data_dependencies: UInt64, max_functions_number_per_contract: UInt64?, max_elements_per_contract_table: String?, max_gas_burnt: NearGas, max_total_prepaid_gas: NearGas, max_locals_per_contract: UInt64?, initial_memory_pages: UInt32, max_length_method_name: UInt64, max_transaction_size: UInt64, max_register_size: UInt64, max_arguments_length: UInt64, max_tables_per_contract: UInt32?, account_id_validity_rules_version: AccountIdValidityRulesVersion?, yield_timeout_length_in_blocks: UInt64, max_number_registers: UInt64, max_length_storage_value: UInt64) {
...
public struct RuntimeConfigView: Codable, Sendable {
    ...
    public init(congestion_control_config: CongestionControlConfigView, account_creation_config: AccountCreationConfigView, witness_config: WitnessConfigView, wasm_config: VMConfigView, transaction_costs: RuntimeFeesConfigView, storage_amount_per_byte: NearToken) {
...
public struct ExecutionOutcomeWithIdView: Codable, Sendable {
    ...
    public init(outcome: ExecutionOutcomeView, block_hash: CryptoHash, id: CryptoHash, proof: [MerklePathItem]) {
...
public struct JsonRpcRequest_for_gas_price: Codable, Sendable {
    ...
    public init(jsonrpc: String, id: String, params: RpcGasPriceRequest, method: String) {
        self.jsonrpc = jsonrpc
        self.id = id
        self.params = params
        self.method = method
...
public struct DelegateAction: Codable, Sendable {
    ...
    public init(max_block_height: UInt64, receiver_id: AccountId, sender_id: AccountId, public_key: PublicKey, actions: [NonDelegateAction], nonce: UInt64) {
...
public struct ShardLayoutV1: Codable, Sendable {
    ...
    public init(boundary_accounts: [AccountId], to_parent_shard_map: [ShardId]?, shards_split_map: [[ShardId]]?, version: UInt32) {
        self.boundary_accounts = boundary_accounts
...
public struct VMConfigView: Codable, Sendable {
    ...
    public init(saturating_float_to_int: Bool, grow_mem_cost: UInt32, vm_kind: VMKind, global_contract_host_fns: Bool, implicit_account_creation: Bool, fix_contract_loading_cost: Bool, discard_custom_sections: Bool, reftypes_bulk_memory: Bool, ext_costs: ExtCostsConfigView, deterministic_account_ids: Bool, storage_get_mode: StorageGetMode, eth_implicit_accounts: Bool, limit_config: LimitConfig, regular_op_cost: UInt32) {
...
public struct RpcReceiptResponse: Codable, Sendable {
    ...
    public init(receipt_id: CryptoHash, receiver_id: AccountId, priority: UInt64?, receipt: ReceiptEnumView, predecessor_id: AccountId) {
        self.receipt_id = receipt_id
        self.receiver_id = receiver_id
...
public struct StatusSyncInfo: Codable, Sendable {
    ...
    public init(syncing: Bool, latest_block_hash: CryptoHash, earliest_block_hash: String?, earliest_block_height: UInt64?, epoch_start_height: UInt64?, epoch_id: String?, latest_block_height: UInt64, earliest_block_time: String?, latest_state_root: CryptoHash, latest_block_time: String) {
...
public struct GenesisConfig: Codable, Sendable {
    ...
    public init(max_gas_price: NearToken, gas_limit: NearGas, minimum_validators_per_shard: UInt64?, use_production_config: Bool?, minimum_stake_divisor: UInt64?, max_kickout_stake_perc: String?, chunk_producer_assignment_changes_limit: UInt64?, fishermen_threshold: NearToken, dynamic_resharding: Bool, online_min_threshold: [Int32]?, avg_hidden_validator_seats_per_shard: [UInt64], protocol_treasury_account: AccountId, total_supply: NearToken, online_max_threshold: [Int32]?, shard_layout: ShardLayout?, epoch_length: UInt64, num_chunk_validator_seats: UInt64?, protocol_upgrade_stake_threshold: [Int32]?, block_producer_kickout_threshold: String, minimum_stake_ratio: [Int32]?, validators: [AccountInfo], transaction_validity_period: UInt64, genesis_time: String, min_gas_price: NearToken, chain_id: String, num_block_producer_seats: UInt64, max_inflation_rate: [Int32], shuffle_shard_assignment_for_chunk_producers: Bool?, num_chunk_only_producer_seats: UInt64?, num_chunk_producer_seats: UInt64?, num_blocks_per_year: UInt64, protocol_reward_rate: [Int32], chunk_validator_only_kickout_threshold: String?, genesis_height: UInt64, protocol_version: UInt32, num_block_producer_seats_per_shard: [UInt64], chunk_producer_kickout_threshold: String, target_validator_mandates_per_shard: UInt64?, gas_price_adjustment_rate: [Int32]) {
...
public struct CatchupStatusView: Codable, Sendable {
    ...
    public init(shard_sync_status: String, blocks_to_catchup: [BlockStatusView], sync_block_hash: CryptoHash, sync_block_height: UInt64) {
...
public struct RpcValidatorResponse: Codable, Sendable {
    ...
    public init(current_validators: [CurrentEpochValidatorInfo], epoch_height: UInt64, current_proposals: [ValidatorStakeView], prev_epoch_kickout: [ValidatorKickoutView], epoch_start_height: UInt64, next_fishermen: [ValidatorStakeView], next_validators: [NextEpochValidatorInfo], current_fishermen: [ValidatorStakeView]) {
...
public struct JsonRpcRequest_for_EXPERIMENTAL_receipt: Codable, Sendable {
    ...
    public init(method: String, id: String, params: RpcReceiptRequest, jsonrpc: String) {
        self.method = method
        self.id = id
        self.params = params
        self.jsonrpc = jsonrpc
...
public struct BlockHeaderView: Codable, Sendable {
    ...
    public init(chunk_headers_root: CryptoHash, block_merkle_root: CryptoHash, gas_price: NearToken, chunk_receipts_root: CryptoHash, prev_hash: CryptoHash, last_final_block: CryptoHash, latest_protocol_version: UInt32, height: UInt64, random_value: CryptoHash, chunk_mask: [Bool], signature: Signature, challenges_result: [SlashedValidator], epoch_sync_data_hash: String?, prev_state_root: CryptoHash, total_supply: NearToken, block_body_hash: String?, chunks_included: UInt64, chunk_tx_root: CryptoHash, hash: CryptoHash, validator_proposals: [ValidatorStakeView], validator_reward: NearToken?, next_bp_hash: CryptoHash, timestamp: UInt64, timestamp_nanosec: String, outcome_root: CryptoHash, approvals: [String], prev_height: UInt64?, last_ds_final_block: CryptoHash, rent_paid: NearToken?, block_ordinal: UInt64?, next_epoch_id: CryptoHash, epoch_id: CryptoHash, chunk_endorsements: [[String]]?, challenges_root: CryptoHash) {
...
public struct RpcClientConfigResponse: Codable, Sendable {
    ...
    public init(version: Version, enable_statistics_export: Bool, save_trie_changes: Bool, chunk_distribution_network: String?, state_request_server_threads: String, cloud_archival_reader: String?, ttl_account_id_router: [UInt64], sync_step_period: [UInt64], header_sync_expected_height_per_second: UInt64, epoch_length: UInt64, epoch_sync: EpochSyncConfig, produce_empty_blocks: Bool, tracked_shards_config: TrackedShardsConfig, min_block_production_delay: [UInt64], expected_shutdown: MutableConfigValue, view_client_threads: String, sync_height_threshold: UInt64, block_fetch_horizon: UInt64, save_untracked_partial_chunks_parts: Bool, sync_check_period: [UInt64], chunk_wait_mult: [Int32], max_block_wait_delay: [UInt64], save_latest_witnesses: Bool, gc: GCConfig, save_tx_outcomes: Bool, catchup_step_period: [UInt64], header_sync_progress_timeout: [UInt64], transaction_request_handler_threads: String, block_header_fetch_horizon: UInt64, orphan_state_witness_max_size: UInt64, transaction_pool_size_limit: UInt64?, produce_chunk_add_transactions_time_limit: String, num_block_producer_seats: UInt64, protocol_version_check: ProtocolVersionCheckConfig, log_summary_style: LogSummaryStyle, chain_id: String, min_num_peers: String, state_sync_p2p_timeout: [UInt64], header_sync_stall_ban_timeout: [UInt64], log_summary_period: [UInt64], resharding_config: MutableConfigValue, archive: Bool, skip_sync_wait: Bool, state_sync_retry_backoff: [UInt64], tx_routing_height_horizon: UInt64, rpc_addr: String?, doomslug_step_period: [UInt64], trie_viewer_state_size_limit: UInt64?, enable_multiline_logging: Bool, chunk_request_retry_period: [UInt64], chunk_validation_threads: String, state_requests_per_throttle_period: String, cloud_archival_writer: String?, state_sync_external_timeout: [UInt64], state_sync: StateSyncConfig, orphan_state_witness_pool_size: String, header_sync_initial_timeout: [UInt64], sync_max_block_requests: String, state_request_throttle_period: [UInt64], block_production_tracking_delay: [UInt64], max_gas_burnt_view: String?, state_sync_external_backoff: [UInt64], client_background_migration_threads: String, max_block_production_delay: [UInt64], save_invalid_witnesses: Bool, state_sync_enabled: Bool) {
        self.version = version
...
public struct AccountView: Codable, Sendable {
    ...
    public init(global_contract_account_id: String?, storage_usage: UInt64, global_contract_hash: String?, storage_paid_at: UInt64?, amount: NearToken, locked: NearToken, code_hash: CryptoHash) {
...
public struct NetworkInfoView: Codable, Sendable {
    ...
    public init(num_connected_peers: String, tier1_accounts_data: [AccountDataView], known_producers: [KnownProducerView], tier1_connections: [PeerInfoView], peer_max_count: UInt32, tier1_accounts_keys: [PublicKey], connected_peers: [PeerInfoView]) {
...
public struct JsonRpcRequest_for_block: Codable, Sendable {
    ...
    public init(method: String, id: String, params: RpcBlockRequest, jsonrpc: String) {
        self.method = method
        self.id = id
        self.params = params
        self.jsonrpc = jsonrpc
...
public struct FinalExecutionOutcomeView: Codable, Sendable {
    ...
    public init(transaction: SignedTransactionView, receipts_outcome: [ExecutionOutcomeWithIdView], transaction_outcome: ExecutionOutcomeWithIdView, status: FinalExecutionStatus) {
        self.transaction = transaction
        self.receipts_outcome = receipts_outcome
        self.transaction_outcome = transaction_outcome
        self.status = status
...
public struct GasKeyView: Codable, Sendable {
    ...
    public init(permission: AccessKeyPermissionView, balance: NearToken, num_nonces: UInt32) {
        self.permission = permission
...
public struct Fee: Codable, Sendable {
    ...
    public init(send_sir: NearGas, send_not_sir: NearGas, execution: NearGas) {
...
public struct RpcNetworkInfoResponse: Codable, Sendable {
    ...
    public init(peer_max_count: UInt32, sent_bytes_per_sec: UInt64, active_peers: [RpcPeerInfo], received_bytes_per_sec: UInt64, known_producers: [RpcKnownProducer], num_active_peers: String) {
        self.peer_max_count = peer_max_count
        self.sent_bytes_per_sec = sent_bytes_per_sec
...
public struct CongestionControlConfigView: Codable, Sendable {
    ...
    public init(max_congestion_memory_consumption: UInt64, max_outgoing_gas: NearGas, max_tx_gas: NearGas, max_congestion_outgoing_gas: NearGas, min_outgoing_gas: NearGas, outgoing_receipts_big_size_limit: UInt64, min_tx_gas: NearGas, outgoing_receipts_usual_size_limit: UInt64, allowed_shard_outgoing_gas: NearGas, reject_tx_congestion_threshold: String, max_congestion_incoming_gas: NearGas, max_congestion_missed_chunks: UInt64) {
...
public struct RuntimeFeesConfigView: Codable, Sendable {
    ...
    public init(storage_usage_config: StorageUsageConfigView, action_receipt_creation_config: Fee, action_creation_config: ActionCreationConfigView, pessimistic_gas_price_inflation_ratio: [Int32], data_receipt_creation_config: DataReceiptCreationConfigView, burnt_gas_reward: [Int32]) {
...
public struct ActionCreationConfigView: Codable, Sendable {
    ...
    public init(delete_key_cost: Fee, create_account_cost: Fee, function_call_cost_per_byte: Fee, delegate_cost: Fee, function_call_cost: Fee, stake_cost: Fee, add_key_cost: AccessKeyCreationConfigView, delete_account_cost: Fee, deploy_contract_cost: Fee, transfer_cost: Fee, deploy_contract_cost_per_byte: Fee) {
...
public struct RpcProtocolConfigResponse: Codable, Sendable {
    ...
    public init(max_inflation_rate: [Int32], protocol_reward_rate: [Int32], protocol_version: UInt32, gas_limit: NearGas, gas_price_adjustment_rate: [Int32], num_blocks_per_year: UInt64, online_max_threshold: [Int32], minimum_validators_per_shard: UInt64, online_min_threshold: [Int32], max_gas_price: NearToken, minimum_stake_ratio: [Int32], genesis_height: UInt64, epoch_length: UInt64, shuffle_shard_assignment_for_chunk_producers: Bool, avg_hidden_validator_seats_per_shard: [UInt64], min_gas_price: NearToken, runtime_config: RuntimeConfigView, chunk_validator_only_kickout_threshold: String, chunk_producer_kickout_threshold: String, genesis_time: String, num_block_producer_seats: UInt64, num_block_producer_seats_per_shard: [UInt64], max_kickout_stake_perc: String, chain_id: String, dynamic_resharding: Bool, protocol_upgrade_stake_threshold: [Int32], fishermen_threshold: NearToken, protocol_treasury_account: AccountId, minimum_stake_divisor: UInt64, target_validator_mandates_per_shard: UInt64, block_producer_kickout_threshold: String, transaction_validity_period: UInt64, shard_layout: ShardLayout) {
        self.max_inflation_rate = max_inflation_rate
        self.protocol_reward_rate = protocol_reward_rate
        self.protocol_version = protocol_version
        self.gas_limit = gas_limit
...
public struct RpcStatusResponse: Codable, Sendable {
    ...
    public init(protocol_version: UInt32, node_key: String?, validator_public_key: String?, validator_account_id: String?, chain_id: String, genesis_hash: CryptoHash, rpc_addr: String?, validators: [ValidatorInfo], uptime_sec: Int64, node_public_key: PublicKey, sync_info: StatusSyncInfo, detailed_debug_status: String?, version: Version, latest_protocol_version: UInt32) {
        self.protocol_version = protocol_version
