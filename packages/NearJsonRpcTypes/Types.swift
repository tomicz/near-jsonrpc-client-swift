...
// Generated on: 2025-09-26 02:19:38 +0000
...
public struct RpcLightClientExecutionProofResponse: Codable {
    ...
    public init(outcome_proof: ExecutionOutcomeWithIdView, block_header_lite: LightClientBlockLiteView, block_proof: [MerklePathItem], outcome_root_proof: [MerklePathItem]) {
...
public struct FinalExecutionOutcomeView: Codable {
    ...
    public init(transaction_outcome: String, status: String, receipts_outcome: [ExecutionOutcomeWithIdView], transaction: String) {
...
public struct CloudArchivalWriterConfig: Codable {
    ...
    public init(cloud_storage: String, polling_interval: String?, archive_block_data: Bool?) {
...
public struct CurrentEpochValidatorInfo: Codable {
    ...
    public init(num_expected_chunks: UInt64?, num_produced_endorsements_per_shard: [UInt64]?, is_slashed: Bool, num_expected_endorsements_per_shard: [UInt64]?, shards_endorsed: [ShardId]?, shards: [ShardId], num_expected_endorsements: UInt64?, num_produced_endorsements: UInt64?, num_produced_chunks_per_shard: [UInt64]?, num_expected_chunks_per_shard: [UInt64]?, num_expected_blocks: UInt64, stake: NearToken, account_id: AccountId, num_produced_blocks: UInt64, public_key: PublicKey, num_produced_chunks: UInt64?) {
...
public struct JsonRpcRequest_for_EXPERIMENTAL_validators_ordered: Codable {
    ...
    public init(id: String, params: RpcValidatorsOrderedRequest, method: String, jsonrpc: String) {
        self.id = id
        self.params = params
        self.method = method
...
public struct NetworkInfoView: Codable {
    ...
    public init(num_connected_peers: String, tier1_connections: [PeerInfoView], tier1_accounts_keys: [PublicKey], tier1_accounts_data: [AccountDataView], known_producers: [KnownProducerView], connected_peers: [PeerInfoView], peer_max_count: String) {
...
public struct ReceiptView: Codable {
    ...
    public init(receipt_id: CryptoHash, receiver_id: AccountId, receipt: ReceiptEnumView, priority: UInt64?, predecessor_id: AccountId) {
...
public struct JsonRpcRequest_for_chunk: Codable {
    ...
    public init(id: String, params: RpcChunkRequest, method: String, jsonrpc: String) {
        self.id = id
        self.params = params
        self.method = method
        self.jsonrpc = jsonrpc
...
public struct GenesisConfig: Codable {
    ...
    public init(num_chunk_validator_seats: UInt64?, dynamic_resharding: Bool, protocol_treasury_account: String, online_max_threshold: [Int32]?, minimum_stake_divisor: UInt64?, protocol_version: String, num_blocks_per_year: UInt64, num_block_producer_seats_per_shard: [UInt64], chunk_validator_only_kickout_threshold: String?, block_producer_kickout_threshold: String, minimum_validators_per_shard: UInt64?, protocol_upgrade_stake_threshold: [Int32]?, chunk_producer_assignment_changes_limit: UInt64?, max_inflation_rate: [Int32], min_gas_price: String, validators: [AccountInfo], transaction_validity_period: UInt64, shard_layout: String?, gas_price_adjustment_rate: [Int32], num_chunk_only_producer_seats: UInt64?, gas_limit: String, num_block_producer_seats: UInt64, fishermen_threshold: String, epoch_length: UInt64, chain_id: String, chunk_producer_kickout_threshold: String, total_supply: String, max_gas_price: NearToken, use_production_config: Bool?, genesis_height: UInt64, num_chunk_producer_seats: UInt64?, target_validator_mandates_per_shard: UInt64?, minimum_stake_ratio: [Int32]?, protocol_reward_rate: [Int32], shuffle_shard_assignment_for_chunk_producers: Bool?, genesis_time: String, max_kickout_stake_perc: String?, online_min_threshold: [Int32]?, avg_hidden_validator_seats_per_shard: [UInt64]) {
...
public struct FunctionCallAction: Codable {
    ...
    public init(gas: NearGas, deposit: NearToken, method_name: String, args: String) {
        self.gas = gas
...
public struct JsonRpcRequest_for_health: Codable {
    ...
    public init(id: String, params: RpcHealthRequest, method: String, jsonrpc: String) {
        self.id = id
        self.params = params
        self.method = method
        self.jsonrpc = jsonrpc
...
public struct JsonRpcRequest_for_EXPERIMENTAL_congestion_level: Codable {
    ...
    public init(id: String, params: RpcCongestionLevelRequest, method: String, jsonrpc: String) {
        self.id = id
        self.params = params
        self.method = method
        self.jsonrpc = jsonrpc
...
public struct ChunkHeaderView: Codable {
    ...
    public init(chunk_hash: CryptoHash, prev_state_root: CryptoHash, gas_limit: NearGas, height_created: UInt64, outcome_root: CryptoHash, shard_id: ShardId, congestion_info: String?, outgoing_receipts_root: CryptoHash, rent_paid: String?, tx_root: CryptoHash, signature: Signature, balance_burnt: NearToken, gas_used: NearGas, encoded_merkle_root: CryptoHash, height_included: UInt64, prev_block_hash: CryptoHash, encoded_length: UInt64, validator_proposals: [ValidatorStakeView], bandwidth_requests: String?, validator_reward: String?) {
...
public struct RuntimeFeesConfigView: Codable {
    ...
    public init(burnt_gas_reward: [Int32], action_creation_config: String, data_receipt_creation_config: String, action_receipt_creation_config: String, pessimistic_gas_price_inflation_ratio: [Int32], storage_usage_config: String) {
...
public struct BlockHeaderView: Codable {
    ...
    public init(gas_price: NearToken, challenges_result: [SlashedValidator], timestamp: UInt64, chunk_mask: [Bool], outcome_root: CryptoHash, chunk_tx_root: CryptoHash, chunk_headers_root: CryptoHash, total_supply: NearToken, prev_height: UInt64?, block_ordinal: UInt64?, chunk_endorsements: [[String]]?, rent_paid: String?, block_merkle_root: CryptoHash, prev_hash: String, signature: String, height: UInt64, next_epoch_id: CryptoHash, validator_proposals: [ValidatorStakeView], validator_reward: String?, approvals: [String], last_final_block: CryptoHash, chunk_receipts_root: CryptoHash, prev_state_root: CryptoHash, epoch_id: CryptoHash, latest_protocol_version: String, timestamp_nanosec: String, next_bp_hash: CryptoHash, last_ds_final_block: CryptoHash, challenges_root: CryptoHash, chunks_included: UInt64, hash: CryptoHash, block_body_hash: String?, epoch_sync_data_hash: String?, random_value: CryptoHash) {
...
public struct AccountView: Codable {
    ...
    public init(code_hash: CryptoHash, amount: NearToken, storage_paid_at: UInt64?, storage_usage: UInt64, global_contract_account_id: String?, global_contract_hash: String?, locked: NearToken) {
...
public enum RpcLightClientExecutionProofRequest: Codable {
    case case0(sender_id: AccountId, type: String, transaction_hash: CryptoHash)
    case case01(receiver_id: AccountId, receipt_id: CryptoHash, type: String)
}
...
public struct JsonRpcRequest_for_validators: Codable {
    ...
    public init(id: String, params: RpcValidatorRequest, method: String, jsonrpc: String) {
        self.id = id
        self.params = params
        self.method = method
        self.jsonrpc = jsonrpc
...
public struct CongestionControlConfigView: Codable {
    ...
    public init(min_outgoing_gas: String, max_tx_gas: String, max_congestion_memory_consumption: UInt64, max_congestion_incoming_gas: String, max_congestion_outgoing_gas: String, outgoing_receipts_usual_size_limit: UInt64, max_congestion_missed_chunks: UInt64, allowed_shard_outgoing_gas: String, min_tx_gas: String, outgoing_receipts_big_size_limit: UInt64, max_outgoing_gas: String, reject_tx_congestion_threshold: String) {
...
public struct EpochSyncConfig: Codable {
    ...
    public init(epoch_sync_horizon: UInt64, disable_epoch_sync_for_bootstrapping: Bool?, ignore_epoch_sync_network_requests: Bool?, timeout_for_epoch_sync: String) {
...
public struct FinalExecutionOutcomeWithReceiptView: Codable {
    ...
    public init(receipts_outcome: [ExecutionOutcomeWithIdView], transaction_outcome: String, transaction: String, status: String, receipts: [ReceiptView]) {
        self.receipts_outcome = receipts_outcome
        self.transaction_outcome = transaction_outcome
        self.transaction = transaction
        self.status = status
...
public struct VMConfigView: Codable {
    ...
    public init(deterministic_account_ids: Bool, saturating_float_to_int: Bool, reftypes_bulk_memory: Bool, ext_costs: String, implicit_account_creation: Bool, global_contract_host_fns: Bool, discard_custom_sections: Bool, vm_kind: String, grow_mem_cost: String, limit_config: String, eth_implicit_accounts: Bool, regular_op_cost: String, storage_get_mode: String, fix_contract_loading_cost: Bool) {
...
public struct StatusSyncInfo: Codable {
    ...
    public init(earliest_block_time: String?, latest_block_hash: CryptoHash, syncing: Bool, latest_state_root: CryptoHash, latest_block_height: UInt64, epoch_id: String?, latest_block_time: String, epoch_start_height: UInt64?, earliest_block_height: UInt64?, earliest_block_hash: String?) {
...
public struct RpcKnownProducer: Codable {
    ...
    public init(peer_id: PeerId, account_id: AccountId, addr: String?) {
...
public struct LimitConfig: Codable {
    ...
    public init(max_total_log_length: UInt64, max_total_prepaid_gas: String, max_memory_pages: String, max_length_storage_key: UInt64, max_gas_burnt: String, max_actions_per_receipt: UInt64, initial_memory_pages: String, max_stack_height: String, max_receipt_size: UInt64, max_transaction_size: UInt64, max_locals_per_contract: UInt64?, max_number_input_data_dependencies: UInt64, max_promises_per_function_call_action: UInt64, account_id_validity_rules_version: String?, max_elements_per_contract_table: String?, per_receipt_storage_proof_size_limit: String, max_tables_per_contract: String?, max_register_size: UInt64, yield_timeout_length_in_blocks: UInt64, max_length_storage_value: UInt64, max_contract_size: UInt64, max_number_registers: UInt64, max_yield_payload_size: UInt64, max_number_logs: UInt64, registers_memory_limit: UInt64, max_length_returned_data: UInt64, max_length_method_name: UInt64, max_functions_number_per_contract: UInt64?, max_number_bytes_method_names: UInt64, max_arguments_length: UInt64) {
...
public struct ShardLayoutV1: Codable {
    ...
    public init(boundary_accounts: [AccountId], version: String, to_parent_shard_map: [ShardId]?, shards_split_map: [[ShardId]]?) {
...
public struct RuntimeConfigView: Codable {
    ...
    public init(transaction_costs: String, storage_amount_per_byte: String, account_creation_config: String, congestion_control_config: String, witness_config: String, wasm_config: String) {
...
public struct SignedTransactionView: Codable {
    ...
    public init(nonce: UInt64, signature: Signature, public_key: PublicKey, actions: [ActionView], hash: CryptoHash, priority_fee: UInt64?, signer_id: AccountId, receiver_id: AccountId) {
        self.nonce = nonce
        self.signature = signature
        self.public_key = public_key
...
public struct ActionCreationConfigView: Codable {
    ...
    public init(create_account_cost: String, add_key_cost: String, stake_cost: String, deploy_contract_cost_per_byte: String, deploy_contract_cost: String, delete_key_cost: String, function_call_cost_per_byte: String, function_call_cost: String, transfer_cost: String, delete_account_cost: String, delegate_cost: String) {
...
public struct JsonRpcRequest_for_EXPERIMENTAL_changes_in_block: Codable {
    ...
    public init(id: String, params: RpcStateChangesInBlockRequest, method: String, jsonrpc: String) {
        self.id = id
        self.params = params
        self.method = method
        self.jsonrpc = jsonrpc
...
public struct BlockHeaderInnerLiteView: Codable {
    ...
    public init(next_epoch_id: String, timestamp: UInt64, block_merkle_root: String, height: UInt64, timestamp_nanosec: String, prev_state_root: CryptoHash, outcome_root: CryptoHash, epoch_id: String, next_bp_hash: String) {
        self.next_epoch_id = next_epoch_id
        self.timestamp = timestamp
        self.block_merkle_root = block_merkle_root
        self.height = height
...
public struct JsonRpcRequest_for_EXPERIMENTAL_receipt: Codable {
    ...
    public init(id: String, params: RpcReceiptRequest, method: String, jsonrpc: String) {
        self.id = id
        self.params = params
        self.method = method
        self.jsonrpc = jsonrpc
...
public struct JsonRpcRequest_for_EXPERIMENTAL_protocol_config: Codable {
    ...
    public init(id: String, params: RpcProtocolConfigRequest, method: String, jsonrpc: String) {
        self.id = id
        self.params = params
        self.method = method
        self.jsonrpc = jsonrpc
...
public struct ExternalStorageConfig: Codable {
    ...
    public init(num_concurrent_requests: String?, external_storage_fallback_threshold: UInt64?, num_concurrent_requests_during_catchup: String?, location: String) {
...
public struct RpcReceiptResponse: Codable {
    ...
    public init(receiver_id: AccountId, receipt: ReceiptEnumView, priority: UInt64?, receipt_id: CryptoHash, predecessor_id: AccountId) {
        self.receiver_id = receiver_id
        self.receipt = receipt
        self.priority = priority
        self.receipt_id = receipt_id
...
public struct PeerInfoView: Codable {
    ...
    public init(received_bytes_per_sec: UInt64, account_id: String?, tracked_shards: [ShardId], last_time_received_message_millis: UInt64, peer_id: PublicKey, block_hash: String?, sent_bytes_per_sec: UInt64, nonce: UInt64, connection_established_time_millis: UInt64, height: UInt64?, is_highest_block_invalid: Bool, archival: Bool, is_outbound_peer: Bool, last_time_peer_requested_millis: UInt64, addr: String) {
...
public struct AccountDataView: Codable {
    ...
    public init(proxies: [Tier1ProxyView], timestamp: String, peer_id: String, account_key: String) {
...
public struct RpcStatusResponse: Codable {
    ...
    public init(validator_account_id: String?, latest_protocol_version: String, node_key: String?, chain_id: String, uptime_sec: String, node_public_key: String, detailed_debug_status: String?, genesis_hash: String, protocol_version: String, rpc_addr: String?, validator_public_key: String?, sync_info: String, validators: [ValidatorInfo], version: String) {
...
public struct DelegateAction: Codable {
    ...
    public init(nonce: UInt64, receiver_id: String, actions: [NonDelegateAction], public_key: String, sender_id: String, max_block_height: UInt64) {
        self.nonce = nonce
        self.receiver_id = receiver_id
        self.actions = actions
        self.public_key = public_key
...
public struct ShardLayoutV2: Codable {
    ...
    public init(index_to_id_map: String, boundary_accounts: [AccountId], shard_ids: [ShardId], version: String, shards_split_map: String?, shards_parent_map: String?, id_to_index_map: String) {
...
public struct RpcValidatorResponse: Codable {
    ...
    public init(current_validators: [CurrentEpochValidatorInfo], next_fishermen: [ValidatorStakeView], current_proposals: [ValidatorStakeView], next_validators: [NextEpochValidatorInfo], epoch_start_height: UInt64, epoch_height: UInt64, prev_epoch_kickout: [ValidatorKickoutView], current_fishermen: [ValidatorStakeView]) {
...
public struct ExecutionOutcomeView: Codable {
    ...
    public init(status: String, metadata: String?, logs: [String], executor_id: String, tokens_burnt: String, receipt_ids: [CryptoHash], gas_burnt: String) {
        self.status = status
...
public struct RpcProtocolConfigResponse: Codable {
    ...
    public init(protocol_version: String, shard_layout: String, chunk_producer_kickout_threshold: String, chain_id: String, block_producer_kickout_threshold: String, runtime_config: String, protocol_treasury_account: String, minimum_stake_divisor: UInt64, epoch_length: UInt64, chunk_validator_only_kickout_threshold: String, num_blocks_per_year: UInt64, shuffle_shard_assignment_for_chunk_producers: Bool, gas_limit: String, online_min_threshold: [Int32], minimum_validators_per_shard: UInt64, avg_hidden_validator_seats_per_shard: [UInt64], transaction_validity_period: UInt64, genesis_height: UInt64, gas_price_adjustment_rate: [Int32], protocol_reward_rate: [Int32], max_inflation_rate: [Int32], max_gas_price: String, fishermen_threshold: String, dynamic_resharding: Bool, target_validator_mandates_per_shard: UInt64, num_block_producer_seats_per_shard: [UInt64], genesis_time: String, minimum_stake_ratio: [Int32], online_max_threshold: [Int32], min_gas_price: String, max_kickout_stake_perc: String, num_block_producer_seats: UInt64, protocol_upgrade_stake_threshold: [Int32]) {
        self.protocol_version = protocol_version
        self.shard_layout = shard_layout
        self.chunk_producer_kickout_threshold = chunk_producer_kickout_threshold
        self.chain_id = chain_id
...
public struct RpcChunkResponse: Codable {
    ...
    public init(header: ChunkHeaderView, author: AccountId, receipts: [ReceiptView], transactions: [SignedTransactionView]) {
        self.header = header
        self.author = author
        self.receipts = receipts
...
public struct DetailedDebugStatus: Codable {
    ...
    public init(network_info: NetworkInfoView, current_header_head_status: BlockStatusView, current_head_status: BlockStatusView, catchup_status: [CatchupStatusView], sync_status: String, block_production_delay_millis: UInt64) {
...
public struct ExtCostsConfigView: Codable {
    ...
    public init(bls12381_g2_multiexp_element: NearGas, yield_resume_base: String, storage_iter_create_prefix_byte: String, utf8_decoding_base: String, bls12381_p1_decompress_element: NearGas, bls12381_p1_decompress_base: NearGas, utf16_decoding_base: String, storage_write_base: String, promise_return: String, storage_iter_create_from_byte: String, log_byte: String, utf8_decoding_byte: String, contract_compile_bytes: NearGas, read_memory_byte: String, storage_iter_next_base: String, alt_bn128_g1_multiexp_base: String, base: String, ecrecover_base: String, bls12381_g1_multiexp_base: NearGas, bls12381_pairing_element: NearGas, sha256_byte: String, write_register_byte: String, storage_write_key_byte: String, storage_remove_base: String, storage_has_key_byte: String, alt_bn128_g1_sum_element: String, validator_total_stake_base: String, bls12381_p2_sum_element: NearGas, keccak256_base: String, storage_read_base: String, storage_remove_key_byte: String, bls12381_g2_multiexp_base: NearGas, bls12381_p2_decompress_base: NearGas, write_memory_byte: String, keccak512_byte: String, keccak512_base: String, ed25519_verify_byte: String, storage_read_value_byte: String, contract_loading_bytes: String, sha256_base: String, log_base: String, contract_loading_base: String, storage_iter_create_range_base: String, storage_large_read_overhead_base: String, read_register_byte: String, alt_bn128_pairing_check_element: String, promise_and_per_promise: String, yield_create_base: String, read_memory_base: String, storage_iter_create_prefix_base: String, storage_iter_next_value_byte: String, read_register_base: String, read_cached_trie_node: String, alt_bn128_pairing_check_base: String, storage_large_read_overhead_byte: String, bls12381_p1_sum_base: NearGas, bls12381_p1_sum_element: NearGas, storage_write_evicted_byte: String, utf16_decoding_byte: String, storage_iter_next_key_byte: String, write_register_base: String, bls12381_map_fp_to_g1_base: NearGas, promise_and_base: String, bls12381_map_fp2_to_g2_base: NearGas, bls12381_map_fp2_to_g2_element: NearGas, bls12381_p2_decompress_element: NearGas, keccak256_byte: String, yield_resume_byte: String, validator_stake_base: String, bls12381_p2_sum_base: NearGas, storage_has_key_base: String, alt_bn128_g1_multiexp_element: String, alt_bn128_g1_sum_base: String, storage_iter_create_to_byte: String, write_memory_base: String, bls12381_g1_multiexp_element: NearGas, yield_create_byte: String, touching_trie_node: String, storage_read_key_byte: String, ripemd160_block: String, bls12381_pairing_base: NearGas, ed25519_verify_base: String, contract_compile_base: NearGas, storage_remove_ret_value_byte: String, storage_write_value_byte: String, bls12381_map_fp_to_g1_element: NearGas, ripemd160_base: String) {
...
public struct RpcNetworkInfoResponse: Codable {
    ...
    public init(known_producers: [RpcKnownProducer], received_bytes_per_sec: UInt64, num_active_peers: String, active_peers: [RpcPeerInfo], peer_max_count: String, sent_bytes_per_sec: UInt64) {
        self.known_producers = known_producers
        self.received_bytes_per_sec = received_bytes_per_sec
...
public struct RpcClientConfigResponse: Codable {
    ...
    public init(protocol_version_check: String, enable_multiline_logging: Bool, state_request_server_threads: String, max_block_production_delay: [UInt64], block_fetch_horizon: UInt64, state_sync: String, chunk_distribution_network: String?, cloud_archival_reader: String?, state_requests_per_throttle_period: String, chunk_validation_threads: String, enable_statistics_export: Bool, block_production_tracking_delay: [UInt64], catchup_step_period: [UInt64], save_trie_changes: Bool, save_tx_outcomes: Bool, tx_routing_height_horizon: UInt64, sync_height_threshold: UInt64, state_sync_external_backoff: [UInt64], header_sync_stall_ban_timeout: [UInt64], sync_check_period: [UInt64], transaction_request_handler_threads: String, max_block_wait_delay: [UInt64], block_header_fetch_horizon: UInt64, version: String, state_request_throttle_period: [UInt64], state_sync_enabled: Bool, state_sync_p2p_timeout: [UInt64], sync_step_period: [UInt64], orphan_state_witness_pool_size: String, save_untracked_partial_chunks_parts: Bool, state_sync_external_timeout: [UInt64], save_latest_witnesses: Bool, cloud_archival_writer: String?, min_num_peers: String, epoch_sync: String, doomslug_step_period: [UInt64], state_sync_retry_backoff: [UInt64], min_block_production_delay: [UInt64], header_sync_initial_timeout: [UInt64], tracked_shards_config: TrackedShardsConfig, log_summary_period: [UInt64], client_background_migration_threads: String, view_client_threads: String, chunk_request_retry_period: [UInt64], orphan_state_witness_max_size: UInt64, num_block_producer_seats: UInt64, chunk_wait_mult: [Int32], header_sync_expected_height_per_second: UInt64, skip_sync_wait: Bool, archive: Bool, resharding_config: MutableConfigValue, ttl_account_id_router: [UInt64], gc: String, log_summary_style: String, produce_empty_blocks: Bool, header_sync_progress_timeout: [UInt64], sync_max_block_requests: String, rpc_addr: String?, chain_id: String, epoch_length: UInt64, trie_viewer_state_size_limit: UInt64?, expected_shutdown: String, produce_chunk_add_transactions_time_limit: String, transaction_pool_size_limit: UInt64?, save_invalid_witnesses: Bool, max_gas_burnt_view: String?) {
