...
extension NearRpcClient {
    ...
    public func tx(params: [String: Any]) async throws -> [String: Any] {
        let response: DictionaryResponse = try await makeRequest(method: .tx, params: params)
        return response.value
    }

    /// Returns the proofs for a transaction execution.
    public func experimentalLightClientProof(params: [String: Any]) async throws -> [String: Any] {
        let response: DictionaryResponse = try await makeRequest(method: .EXPERIMENTAL_light_client_proof, params: params)
        return response.value
    }
    ...
    public func experimentalChangesInBlock(params: [String: Any]) async throws -> [String: Any] {
        let response: DictionaryResponse = try await makeRequest(method: .EXPERIMENTAL_changes_in_block, params: params)
        return response.value
    }

    /// Get initial state and parameters for the genesis block
    public func genesisConfig(params: [String: Any]) async throws -> [String: Any] {
        let response: DictionaryResponse = try await makeRequest(method: .genesis_config, params: params)
        return response.value
    }
    ...
    public func networkInfo() async throws -> [String: Any] {
        let response: DictionaryResponse = try await makeRequest(method: .network_info)
        return response.value
    }

    /// Returns gas price for a specific block_height or block_hash. Using [null] will return the most recent block's gas price.
    public func gasPrice(params: [String: Any]) async throws -> [String: Any] {
        let response: DictionaryResponse = try await makeRequest(method: .gas_price, params: params)
        return response.value
    }
    ...
    public func validators(params: [String: Any]) async throws -> [String: Any] {
        let response: DictionaryResponse = try await makeRequest(method: .validators, params: params)
        return response.value
    }

    /// Returns changes for a given account, contract or contract code for given block height or hash.
    public func changes(params: [String: Any]) async throws -> [String: Any] {
        let response: DictionaryResponse = try await makeRequest(method: .changes, params: params)
        return response.value
    }

    /// Queries status of a transaction by hash, returning the final transaction result and details of all receipts.
    public func experimentalTxStatus(params: [String: Any]) async throws -> [String: Any] {
        let response: DictionaryResponse = try await makeRequest(method: .EXPERIMENTAL_tx_status, params: params)
        return response.value
    }

    /// [Deprecated] Get initial state and parameters for the genesis block. Consider genesis_config instead.
    public func experimentalGenesisConfig(params: [String: Any]) async throws -> [String: Any] {
        let response: DictionaryResponse = try await makeRequest(method: .EXPERIMENTAL_genesis_config, params: params)
        return response.value
    }
    ...
    public func experimentalSplitStorageInfo(params: [String: Any]) async throws -> [String: Any] {
        let response: DictionaryResponse = try await makeRequest(method: .EXPERIMENTAL_split_storage_info, params: params)
        return response.value
    }
    ...
    public func experimentalChanges(params: [String: Any]) async throws -> [String: Any] {
        let response: DictionaryResponse = try await makeRequest(method: .EXPERIMENTAL_changes, params: params)
        return response.value
    }
    ...
    public func status() async throws -> [String: Any] {
        let response: DictionaryResponse = try await makeRequest(method: .status)
        return response.value
    }
    ...
    public func blockEffects(params: [String: Any]) async throws -> [String: Any] {
        let response: DictionaryResponse = try await makeRequest(method: .block_effects, params: params)
        return response.value
    }

    /// A configuration that defines the protocol-level parameters such as gas/storage costs, limits, feature flags, other settings
    public func experimentalProtocolConfig(params: [String: Any]) async throws -> [String: Any] {
        let response: DictionaryResponse = try await makeRequest(method: .EXPERIMENTAL_protocol_config, params: params)
        return response.value
    }

    /// Returns block details for given height or hash
    public func block(params: [String: Any]) async throws -> [String: Any] {
        let response: DictionaryResponse = try await makeRequest(method: .block, params: params)
        return response.value
    }

    /// Queries client node configuration
    public func clientConfig(params: [String: Any]) async throws -> [String: Any] {
        let response: DictionaryResponse = try await makeRequest(method: .client_config, params: params)
        return response.value
    }

    /// Returns the next light client block.
    public func nextLightClientBlock(params: [String: Any]) async throws -> [String: Any] {
        let response: DictionaryResponse = try await makeRequest(method: .next_light_client_block, params: params)
        return response.value
    }

    /// Returns details of a specific chunk. You can run a block details query to get a valid chunk hash.
    public func chunk(params: [String: Any]) async throws -> [String: Any] {
        let response: DictionaryResponse = try await makeRequest(method: .chunk, params: params)
        return response.value
    }
    ...
    /// Returns the proofs for a transaction execution.
    public func lightClientProof(params: [String: Any]) async throws -> [String: Any] {
        let response: DictionaryResponse = try await makeRequest(method: .light_client_proof, params: params)
        return response.value
    }

    /// Fetches a receipt by its ID (as is, without a status or execution outcome)
    public func experimentalReceipt(params: [String: Any]) async throws -> [String: Any] {
        let response: DictionaryResponse = try await makeRequest(method: .EXPERIMENTAL_receipt, params: params)
        return response.value
    }
    ...
    public func broadcastTxCommit(params: [String: Any]) async throws -> [String: Any] {
        let response: DictionaryResponse = try await makeRequest(method: .broadcast_tx_commit, params: params)
        return response.value
    }

    /// Returns the proofs for a transaction execution.
    public func experimentalLightClientBlockProof(params: [String: Any]) async throws -> [String: Any] {
        let response: DictionaryResponse = try await makeRequest(method: .EXPERIMENTAL_light_client_block_proof, params: params)
        return response.value
    }
    ...
    public func sendTx(params: [String: Any]) async throws -> [String: Any] {
        let response: DictionaryResponse = try await makeRequest(method: .send_tx, params: params)
        return response.value
    }

    /// [Deprecated] Sends a transaction and immediately returns transaction hash. Consider using send_tx instead.
    public func broadcastTxAsync(params: [String: Any]) async throws -> [String: Any] {
        let response: DictionaryResponse = try await makeRequest(method: .broadcast_tx_async, params: params)
        return response.value
    }
    ...
    public func experimentalCongestionLevel(params: [String: Any]) async throws -> [String: Any] {
        let response: DictionaryResponse = try await makeRequest(method: .EXPERIMENTAL_congestion_level, params: params)
        return response.value
    }
